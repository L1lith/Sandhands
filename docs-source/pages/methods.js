  ...
  render() {
    return (
      <div className="methods">
        ...
        <p className="description">This section describes the usage of Sandhands&apos;s methods. To see the more about the sanitation format please see <Link href="/Sandhands/format.html">here</Link>.</p>
        <div id="sanitize" className="method section">
...
sanitize(14, {_: Number, min: 22}) // throws error with message "Too small"`
        ...
        <div id="valid" className="method section">
...
console.log(valid('foo bar', String)) // true`
        ...
        <div id="details" className="method section">
...
console.log(details({a: 24}, {a: String, b: String})) // {a: "Expected String", b: "Property Required"}`
        ...
        <div id="format" className="method section">
...
console.log(details({name: Format(String).lowerCase()})) // Also writeable as {_: String, lowercase: true}`}
        ...
        <div id="set-default" className="method section">
...
console.log(valid('', String)) // returns true because we've now lowered the minimum length to 0`
        ...
        <div id="custom-format" className="method section">
...
consooe.log(valid(1523, {_: 'ticketNumber', even: true})) // false`
        ...
        <div id="sandhands-express" className="method section">
