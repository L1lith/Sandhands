    ...
    return (
      <div className="methods">
        ...
        <p className="description">
          This section describes the usage of Sandhands&apos;s methods. To see the more about the
          sanitation format please see <Link href="/Sandhands/format.html">here</Link>.
        </p>
