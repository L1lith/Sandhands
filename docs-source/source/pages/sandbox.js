...
class Sandbox extends Component {
  constructor(props) {
    super(props)
    this.state = {mode: "details", editors: ["input", "format"], objects: {input: {userEmail: 12}, format: {userEmail: "email"}}, values: {input: "{userEmail: 12}", format: '{userEmail: "email"}'}, output: "{\n    userEmail: \"Expected String\"\n}"};
