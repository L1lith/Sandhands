  ...
  [14],
  {
      ...
      !(function () {
        var n = (function (t) {
          ...
          function (t, e, n) {
            ...
            function m(t, e) {
              e.multiline_frame ||
                e.mode === b.ForInitializer ||
                e.mode === b.Conditional ||
                t.remove_indent(e.start_line_index)
            }
            function y(t) {
              return t === b.ArrayLiteral
            }
            function w(t) {
              return l(t, [b.Expression, b.ForInitializer, b.Conditional])
            }
            function v(t, e) {
              ;(e = e || {}),
                (this._source_text = t || ''),
            ...
            ;(v.prototype.create_flags = function (t, e) {
              ...
              (v.prototype.handle_whitespace_and_comments = function (t, e) {
                var n = t.newlines,
                  i = this._options.keep_array_indentation && y(this._flags.mode)
            ...
            var k = ['async', 'break', 'continue', 'return', 'throw', 'yield']
            ;(v.prototype.allow_wrap_or_preserved_newline = function (t, e) {
              if (((e = void 0 !== e && e), !this._output.just_added_newline())) {
                ...
                if (n) this.print_newline(!1, !0)
                  ...
                  if (p(this._flags.last_token, k)) return
                  ...
                  !!(e =
                    (e =
                        ...
                        (e =
                          (e =
                            ...
                            (!(
                              ...
                              p(this._flags.last_token, k) &&
                              !t.newlines)) ||
                          (c(this._flags.last_token, 'else') &&
                            !(c(t, 'if') && !t.comments_before))) ||
                        (this._flags.last_token.type === h.END_EXPR &&
                          (this._previous_flags.mode === b.ForInitializer ||
                            this._previous_flags.mode === b.Conditional))) ||
                      (this._flags.last_token.type === h.WORD &&
                        ...
                        t.type !== h.WORD &&
                        t.type !== h.RESERVED)) ||
                    (this._flags.mode === b.ObjectLiteral &&
                      ((':' === this._flags.last_token.text && 0 === this._flags.ternary_depth) ||
                        p(this._flags.last_token, ['get', 'set'])))) &&
                  (this.set_mode(b.Statement),
                  this.indent(),
              ...
              (v.prototype.handle_end_expr = function (t) {
                for (; this._flags.mode === b.Statement; ) this.restore_mode()
                this.handle_whitespace_and_comments(t),
                  this._flags.multiline_frame &&
                    this.allow_wrap_or_preserved_newline(
                      t,
                      ']' === t.text && y(this._flags.mode) && !this._options.keep_array_indentation
                    ),
                  ...
                  this._flags.do_while &&
                    this._previous_flags.mode === b.Conditional &&
                    ((this._previous_flags.mode = b.Expression),
              ...
              (v.prototype.handle_start_block = function (t) {
                ...
                'switch' === this._flags.last_word && this._flags.last_token.type === h.END_EXPR
                  ? (this.set_mode(b.BlockStatement), (this._flags.in_case_statement = !0))
              ...
              (v.prototype.handle_end_block = function (t) {
                for (this.handle_whitespace_and_comments(t); this._flags.mode === b.Statement; )
                  this.restore_mode()
              ...
              (v.prototype.handle_word = function (t) {
                if (t.type === h.RESERVED)
                  if (l(t.text, ['set', 'get']) && this._flags.mode !== b.ObjectLiteral)
                    t.type = h.WORD
                  ...
                  else if (this._flags.mode === b.ObjectLiteral) {
                  ...
                  return (
                    ...
                    this._flags.last_token.type === h.WORD
                      ? p(this._flags.last_token, ['get', 'set', 'new', 'export']) ||
                        p(this._flags.last_token, k)
                        ? (this._output.space_before_token = !0)
                        : c(this._flags.last_token, 'default') && 'export' === this._last_last_text
                        ? (this._output.space_before_token = !0)
                      ...
                      ? (this._output.space_before_token = !0)
                      : (this._flags.multiline_frame ||
                          (!w(this._flags.mode) && !y(this._flags.mode))) &&
                        this.print_newline(),
                    this.print_token(t),
                ...
                ;(this._flags.last_token.type === h.END_BLOCK
                  ? this._previous_flags.inline_frame
                    ...
                    : (e = 'NEWLINE')
                  : this._flags.last_token.type === h.SEMICOLON &&
                    this._flags.mode === b.BlockStatement
                  ? (e = 'NEWLINE')
                  : this._flags.last_token.type === h.SEMICOLON && w(this._flags.mode)
                  ? (e = 'SPACE')
              ...
              (v.prototype.handle_comma = function (t) {
                this.handle_whitespace_and_comments(t, !0),
                  ...
                  this._flags.declaration_statement
                    ? (w(this._flags.parent.mode) && (this._flags.declaration_assignment = !1),
                    ...
                    : this._flags.mode === b.ObjectLiteral ||
                      (this._flags.mode === b.Statement &&
                        this._flags.parent.mode === b.ObjectLiteral)
                    ? (this._flags.mode === b.Statement && this.restore_mode(),
                ...
                if ('*' !== t.text || this._flags.last_token.type !== h.DOT)
                  if ('::' !== t.text) {
                    ...
                    if (
                      ...
                      switch (this._options.operator_position) {
                        ...
                        case d.preserve_newline:
                          return (
                            m || this.allow_wrap_or_preserved_newline(t),
                            (r = !(this._output.just_added_newline() || m)),
                    ...
                    if (e) {
                      ...
                      s = y && l(y.type, [h.WORD, h.RESERVED])
                    } else
                      '...' === t.text
                        ? (this.allow_wrap_or_preserved_newline(t),
                        ...
                        : (l(t.text, ['--', '++', '!', '~']) || n) &&
                          ...
                          !t.newlines ||
                            ('--' !== t.text && '++' !== t.text) ||
                            this.print_newline(!1, !0),
                          ';' === this._flags.last_token.text && w(this._flags.mode) && (r = !0),
                          this._flags.last_token.type === h.RESERVED
                            ? (r = !0)
                            : this._flags.last_token.type === h.END_EXPR
                            ? (r = !(
                            ...
                            : this._flags.last_token.type === h.OPERATOR &&
                              ...
                              l(t.text, ['+', '-']) &&
                                l(this._flags.last_token.text, ['--', '++']) &&
                                (s = !0)),
                          ((this._flags.mode !== b.BlockStatement || this._flags.inline_frame) &&
                            this._flags.mode !== b.Statement) ||
                            ('{' !== this._flags.last_token.text &&
                              ';' !== this._flags.last_token.text) ||
                            this.print_newline())
                  ...
                  this.props.debounceChangePeriod &&
                    ...
                    C.forEach(function (e, n) {
                      ...
                      var m = (0, o.default)(x, n, []),
                        v = (0, o.default)(O, n, [])
                      e.getSession().setAnnotations(m), v && v.length > 0 && t.handleMarkers(v, e)
                      ...
                      t.handleOptions(t.props, e),
                        ...
                        w && e.setKeyboardHandler('ace/keyboard/' + w)
                    }),
    ...
    NCrt: function (module, __webpack_exports__, __webpack_require__) {
      ...
      var _babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
        ...
        _babel_runtime_helpers_esm_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
          'md7G'
        ),
        _babel_runtime_helpers_esm_getPrototypeOf__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
          'foSv'
        ),
        _babel_runtime_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
          'Ji7U'
        ),
      ...
      function _createSuper(t) {
        return function () {
          var e,
            n = Object(_babel_runtime_helpers_esm_getPrototypeOf__WEBPACK_IMPORTED_MODULE_5__.a)(t)
          if (_isNativeReflectConstruct()) {
            var i = Object(
              _babel_runtime_helpers_esm_getPrototypeOf__WEBPACK_IMPORTED_MODULE_5__.a
            )(this).constructor
            e = Reflect.construct(n, arguments, i)
          } else e = n.apply(this, arguments)
          return Object(
            _babel_runtime_helpers_esm_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_4__.a
          )(this, e)
        }
      }
      ...
      var Sandbox = (function (_Component) {
        Object(_babel_runtime_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_6__.a)(
          Sandbox,
          _Component
        )
    ...
    Sca8: function (t, e, n) {
      ...
      function l(t) {
        for (
          ...
          'object' == i(t) && null !== t && t.hasOwnProperty('_');

        )
          Object.assign(n, t), delete n._, (t = t._)
        return Object.assign(n, e), { options: n, format: t }
      }
      ...
      function f(t) {
        if ('string' == typeof t) {
          if (!c.hasOwnProperty(t)) throw new Error('Custom Format "'.concat(t, '" Not Found'))
          return c[t]
        }
        if ('object' == i(t) && null !== t) {
          if (Array.isArray(t)) return t.map(f)
          if (t.hasOwnProperty('_')) return _({}, t, { _: f(t._) })
          var e = {}
          return (
      ...
      var d = new Map([
        ...
        g = Object.freeze(['equalTo', 'validate']),
        b = new Map([
          [
            String,
            Object.freeze([
      ...
      var m = Object.freeze(['strict']),
        ...
        w = Object.freeze({ universal: g, primitives: b, object: m, array: y })
      var v = Object.freeze(function t() {
          r(this, t)
        }),
        k = [String, Number, Boolean, null, void 0],
        x = new Map([
          [
            String,
            function (t) {
      ...
      function E(t) {
        ...
        var r = [],
          s = 'Internal Error'
        if (k.includes(t)) {
          if (((s = O.get(t)), w.primitives.has(t) && (r = w.primitives.get(t)), x.has(t))) {
            var a = x.get(t)(e)
            if (null !== a) return a
          }
        } else if (Array.isArray(t)) (s = 'Array'), (r = w.array)
        else if ('object' == i(t) && null !== t) {
          ;(s = 'Object'), (r = w.object)
          var o = (function (t) {
            var e = t.strict
            return t.hasOwnProperty('strict') && 'boolean' != typeof e
              ? 'Invalid Strict Option'
              : null
          })(e)
          if (null !== o) return o
        } else if (t !== v) return 'Invalid Format Type'
        r = r.concat(w.universal)
      ...
      function C(t) {
        if ('object' == i(t) && null !== t) {
          if (t instanceof j) return C(t.format)
          if (t.hasOwnProperty('_')) return _({}, t, { _: C(t._) })
      ...
      function T() {
        ...
        ;(e[1] = C(e[1])), (e[1] = f(e[1])), S.apply(void 0, e)
        var r = (function t(e) {
          ...
          if ('object' == i(e) && null !== e) {
            if (Array.isArray(e)) {
              for (var r = 0; r < e.length; r++) {
                var s = e[r]
                if ((!0 === n && (s = t(s, !0)), null !== s)) return s
              }
              return null
            }
            for (var a = Object.values(e), o = 0; o < a.length; o++) {
              var _ = a[o]
              if ((!0 === n && (_ = t(_, !0)), null !== _)) return _
            }
            return null
          }
          return e
      ...
      function R() {
        for (var t = arguments.length, e = new Array(t), n = 0; n < t; n++) e[n] = arguments[n]
        return (e[1] = C(e[1])), (e[1] = f(e[1])), S.apply(void 0, e), null === U.apply(void 0, e)
      }
      var j = (function () {
          function t(e, n) {
            r(this, t), E(e, n), (this.format = _({}, n || {}, { _: e }))
          }
          var e, n, i
          return (
            (e = t),
            (n = [
              {
                key: 'details',
                value: function (t) {
                  return D(t, this.format)
                }
              },
              {
                key: 'valid',
                value: function (t) {
                  return R(t, this.format)
                }
              },
              {
                key: 'sanitize',
        ...
        M = {
          get: function (t, e) {
            if (t === A) return A[e]
            if (!(t instanceof j)) throw new Error('Expected Format Instance')
            if ('_' === e) throw new Error('You must assign the format in the constructor')
            return 'format' === e
              ? t.format
              : t.hasOwnProperty(e) && 'function' == typeof t[e]
              ? t[e].bind(t)
              : function () {
                  var n = !(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0]
                  return (t.format[e] = n), new Proxy(t, M)
                }
          },
          construct: function (t, e) {
            return A.apply(void 0, h(e))
          }
        }
      function A() {
        for (var t = arguments.length, e = new Array(t), n = 0; n < t; n++) e[n] = arguments[n]
      ...
      var N = new Map([
        [
          ...
          function (t, e) {
            ...
            if (e.hasOwnProperty('email') && !0 === l && ((n = t), !L.test(n)))
      ...
      function I(t, e) {
        ...
        e instanceof j && (e = e.format)
        var r = l(e, n)
        if (((e = r.format), (n = r.options).hasOwnProperty('equalTo') && t !== n.equalTo))
          return 'Input Not Equal'
        if (N.has(e)) {
          d.has(e) && (n = Object.assign({}, d.get(e), n))
          var s = N.get(e)(t, n)
          if (null !== s) return s
          ...
          var a = (function (t, e, n, i) {
            ...
            if (
              ...
              throw new Error(
                'Cannot both specify standard manually and set firstAsStandard to true.'
              )
            ...
            return (
              Array.prototype.forEach.call(e, function (e, i) {
                if (u.hasOwnProperty(i)) {
                  ...
                  var a = t(e, c)
                  null !== a && (p[i] = a)
                } else !0 === s && (p[i] = 'Invalid Property')
              }),
              !0 === s &&
                u.forEach(function (t, n) {
                  Object.prototype.hasOwnProperty.call(e, n) || (p[n] = 'Index Missing')
                }),
              p.length < 1 ? null : p
            )
          })(I, t, e, (n = Object.assign({}, d.get(Array), n)))
          if (null !== a) return a
        } else if ('object' == i(e) || e === Object) {
          var o = (function (t, e, n, r) {
            if ('object' != i(e) || null === e || Array.isArray(e)) return 'Expected Object'
            var s = {}
            return (
              !0 === r.strict &&
                Object.keys(e).forEach(function (t) {
                  n.hasOwnProperty(t) || (s[t] = 'Invalid Property')
                }),
              Object.entries(n).forEach(function (n) {
                ...
                if (!s[a]) {
                  ...
                  if (Object.prototype.hasOwnProperty.call(e, a)) {
                    ...
                    var c = t(e[a], o, h)
                    null !== c && (s[a] = c)
                  } else !0 !== h.optional && !0 === r.strict && (s[a] = 'Property Required')
                }
              }),
              Object.keys(s).length < 1 ? null : s
            )
          })(I, t, e, (n = Object.assign({}, d.get(Object), n)))
          if (null !== o) return o
        } else if (e !== v) throw new Error('Invalid Format')
        if (n.hasOwnProperty('validate'))
          if (Array.isArray(n.validate))
            for (var _ = 0; _ < n.validate.length; _++) {
              var c = n.validate[_](t)
              if ('string' == typeof c) {
                if (c.length < 1)
              ...
              if (!1 === c) return 'Failed Validation Function'
            }
          else {
            var p = n.validate(t)
            if ('string' == typeof p) {
            ...
            if ('boolean' != typeof p)
              throw new Error('Validation Function Returned Unexpected output')
            if (!1 === p) return 'Failed Validation Function'
          }
        return null
      }
      function U(t, e, n) {
        return (arguments[1] = f(arguments[1])), I.apply(void 0, arguments)
      }
      function D() {
        for (var t = arguments.length, e = new Array(t), n = 0; n < t; n++) e[n] = arguments[n]
        return (e[1] = C(e[1])), (e[1] = f(e[1])), S.apply(void 0, e), U.apply(void 0, e)
      }
      var K = P
      ;(e.All = v),
        (e.F = K),
        ...
        (e.customFormat = function t(e, n) {
          if (1 !== arguments.length || 'object' != i(arguments[0]) || null === arguments[0]) {
            ...
            if (null !== E(n)) throw new Error('Custom Format Invalid, "'.concat(n, '"'))
            c[e] = n
          } else
        ...
        (e.sandhandsExpress = function (t) {
          ...
          return function (n, i, r) {
            if (!n.hasOwnProperty('body')) return i.status(400).send('Expected Body')
            var s = D(n.body, t, e)
            ...
            ;(p.prototype.eatString = function (t) {
              ...
              (p.prototype.beautify = function () {
                ...
                ;(this._output = new r(this._options, n)),
                  ...
                  (this._ch = null)
                for (
                  var i, p, f = 0, d = !1, g = !1, b = !1, m = !1, y = !1, w = this._ch;
                  ...
                  if ('/' === this._ch && '*' === this._input.peek()) {
                    ...
                    var v = this._input.read(l),
                      k = a.get_directives(v)
                    k && 'start' === k.ignore && (v += a.readIgnored(this._input)),
                      this.print_string(v),
                    ...
                    '#' === this._ch && '{' === this._input.peek()
                      ...
                      ? (g && ((g = !1), this.outdent()),
                        ...
                        b
                          ...
                          : (d = this._indentLevel >= this._nestedLevel),
    ...
    XaGS: function (t, e, n) {
      ;(function (t, n) {
        var i = 200,
          ...
          R = /^(?:0|[1-9]\d*)$/,
          j = {}
        ;(j['[object Float32Array]'] = j['[object Float64Array]'] = j['[object Int8Array]'] = j[
          '[object Int16Array]'
        ] = j['[object Int32Array]'] = j['[object Uint8Array]'] = j[
          '[object Uint8ClampedArray]'
        ] = j['[object Uint16Array]'] = j['[object Uint32Array]'] = !0),
          (j[_] = j[u] = j[S] = j[l] = j[C] = j[c] = j[p] = j[f] = j[g] = j[b] = j[y] = j[v] = j[
            k
          ] = j[x] = j['[object WeakMap]'] = !1)
        var M = 'object' == typeof t && t && t.Object === Object && t,
          A = 'object' == typeof self && self && self.Object === Object && self,
          P = M || A || Function('return this')(),
          L = e && !e.nodeType && e,
          N = L && 'object' == typeof n && n && !n.nodeType && n,
          I = N && N.exports === L,
          U = I && M.process,
          D = (function () {
            try {
              ...
              : (function (t, e, n, i, r, o) {
                      ...
                      h || Yt(t)
                        ...
                        : (function (t, e, n, i, r, o, _) {
                            switch (n) {
                              ...
                              case k:
                                var h = i & s
                                if ((u || (u = B), t.size != e.size && !h)) return !1
                                var f = _.get(t)
                                if (f) return f == e
                                ;(i |= a), _.set(t, e)
                                var d = Lt(u(t), u(e), i, r, o, _)
                                return _.delete(t), d
                              case O:
                  ...
                  if (!(n & s)) {
                    var R = w && Y.call(t, '__wrapped__'),
                      j = E && Y.call(e, '__wrapped__')
                    if (R || j) {
                      var M = R ? t.value() : t,
                        A = j ? e.value() : e
                      return o || (o = new St()), r(M, A, n, i, o)
                    }
                  }
                  if (!T) return !1
                  return (
                    ...
                    (function (t, e, n, i, r, a) {
                      ...
                      for (; l--; ) {
                        var c = _[l]
                        if (!(o ? c in e : Y.call(e, c))) return !1
                      }
                      var p = a.get(t)
                      ...
                      for (; ++l < u; ) {
                        ...
                        var g = t[c],
                          b = e[c]
                        if (i) var m = o ? i(b, g, c, e, t, a) : i(g, b, c, t, e, a)
                        if (!(void 0 === m ? g === b || r(g, b, n, i, a) : m)) {
                          f = !1
                          break
                        }
                        d || (d = 'constructor' == c)
        ...
        function Lt(t, e, n, i, r, o) {
          ...
          for (o.set(t, e), o.set(e, t); ++c < u; ) {
            var d = t[c],
              g = e[c]
            if (i) var b = _ ? i(g, d, c, e, t, o) : i(d, g, c, t, e, o)
            if (void 0 !== b) {
              if (b) continue
              p = !1
              break
            ...
            if (f) {
              if (
                !z(e, function (t, e) {
                  if (((s = e), !f.has(s) && (d === t || r(d, t, n, i, o)))) return f.push(e)
                  var s
                })
              ) {
                p = !1
        ...
        ;(kt.prototype.clear = function () {
          ...
          (kt.prototype.has = function (t) {
            var e = this.__data__
            return ft ? void 0 !== e[t] : Y.call(e, t)
          }),
          (kt.prototype.set = function (t, e) {
            var n = this.__data__
            return (this.size += this.has(t) ? 0 : 1), (n[t] = ft && void 0 === e ? r : e), this
          }),
          ...
          (Ot.prototype.clear = function () {
            ;(this.size = 0),
              (this.__data__ = { hash: new kt(), map: new (ht || xt)(), string: new kt() })
          }),
          ...
          (St.prototype.set = function (t, e) {
            ...
            if (n instanceof xt) {
              var r = n.__data__
              if (!ht || r.length < i - 1) return r.push([t, e]), (this.size = ++n.size), this
        ...
        ;((ut && Kt(new ut(new ArrayBuffer(1))) != C) ||
          (ht && Kt(new ht()) != g) ||
          (lt && '[object Promise]' != Kt(lt.resolve())) ||
          (ct && Kt(new ct()) != k) ||
          (pt && '[object WeakMap]' != Kt(new pt()))) &&
          (Kt = function (t) {
            var e = Rt(t),
        ...
        var Yt = K
          ...
          : function (t) {
              return Qt(t) && Gt(t.length) && !!j[Rt(t)]
            }
        function Xt(t) {
          return null != (e = t) && Gt(e.length) && !Vt(e) ? Ct(t) : Pt(t)
          var e
        }
            ...
            for (var m = -b + p; m <= b - f; m += 2) {
              ...
              if (((_[y] = E), E > i)) f += 2
                ...
                if ((x = a + l - m) >= 0 && x < o && -1 != u[x])
                  if (E >= (k = i - u[x])) return this.diff_bisectSplit_(t, e, E, w, n)
              }
            }
            for (var v = -b + d; v <= b - g; v += 2) {
              for (
                var k,
                  x = a + v,
                  O =
                    (k = v == -b || (v != b && u[x - 1] < u[x + 1]) ? u[x + 1] : u[x - 1] + 1) - v;
              ...
              if (((u[x] = k), k > i)) g += 2
                ...
                if ((y = a + l - v) >= 0 && y < o && -1 != _[y]) {
                  var E
                  w = a + (E = _[y]) - y
                  if (E >= (k = i - k)) return this.diff_bisectSplit_(t, e, E, w, n)
                }
              }
            }
          }
                  ...
                  (n.is_empty_element ||
                    (n.is_end_tag
                      ...
                      : (this._do_optional_end_element(n) &&
                          (n.is_inline_element ||
                            (n.parent && (n.parent.multiline_content = !0), t.print_newline(!1))),
          ...
          function (t, e, n) {
            ...
            ;((h.prototype = new i())._is_comment = function (t) {
                            ...
                            (n =
                              (n =
                                (n =
                                  ...
                                  this._read_raw_content(i, t, e)) || this._read_close(i, e)) ||
                              this._read_content_word(i)) || this._read_comment_or_cdata(i)) ||
              ...
              (h.prototype._read_raw_content = function (t, e, n) {
                ...
                else if (e.type === _.TAG_CLOSE && '<' === e.opened.text[0]) {
      ...
      ;(function (e) {
          ...
          for (
            var n,
              ...
              r = (e = (function (t, e) {
                if (F(t)) return !1
                var n = typeof t
                if ('number' == n || 'symbol' == n || 'boolean' == n || null == t || q(t)) return !0
                return u.test(t) || !_.test(t) || (null != e && (t in Object(e)))
              })(e, t)
                ? [e]
                : F((n = e))
                ? n
        ...
        ;(A.prototype.clear = function () {
          ...
          (A.prototype.has = function (t) {
            var e = this.__data__
            return R ? void 0 !== e[t] : x.call(e, t)
          }),
          (A.prototype.set = function (t, e) {
            return (this.__data__[t] = R && void 0 === e ? i : e), this
          }),
          ...
          (L.prototype.clear = function () {
            this.__data__ = { hash: new A(), map: new (T || P)(), string: new A() }
          }),
        ...
        var z = B(function (t) {
          ...
          return (
            h.test(t) && n.push(''),
            t.replace(l, function (t, e, i, r) {
              n.push(i ? r.replace(c, '$1') : e || t)
            }),
            n
          )
        })
        ...
        function B(t, e) {
          ...
          return (i.cache = new (B.Cache || L)()), i
        }
        B.Cache = L
        var F = Array.isArray
        function J(t) {
