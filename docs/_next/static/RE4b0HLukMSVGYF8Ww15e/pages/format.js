  ...
  [11],
  {
    WGu9: function (e, a, s) {
      ...
      var h = (function (e) {
        ...
        function r() {
          return Object(t.a)(this, r), s.apply(this, arguments)
        }
        return (
          Object(i.a)(r, [
            {
              ...
              value: function () {
                return u(
                  'div',
                  { className: 'format' },
                  u('h1', { className: 'pagetitle' }, 'Format'),
                  u(
                    'p',
                  ...
                  u(
                    'div',
                    { id: 'primitives', className: 'primitives section' },
                    u('h2', { className: 'name' }, 'Primitives Basics'),
                    u(
                      'p',
                      { className: 'description' },
                  ...
                  u(
                    'div',
                    { id: 'options', className: 'options section' },
                    u('h2', { className: 'name' }, 'Options'),
                    u(
                      'p',
                      { className: 'description' },
                  ...
                  u(
                    'div',
                    { id: 'strings', className: 'strings section' },
                    u('h2', { className: 'name' }, 'Strings'),
                    u(
                      'p',
                      { className: 'description' },
                    ...
                    u(
                      'div',
                      { className: 'option' },
                      u('h3', { className: 'name' }, 'whitespace'),
                      u(
                        'p',
                        { className: 'description' },
                  ...
                  u(
                    'div',
                    { id: 'numbers', className: 'numbers section' },
                    u('h2', { className: 'name' }, 'Numbers'),
                    u(
                      'div',
                      { className: 'option' },
                      u('h3', { className: 'name' }, 'integer'),
                      u(
                        'p',
                        { className: 'description' },
                    ...
                    u(
                      'div',
                      { className: 'option' },
                      u('h3', { className: 'name' }, 'min'),
                      u('p', { className: 'description' }, 'Set the minimum value of the input')
                    ),
                    u(
                      'div',
                      { className: 'option' },
                      u('h3', { className: 'name' }, 'max'),
                      u('p', { className: 'description' }, 'Set the maximum value of the input')
                    ),
                    u(
                      'div',
                      { className: 'option' },
                      u('h3', { className: 'name' }, 'even'),
                      u('p', { className: 'description' }, 'Flag as true to require even numbers.')
                    ),
                    u(
                      'div',
                      { className: 'option' },
                      u('h3', { className: 'name' }, 'odd'),
                      u('p', { className: 'description' }, 'Flag as true to require odd numbers.')
                    )
                  ),
                  u(
                    'div',
                    { id: 'objects', className: 'object section' },
                    u('h2', { className: 'name' }, 'Objects'),
                    u(
                      'p',
                      { className: 'description' },
                  ...
                  u(
                    'div',
                    { id: 'arrays', className: 'array section' },
                    u('h2', { className: 'name' }, 'Arrays'),
                    u(
                      'p',
                      { className: 'description' },
                    ...
                    u(
                      'div',
                      { className: 'option' },
                      u('h3', { className: 'name' }, 'firstAsStandard'),
                      u(
                        'p',
                        { className: 'description' },
                    ...
                    u(
                      ...
                      { className: 'option' },
                      u('h3', { className: 'name' }, 'maxLength'),
                      u('p', { className: 'description' }, 'Set the maximum length of the array.')
                    ),
                    u(
                      'div',
                      { className: 'option' },
                  ...
                  u(
                    'div',
                    { id: 'universal', className: 'universal section' },
                    u('h2', { className: 'name' }, 'Universal Options'),
                    u(
                      'div',
                      { className: 'option' },
                      u('h3', { className: 'name' }, 'validate'),
                      u(
                        'p',
                        { className: 'description' },
