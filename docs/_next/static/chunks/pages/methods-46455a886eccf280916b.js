    ...
    cTJO: function (e, t, n) {
                  ...
                  e.forEach(function (e) {
                    if (l.has(e.target)) {
                      ...
                      ;(e.isIntersecting || e.intersectionRatio > 0) &&
                        (r.unobserve(e.target), l.delete(e.target), t())
                    }
                  })
                },
                { rootMargin: '200px' }
      ...
      var h = function (e) {
        var t = !1 !== e.prefetch,
          ...
          v = o.default.useMemo(
            function () {
              var t = (0, i.resolveHref)(p, e.href, !0),
                n = a(t, 2),
                s = n[0],
                r = n[1]
              return { href: s, as: e.as ? (0, i.resolveHref)(p, e.as) : r || s }
            },
            [p, e.href, e.as]
          ),
          g = v.href,
        ...
        o.default.useEffect(
          function () {
            if (t && u && r && r.tagName && (0, i.isLocalURL)(g) && !d[g + '%' + b])
              return m(r, function () {
                f(h, g, b)
              })
          },
                ...
                e.defaultPrevented ||
                  (function (e, t, n, a, s, r, o) {
                    ;('A' !== e.currentTarget.nodeName ||
                      ...
                      t[s ? 'replace' : 'push'](n, a, { shallow: r }).then(function (e) {
        ...
        return (
          ...
          (e.passHref || ('a' === j.type && !('href' in j.props))) &&
            (x.href = (0, i.addBasePath)((0, i.addLocale)(b, h && h.locale, h && h.defaultLocale))),
          o.default.cloneElement(j, x)
        )
      }
      t.default = h
    },
      ...
      function p(e) {
        ...
        return function () {
          var n,
            a = Object(i.a)(e)
          if (t) {
            var s = Object(i.a)(this).constructor
              ...
              value: function () {
                return h(
                  ...
                  h(
                    ...
                    h(d.a, { href: '/Sandhands/format.html' }, 'here'),
                    '.'
                  ),
                  h(
                    'div',
