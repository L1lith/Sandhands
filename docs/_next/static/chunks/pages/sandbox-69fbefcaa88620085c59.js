  ...
  [13],
  {
    ...
    '5ONA': function (t, e) {
      ...
      function _(t) {
        ...
        if ('0' === e[0][0] && e[0].length > 1) return !1
        if ('0' === e[1][0] && e[1].length > 1) return !1
        if ('0' === e[2][0] && e[2].length > 1) return !1
        if ('0' === e[3][0] && e[3].length > 1) return !1
        var i = Number(e[0]),
          r = Number(e[1]),
          s = Number(e[2]),
          a = Number(e[3])
        return i >= 0 && i < 256 && r >= 0 && r < 256 && s >= 0 && s < 256 && a >= 0 && a < 256
      }
      function u(t) {
        var e = t.replace(i, ''),
          n = t.length !== e.length
        if (n) return !1
        if (!n && r.test(t)) return !1
        var u = e.replace(s, ''),
          h = u.lastIndexOf(':')
        if (-1 === h) return !1
        var l = _(u.substring(h + 1)) ? u.substring(0, h + 1) + '1234:5678' : u
        ...
        if (2 === c.length) {
          var p = '' === c[0] ? [] : c[0].split(':'),
            f = '' === c[1] ? [] : c[1].split(':')
          if (8 - (p.length + f.length) <= 0) return !1
        } else if (8 !== l.split(':').length) return !1
        return !0
      }
      function h(t) {
        return _(t) || u(t)
      ...
      ;(t.exports = function (t) {
        if ((t || (t = {}), 4 === t.version)) return _
        if (6 === t.version) return u
        if (null == t.version) return h
        throw new Error('Unknown version: ' + t.version)
      }),
        (t.exports.__all_regexes__ = [n, i, r, s, a, o])
    },
    '5VLF': function (t, e, n) {
      'use strict'
      var i, r
      ;(i = [n('6UM0'), n('TXwP'), n('psGv')]),
        void 0 ===
          (r = function (t, e, n) {
      ...
      !(function () {
        var n = (function (t) {
          ...
          function (t, e, n) {
            ...
            function c(t, e) {
              return t && t.type === h.RESERVED && t.text === e
            }
            function p(t, e) {
              return t && t.type === h.RESERVED && l(t.text, e)
            }
            var f = [
                'case',
                'return',
              ...
              g = [d.before_newline, d.preserve_newline],
              b = 'BlockStatement',
              m = 'Statement',
              y = 'ObjectLiteral',
              v = 'ArrayLiteral',
            ...
            ;(C.prototype.create_flags = function (t, e) {
              ...
              return (
                    ...
                    (n = t.line_indent_level)),
                {
                  mode: e,
                  parent: t,
                  last_token: t ? t.last_token : new r(h.START_BLOCK, ''),
              ...
              (C.prototype.handle_token = function (t, e) {
                t.type === h.START_EXPR
                  ...
                  : t.type === h.WORD || t.type === h.RESERVED
                  ? this.handle_word(t)
                  : t.type === h.SEMICOLON
                  ...
                  : t.type === h.EOF
                  ? this.handle_eof(t)
                  : (t.type, h.UNKNOWN, this.handle_unknown(t, e))
              }),
              (C.prototype.handle_whitespace_and_comments = function (t, e) {
                ...
                if (i) for (var s = 0; s < n; s += 1) this.print_newline(s > 0, e)
                else if (
            ...
            ;(C.prototype.allow_wrap_or_preserved_newline = function (t, e) {
              if (((e = void 0 !== e && e), !this._output.just_added_newline())) {
                ...
                if (l(this._flags.last_token.text, u) || l(t.text, u)) {
                  var i =
                    (l(this._flags.last_token.text, u) && l(this._options.operator_position, g)) ||
                    l(t.text, u)
                  n = n && i
                }
              ...
              (C.prototype.print_newline = function (t, e) {
                if (
                  ...
                  ',' !== this._flags.last_token.text &&
                  '=' !== this._flags.last_token.text &&
                  (this._flags.last_token.type !== h.OPERATOR ||
                    '--' === this._flags.last_token.text ||
                    '++' === this._flags.last_token.text)
                )
                  for (
              ...
              (C.prototype.restore_mode = function () {
                this._flag_store.length > 0 &&
                  ...
                  this._previous_flags.mode === m && O(this._output, this._previous_flags),
                  this._output.set_indent(this._flags.indentation_level, this._flags.alignment))
              }),
              ...
              (C.prototype.start_of_statement = function (t) {
                ...
                return (
                            ...
                            (e =
                              (e =
                                ...
                                (p(this._flags.last_token, ['var', 'let', 'const']) &&
                                  t.type === h.WORD)) || c(this._flags.last_token, 'do')) ||
                            (!(this._flags.parent.mode === y && this._flags.mode === m) &&
                              p(this._flags.last_token, T) &&
                              !t.newlines)) ||
                          (c(this._flags.last_token, 'else') &&
                            !(c(t, 'if') && !t.comments_before))) ||
                        (this._flags.last_token.type === h.END_EXPR &&
                          (this._previous_flags.mode === w || this._previous_flags.mode === k))) ||
                      (this._flags.last_token.type === h.WORD &&
                        this._flags.mode === b &&
                        !this._flags.in_case &&
                        !('--' === t.text || '++' === t.text) &&
                  ...
                  this.start_of_object_property() ||
                    this.allow_wrap_or_preserved_newline(t, p(t, ['do', 'for', 'if', 'while'])),
                  !0)
                )
              }),
              (C.prototype.handle_start_expr = function (t) {
                ...
                var e = x
                if ('[' === t.text) {
                  if (this._flags.last_token.type === h.WORD || ')' === this._flags.last_token.text)
                    return (
                      p(this._flags.last_token, _) && (this._output.space_before_token = !0),
                      this.print_token(t),
                      this.set_mode(e),
                      this.indent(),
                  ...
                  if (this._flags.last_token.type === h.RESERVED)
                    'for' === this._flags.last_token.text
                      ? ((this._output.space_before_token = this._options.space_before_conditional),
                        (e = w))
                      : l(this._flags.last_token.text, ['if', 'while'])
                      ? ((this._output.space_before_token = this._options.space_before_conditional),
                        (e = k))
                      : l(this._flags.last_word, ['await', 'async'])
                      ? (this._output.space_before_token = !0)
                      : 'import' === this._flags.last_token.text && '' === t.whitespace_before
                      ? (this._output.space_before_token = !1)
                      : (l(this._flags.last_token.text, _) ||
                  ...
                  else if (this._flags.last_token.type === h.WORD) {
                    this._output.space_before_token = !1
                    var n = this._tokens.peek(-3)
                    if (this._options.space_after_named_function && n) {
                      var i = this._tokens.peek(-4)
                      p(n, ['async', 'function']) || ('*' === n.text && p(i, ['async', 'function']))
                        ? (this._output.space_before_token = !0)
                        : this._flags.mode === y &&
                          (('{' !== n.text &&
                            ',' !== n.text &&
                            ('*' !== n.text || ('{' !== i.text && ',' !== i.text))) ||
                            (this._output.space_before_token = !0))
                    }
                  } else this.allow_wrap_or_preserved_newline(t)
                  ;((this._flags.last_token.type === h.RESERVED &&
                    ('function' === this._flags.last_word || 'typeof' === this._flags.last_word)) ||
                    ('*' === this._flags.last_token.text &&
                      (l(this._last_last_text, ['function', 'yield']) ||
                        (this._flags.mode === y && l(this._last_last_text, ['{', ',']))))) &&
                    (this._output.space_before_token = this._options.space_after_anon_function)
                }
                ';' === this._flags.last_token.text || this._flags.last_token.type === h.START_BLOCK
                  ? this.print_newline()
                  : (this._flags.last_token.type !== h.END_EXPR &&
                      this._flags.last_token.type !== h.START_EXPR &&
                      this._flags.last_token.type !== h.END_BLOCK &&
                      '.' !== this._flags.last_token.text &&
                      this._flags.last_token.type !== h.COMMA) ||
                ...
                this.handle_whitespace_and_comments(t),
                  this._flags.multiline_frame &&
                    this.allow_wrap_or_preserved_newline(
                      t,
                      ']' === t.text && E(this._flags.mode) && !this._options.keep_array_indentation
                    ),
              ...
              (C.prototype.handle_start_block = function (t) {
                ...
                'switch' === this._flags.last_word && this._flags.last_token.type === h.END_EXPR
                  ? (this.set_mode(b), (this._flags.in_case_statement = !0))
                  : this._flags.case_body
                  ? this.set_mode(b)
                  : n &&
                    ((l(n.text, [':', ',']) && l(e.type, [h.STRING, h.WORD, h.RESERVED])) ||
                      (l(e.text, ['get', 'set', '...']) && l(n.type, [h.WORD, h.RESERVED])))
                  ...
                  : this._flags.last_token.type === h.OPERATOR &&
                    '=>' === this._flags.last_token.text
                  ? this.set_mode(b)
                  : l(this._flags.last_token.type, [h.EQUALS, h.START_EXPR, h.COMMA, h.OPERATOR]) ||
                    p(this._flags.last_token, ['return', 'throw', 'import', 'default'])
                  ? this.set_mode(y)
                  : this.set_mode(b)
                ...
                if (this._options.brace_preserve_inline) {
                  ...
                  } while (a.type !== h.EOF && (a.type !== h.END_BLOCK || a.opened !== t))
                }
                ...
                !this._flags.inline_frame
                  ? this._flags.last_token.type !== h.OPERATOR &&
                    (r ||
                      this._flags.last_token.type === h.EQUALS ||
                      (p(this._flags.last_token, f) && 'else' !== this._flags.last_token.text))
                    ? (this._output.space_before_token = !0)
                    : this.print_newline(!1, !0)
                  : (!E(this._previous_flags.mode) ||
                      (this._flags.last_token.type !== h.START_EXPR &&
                        this._flags.last_token.type !== h.COMMA) ||
                      ((this._flags.last_token.type === h.COMMA || this._options.space_in_paren) &&
                        (this._output.space_before_token = !0),
                      (this._flags.last_token.type === h.COMMA ||
                        (this._flags.last_token.type === h.START_EXPR &&
                          this._flags.inline_frame)) &&
              ...
              (C.prototype.handle_end_block = function (t) {
                for (this.handle_whitespace_and_comments(t); this._flags.mode === m; )
                  this.restore_mode()
                var e = this._flags.last_token.type === h.START_BLOCK
                this._flags.inline_frame && !e
                  ? (this._output.space_before_token = !0)
                  : 'expand' === this._options.brace_style
                  ? e || this.print_newline()
                  : e ||
                    (E(this._flags.mode) && this._options.keep_array_indentation
              ...
              (C.prototype.handle_word = function (t) {
                if (t.type === h.RESERVED)
                  if (l(t.text, ['set', 'get']) && this._flags.mode !== y) t.type = h.WORD
                  else if ('import' === t.text && '(' === this._tokens.peek().text) t.type = h.WORD
                  else if (l(t.text, ['as', 'from']) && !this._flags.import_block) t.type = h.WORD
                  else if (this._flags.mode === y) {
                    ':' === this._tokens.peek().text && (t.type = h.WORD)
                  }
                if (
                  (this.start_of_statement(t)
                    ...
                    : !t.newlines ||
                      ...
                      (!this._options.preserve_newlines &&
                        p(this._flags.last_token, ['var', 'let', 'const', 'set', 'get']))
                    ? this.handle_whitespace_and_comments(t)
                ...
                if (this._flags.if_block)
                  if (!this._flags.else_block && c(t, 'else')) this._flags.else_block = !0
                  else {
                    for (; this._flags.mode === m; ) this.restore_mode()
                ...
                if (
                  ...
                  return (
                    ...
                    this._flags.last_token.type === h.RESERVED ||
                    this._flags.last_token.type === h.WORD
                      ? p(this._flags.last_token, ['get', 'set', 'new', 'export']) ||
                        p(this._flags.last_token, T) ||
                        (c(this._flags.last_token, 'default') &&
                      ...
                      ? (this._output.space_before_token = !0)
                      : (this._flags.multiline_frame ||
                          (!S(this._flags.mode) && !E(this._flags.mode))) &&
                        this.print_newline(),
                    this.print_token(t),
                ...
                ;(this._flags.last_token.type === h.END_BLOCK
                  ? this._previous_flags.inline_frame
                    ...
                    : (e = 'NEWLINE')
                  : this._flags.last_token.type === h.SEMICOLON && this._flags.mode === b
                  ? (e = 'NEWLINE')
                  : this._flags.last_token.type === h.SEMICOLON && S(this._flags.mode)
                  ? (e = 'SPACE')
                  : this._flags.last_token.type === h.STRING
                  ? (e = 'NEWLINE')
                  : this._flags.last_token.type === h.RESERVED ||
                    this._flags.last_token.type === h.WORD ||
                    ('*' === this._flags.last_token.text &&
                      (l(this._last_last_text, ['function', 'yield']) ||
                        (this._flags.mode === y && l(this._last_last_text, ['{', ',']))))
                  ? (e = 'SPACE')
                  : this._flags.last_token.type === h.START_BLOCK
                ...
                p(t, ['else', 'catch', 'finally']))
                  ? (this._flags.last_token.type !== h.END_BLOCK ||
                    ...
                    : (this._output.trim(!0),
                      ...
                      (this._output.space_before_token = !0))
                  : 'NEWLINE' === e
                  ? p(this._flags.last_token, f) ||
                    ('declare' === this._flags.last_token.text && p(t, ['var', 'let', 'const']))
                    ? (this._output.space_before_token = !0)
                    : this._flags.last_token.type !== h.END_EXPR
                    ? (this._flags.last_token.type === h.START_EXPR &&
                        p(t, ['var', 'let', 'const'])) ||
                      ':' === this._flags.last_token.text ||
                      (c(t, 'if') && c(t.previous, 'else')
                        ? (this._output.space_before_token = !0)
                        : this.print_newline())
                    : p(t, _) && ')' !== this._flags.last_token.text && this.print_newline()
                  : this._flags.multiline_frame &&
                    E(this._flags.mode) &&
                    ',' === this._flags.last_token.text &&
                    '}' === this._last_last_text
                ...
                !t.previous ||
                  (t.previous.type !== h.WORD && t.previous.type !== h.RESERVED) ||
                  (this._output.space_before_token = !0),
                  this.print_token(t),
                  ...
                  t.type === h.RESERVED &&
                    ('do' === t.text
                      ...
                      : this._flags.import_block && c(t, 'from') && (this._flags.import_block = !1))
              }),
              ...
              (C.prototype.handle_comma = function (t) {
                this.handle_whitespace_and_comments(t, !0),
                  ...
                  this._flags.declaration_statement
                    ? (S(this._flags.parent.mode) && (this._flags.declaration_assignment = !1),
                      this._flags.declaration_assignment
                        ? ((this._flags.declaration_assignment = !1), this.print_newline(!1, !0))
                        : this._options.comma_first && this.allow_wrap_or_preserved_newline(t))
                    : this._flags.mode === y ||
                      (this._flags.mode === m && this._flags.parent.mode === y)
                    ? (this._flags.mode === m && this.restore_mode(),
              ...
              (C.prototype.handle_operator = function (t) {
                ...
                if (p(this._flags.last_token, f))
                  return (this._output.space_before_token = !0), void this.print_token(t)
                if ('*' !== t.text || this._flags.last_token.type !== h.DOT)
                  if ('::' !== t.text) {
                    if (
                      (this._flags.last_token.type === h.OPERATOR &&
                        l(this._options.operator_position, g) &&
                        this.allow_wrap_or_preserved_newline(t),
                      ...
                      return (
                        ...
                        void (this._tokens.peek().type !== h.START_BLOCK
                    ...
                    if (
                      (':' === t.text
                        ? 0 === this._flags.ternary_depth
                          ? (r = !1)
                          : ((this._flags.ternary_depth -= 1), (a = !0))
                        : '?' === t.text && (this._flags.ternary_depth += 1),
                      !n && !e && this._options.preserve_newlines && l(t.text, u))
                    ) {
                      var o = ':' === t.text,
                        c = o && a,
                        y = o && !a
                      switch (this._options.operator_position) {
                        case d.before_newline:
                          return (
                            ...
                            this.print_token(t),
                            (o && !c) || this.allow_wrap_or_preserved_newline(t),
                    ...
                    if (e) {
                      ...
                      s = v && l(v.type, [h.WORD, h.RESERVED])
                    } else
                      '...' === t.text
                        ? (this.allow_wrap_or_preserved_newline(t),
                          (r = this._flags.last_token.type === h.START_BLOCK),
                          (s = !1))
                        : (l(t.text, ['--', '++', '!', '~']) || n) &&
                          ((this._flags.last_token.type !== h.COMMA &&
                            this._flags.last_token.type !== h.START_EXPR) ||
                          ...
                          !t.newlines ||
                            ('--' !== t.text && '++' !== t.text) ||
                            this.print_newline(!1, !0),
                          ';' === this._flags.last_token.text && S(this._flags.mode) && (r = !0),
                          this._flags.last_token.type === h.RESERVED
                            ? (r = !0)
                            : this._flags.last_token.type === h.END_EXPR
                            ? (r = !(
                            ...
                            : this._flags.last_token.type === h.OPERATOR &&
                              ...
                              l(t.text, ['+', '-']) &&
                                l(this._flags.last_token.text, ['--', '++']) &&
                                (s = !0)),
                          ((this._flags.mode !== b || this._flags.inline_frame) &&
                            this._flags.mode !== m) ||
                            ('{' !== this._flags.last_token.text &&
                              ';' !== this._flags.last_token.text) ||
                            this.print_newline())
              ...
              (C.prototype.handle_block_comment = function (t, e) {
                return this._output.raw
                  ...
                  : s.newline.test(t.text) || t.newlines
              ...
              (C.prototype.print_block_commment = function (t, e) {
                var n,
                  i = (function (t) {
                    for (
                      var e = [], n = (t = t.replace(s.allLineBreaks, '\n')).indexOf('\n');
                      -1 !== n;
                ...
                if (
                  ...
                  for (
                    ...
                    r
                      ...
                      : a && i[n]
                      ? (this.print_token_line_indentation(t),
                        this._output.add_token(i[n].substring(_)))
                      : (this._output.current_line.set_indent(-1), this._output.add_token(i[n])),
                      this.print_newline(!1, e)
          ...
          function (t, e, n) {
            ...
            function s(t) {
              ...
              ;(this.unindent_chained_methods = this._get_boolean('unindent_chained_methods')),
                ...
                (this.operator_position = this._get_selection('operator_position', r)),
          ...
          function (t, e, n) {
            ...
            var l = {
              ...
              b =
                '>>>= ... >>= <<= === >>> !== **= => ^= :: /= << <= == && -= >= >> != -- += ** || ?? ++ %= &= *= |= |> = ! ? > < : / ^ - + * & % ~ |'
            b = (b = '\\?\\.(?!\\d) ' + (b = b.replace(/[-[\]{}()*+?.,\\^$|#]/g, '\\$&'))).replace(
              / /g,
              '|'
            )
            var m,
              y = new RegExp(b),
              v = 'continue,try,throw,return,var,let,const,if,switch,case,default,for,while,break,function,import,export'.split(
                ','
              ),
              w = v.concat([
                'do',
              ...
              x = function (t, e) {
                ...
                var n = new _(this._input),
                  i = new u(this._input).read_options(this._options)
                this.__patterns = {
                  template: i,
            ...
            ;((x.prototype = new r())._is_comment = function (t) {
              return t.type === l.COMMENT || t.type === l.BLOCK_COMMENT || t.type === l.UNKNOWN
            }),
              (x.prototype._is_opening = function (t) {
                return t.type === l.START_BLOCK || t.type === l.START_EXPR
              }),
              (x.prototype._is_closing = function (t, e) {
                return (
                  (t.type === l.END_BLOCK || t.type === l.END_EXPR) &&
                  e &&
                  ((']' === t.text && '[' === e.text) ||
                    (')' === t.text && '(' === e.text) ||
                    ('}' === t.text && '{' === e.text))
              ...
              (x.prototype._get_next_token = function (t, e) {
                var n = null
                              ...
                              (n =
                                (n =
                                  (n =
                                    ...
                                    this._read_string(i)) || this._read_word(t)) ||
                                this._read_singles(i)) || this._read_comment(i)) ||
                            this._read_regexp(i, t)) || this._read_xml(i, t)) ||
                        this._read_punctuation()) ||
                      this._create_token(l.UNKNOWN, this._input.next()))
              }),
              (x.prototype._read_word = function (t) {
                var e
                return '' !== (e = this.__patterns.identifier.read())
                  ? ((e = e.replace(o.allLineBreaks, '\n')),
                    t.type !== l.DOT &&
                    (t.type !== l.RESERVED || ('set' !== t.text && 'get' !== t.text)) &&
                    k.test(e)
                      ? 'in' === e || 'of' === e
                        ? this._create_token(l.OPERATOR, e)
                        : this._create_token(l.RESERVED, e)
                      : this._create_token(l.WORD, e))
                  : '' !== (e = this.__patterns.number.read())
                  ? this._create_token(l.WORD, e)
                  : void 0
              }),
              (x.prototype._read_singles = function (t) {
                var e = null
                return (
                  '(' === t || '[' === t
                    ? (e = this._create_token(l.START_EXPR, t))
                    : ')' === t || ']' === t
                    ? (e = this._create_token(l.END_EXPR, t))
                    : '{' === t
                    ? (e = this._create_token(l.START_BLOCK, t))
                    : '}' === t
                    ? (e = this._create_token(l.END_BLOCK, t))
                    : ';' === t
                    ? (e = this._create_token(l.SEMICOLON, t))
                    : '.' === t && d.test(this._input.peek(1))
                    ? (e = this._create_token(l.DOT, t))
                    : ',' === t && (e = this._create_token(l.COMMA, t)),
                  e && this._input.next(),
                  e
                )
              }),
              (x.prototype._read_punctuation = function () {
                ...
                if ('' !== t)
                  return '=' === t
                    ? this._create_token(l.EQUALS, t)
                    : '?.' === t
                    ? this._create_token(l.DOT, t)
                    : this._create_token(l.OPERATOR, t)
              }),
              (x.prototype._read_non_javascript = function (t) {
                var e = ''
                if ('#' === t) {
                  if (this._is_first_token() && (e = this.__patterns.shebang.read()))
                    return this._create_token(l.UNKNOWN, e.trim() + '\n')
                  ...
                  if ((e = this.__patterns.html_comment_start.read())) {
                    for (; this._input.hasNext() && !this._input.testChar(o.newline); )
                      e += this._input.next()
                    return (m = !0), this._create_token(l.COMMENT, e)
                  }
                } else if (m && '-' === t && (e = this.__patterns.html_comment_end.read()))
                  return (m = !1), this._create_token(l.COMMENT, e)
                return null
              }),
              (x.prototype._read_comment = function (t) {
                var e = null
                if ('/' === t) {
                  var n = ''
                  if ('*' === this._input.peek(1)) {
                    ...
                    i && 'start' === i.ignore && (n += c.readIgnored(this._input)),
                      (n = n.replace(o.allLineBreaks, '\n')),
                      ((e = this._create_token(l.BLOCK_COMMENT, n)).directives = i)
                  } else
                    '/' === this._input.peek(1) &&
                      ((n = this.__patterns.comment.read()), (e = this._create_token(l.COMMENT, n)))
                }
                return e
              }),
              (x.prototype._read_string = function (t) {
                if ('`' === t || "'" === t || '"' === t) {
              ...
              (x.prototype._allow_regexp_or_xml = function (t) {
                return (
                  (t.type === l.RESERVED &&
                    h(t.text, ['return', 'case', 'throw', 'else', 'do', 'typeof', 'yield'])) ||
                  (t.type === l.END_EXPR &&
                    ')' === t.text &&
                    t.opened.previous.type === l.RESERVED &&
                    h(t.opened.previous.text, ['if', 'while', 'for'])) ||
                  h(t.type, [
                    l.COMMENT,
                    l.START_EXPR,
                    l.START_BLOCK,
              ...
              (x.prototype._read_regexp = function (t, e) {
                if ('/' === t && this._allow_regexp_or_xml(e)) {
                  ...
                  return (
                    this._input.peek() === t &&
                      ((n += this._input.next()), (n += this._input.read(o.identifier))),
                    this._create_token(l.STRING, n)
                  )
                }
                return null
              }),
              (x.prototype._read_xml = function (t, e) {
                  ...
                  if (i) {
                    for (
                      ...
                      var _ = !!i[1],
                        u = i[2]
                      if (
                        (!(!!i[i.length - 1] || '![CDATA[' === u.slice(0, 8)) &&
                          (u === r || (s && u.replace(/^{\s+/, '{').replace(/\s+}$/, '}'))) &&
                          (_ ? --a : ++a),
                        (n += i[0]),
                        a <= 0)
                      )
              ...
              (x.prototype._read_string_recursive = function (t, e, n) {
                var i, r
                "'" === t
                ...
                for (var s = r.read(), a = ''; this._input.hasNext(); ) {
          ...
          function (t, e, n) {
            ...
            ;(r.prototype.restart = function () {
              ...
              (r.prototype.__match = function (t, e) {
                t.lastIndex = e
              ...
              (r.prototype.testChar = function (t, e) {
                var n = this.peek(e)
              ...
              (r.prototype.read = function (t, e, n) {
                var i,
                  r = ''
                return (
              ...
              (r.prototype.readUntil = function (t, e) {
                var n,
                  i = this.__position
                t.lastIndex = this.__position
                var r = t.exec(this.__input)
                return (
                  r ? ((i = r.index), e && (i += r[0].length)) : (i = this.__input_length),
                  (n = this.__input.substring(this.__position, i)),
                  (this.__position = i),
                  n
                )
              }),
              (r.prototype.readUntilAfter = function (t) {
                return this.readUntil(t, !0)
              }),
              (r.prototype.get_regexp = function (t, e) {
                var n = null,
                  r = 'g'
                return (
                  e && i && (r = 'y'),
                  'string' === typeof t && '' !== t
                    ? (n = new RegExp(t, r))
                    : t && (n = new RegExp(t.source, r)),
                  n
                )
              }),
              (r.prototype.get_literal_regexp = function (t) {
                return RegExp(t.replace(/[-\/\\^$*+?.()|[\]{}]/g, '\\$&'))
              }),
              (r.prototype.peekUntilAfter = function (t) {
                var e = this.__position,
                  n = this.readUntilAfter(t)
                return (this.__position = e), n
              }),
              (r.prototype.lookBack = function (t) {
                ...
                a.isEmpty() || ((t.comments_before = a), (a = new s())),
                  ...
                  this._is_opening(t)
                    ...
                    : n &&
                      ...
                      ((t.opened = n), (n.closed = t), (n = i.pop()), (t.parent = n)),
                  (t.previous = e),
                  (e.next = t),
                  this.__tokens.add(t),
                  (e = t)
          ...
          function (t, e, n) {
            ...
            ;(i.prototype.restart = function () {
              ...
              (i.prototype.next = function () {
                var t = null
                return (
                  this.hasNext() && ((t = this.__tokens[this.__position]), (this.__position += 1)),
                  t
                )
              }),
            ...
            ;(r.prototype = new i()),
              ...
              (r.prototype.__split = function (t, e) {
                ...
                for (var n = 0, i = [], r = t.exec(e); r; )
                  i.push(e.substring(n, r.index)), (n = r.index + r[0].length), (r = t.exec(e))
          ...
          function (t, e, n) {
            ...
            ;(s.prototype = new i()),
              ...
              (s.prototype.read_options = function (t) {
                var e = this._create()
                for (var n in r) e._disabled[n] = -1 === t.templating.indexOf(n)
                return e._update(), e
              }),
              ...
              (s.prototype.read = function () {
                ...
                return (
                  this._until_after && (t += this._input.readUntilAfter(this._until_pattern)), t
                )
              }),
      ...
      ace.define(
        ...
        function (t, e, n) {
          ...
          var i = t('./lib/oop'),
            ...
            a = t('./editor').Editor,
            o = t('./virtual_renderer').VirtualRenderer,
            _ = t('./edit_session').EditSession,
            u = function (t, e, n) {
              ;(this.BELOW = 1),
                (this.BESIDE = 0),
                (this.$container = t),
          ...
          ;(function () {
            i.implement(this, s),
              (this.$createEditor = function () {
                ...
                var e = new a(new o(t, this.$theme))
                return (
                  e.on(
                    'focus',
                    function () {
              ...
              (this.$cloneSession = function (t) {
                var e = new _(t.getDocument(), t.getMode()),
                  n = t.getUndoManager()
                if (n) {
                  var i = new h(n, e)
                  e.setUndoManager(i)
                ...
                return (
                  (e.$informUndoManager = r.delayedCall(function () {
                    e.$deltas = []
                  })),
                  ...
                  e.setWrapLimitRange(t.$wrapLimitRange.min, t.$wrapLimitRange.max),
              ...
              (this.setSession = function (t, e) {
                ...
                return (
                  ...
                  this.$editors.some(function (e) {
                    return e.session === t
                  }) && (t = this.$cloneSession(t)),
                  n.setSession(t),
                  t
                )
              }),
              ...
              (this.resize = function () {
                ...
                if (this.$orientation == this.BESIDE)
                  for (var i = e / this.$splits, r = 0; r < this.$splits; r++)
                    ((t = this.$editors[r]).container.style.width = i + 'px'),
                      (t.container.style.top = '0px'),
                      (t.container.style.left = r * i + 'px'),
                      (t.container.style.height = n + 'px'),
                      t.resize()
                else {
                  var s = n / this.$splits
                  for (r = 0; r < this.$splits; r++)
                    ((t = this.$editors[r]).container.style.width = e + 'px'),
                      (t.container.style.top = r * s + 'px'),
                      (t.container.style.left = '0px'),
                      (t.container.style.height = s + 'px'),
                      t.resize()
                }
              })
          }.call(u.prototype),
            function () {
              ;(this.execute = function (t) {
                ...
                (this.undo = function () {
                  var t = this.$u.undo(!0)
                  t && this.$doc.selection.setSelectionRange(t)
                }),
                (this.redo = function () {
                  var t = this.$u.redo(!0)
                  t && this.$doc.selection.setSelectionRange(t)
    ...
    N5VM: function (t, e, n) {
      ...
      n('JTaG')
      var d = (0, i.getAceInstance)(),
        g = d.acequire('ace/range').Range,
        b = d.acequire('ace/split').Split,
        m = (function (t) {
          function e(t) {
            var n
            return (
              ...
              i.editorEvents.forEach(function (t) {
                n[t] = n[t].bind(p(n))
              }),
              (n.debounce = i.debounce),
              n
            )
          }
          var n, s, _
            ...
            (s = [
              {
                ...
                value: function () {
                  var t = this,
                    ...
                    O = e.markers,
                    E = e.splits
                  ;(this.editor = d.edit(this.refEditor)), r && r(d)
                  var S = Object.keys(this.props.editorProps),
                    C = new b(this.editor.container, 'ace/theme/'.concat(_), E)
                  ...
                  var T = this.splitEditor.$options
                  this.props.debounceChangePeriod &&
                    (this.onChange = this.debounce(this.onChange, this.props.debounceChangePeriod)),
                    C.forEach(function (e, n) {
                      for (var r = 0; r < S.length; r++) e[S[r]] = t.props.editorProps[S[r]]
                      var a = (0, o.default)(l, n),
                        b = (0, o.default)(h, n, '')
                      e.session.setUndoManager(new d.UndoManager()),
                        e.setTheme('ace/theme/'.concat(_)),
                        e.renderer.setScrollMargin(y[0], y[1], y[2], y[3]),
                        e.getSession().setMode('ace/mode/'.concat(s)),
                        e.setFontSize(u),
                        e.renderer.setShowGutter(p),
                        e.getSession().setUseWrapMode(f),
                        e.setShowPrintMargin(g),
                        ...
                        e.getSession().selection.on('changeSelection', t.onSelectionChange),
                        e.getSession().selection.on('changeCursor', t.onCursorChange),
                        e.session.on('changeScrollTop', t.onScroll),
                        e.setValue(void 0 === a ? b : a, c)
                      var m = (0, o.default)(x, n, []),
                        w = (0, o.default)(O, n, [])
                      e.getSession().setAnnotations(m), w && w.length > 0 && t.handleMarkers(w, e)
                      for (var E = 0; E < i.editorOptions.length; E++) {
                        var C = i.editorOptions[E]
                        T.hasOwnProperty(C)
                          ? e.setOption(C, t.props[C])
                          : t.props[C] &&
                            console.warn(
                      ...
                      t.handleOptions(t.props, e),
                        ...
                        v && e.setKeyboardHandler('ace/keyboard/' + v)
                    }),
                    n && (this.refEditor.className += ' ' + n),
                    a && this.splitEditor.focus()
                  var R = this.editor.env.split
                  R.setOrientation('below' === this.props.orientation ? R.BELOW : R.BESIDE),
                    R.resize(!0),
                    w && w(R)
                }
              },
              {
                ...
                value: function (t) {
                  ...
                  if (
                    (r.splits !== n.splits && s.setSplits(r.splits),
                    r.orientation !== n.orientation &&
                      s.setOrientation('below' === r.orientation ? s.BELOW : s.BESIDE),
                    s.forEach(function (t, s) {
                      r.mode !== n.mode && t.getSession().setMode('ace/mode/' + r.mode),
                        r.keyboardHandler !== n.keyboardHandler &&
                          (r.keyboardHandler
                            ? t.setKeyboardHandler('ace/keyboard/' + r.keyboardHandler)
                        ...
                        r.showGutter !== n.showGutter && t.renderer.setShowGutter(r.showGutter)
                      for (var _ = 0; _ < i.editorOptions.length; _++) {
                        var u = i.editorOptions[_]
                        r[u] !== n[u] && t.setOption(u, r[u])
                      }
                      ;(0, a.default)(r.setOptions, n.setOptions) || e.handleOptions(r, t)
                      var h = (0, o.default)(r.value, s, '')
                      if (t.getValue() !== h) {
                        e.silent = !0
                      ...
                      var c = (0, o.default)(r.annotations, s, []),
                        p = (0, o.default)(n.annotations, s, [])
                      ;(0, a.default)(c, p) || t.getSession().setAnnotations(c)
                      var f = (0, o.default)(r.markers, s, []),
                        d = (0, o.default)(n.markers, s, [])
                      !(0, a.default)(f, d) && Array.isArray(f) && e.handleMarkers(f, t)
                    }),
                    r.className !== n.className)
                  ) {
                    var _ = this.refEditor.className.trim().split(' ')
                    n.className
                      .trim()
                      .split(' ')
                      .forEach(function (t) {
                      ...
                      (this.refEditor.className = ' ' + r.className + ' ' + _.join(' '))
                  }
                  r.theme !== n.theme && s.setTheme('ace/theme/' + r.theme),
                    r.focus && !n.focus && this.splitEditor.focus(),
                    (r.height === this.props.height && r.width === this.props.width) ||
                      this.editor.resize()
                }
              },
              {
              ...
              },
              {
                key: 'handleOptions',
                value: function (t, e) {
                  for (var n = Object.keys(t.setOptions), i = 0; i < n.length; i++)
                    e.setOption(n[i], t.setOptions[n[i]])
                }
              },
              {
                key: 'handleMarkers',
                value: function (t, e) {
                  ...
                  for (var i in n) n.hasOwnProperty(i) && e.getSession().removeMarker(n[i].id)
                  ...
                  t.forEach(function (t) {
                    var n = t.startRow,
                      ...
                      u = void 0 !== _ && _,
                      h = new g(n, i, r, s)
                    e.getSession().addMarker(h, a, o, u)
                  })
                }
              },
              {
                ...
                value: function () {
                  var t = this.props,
                    ...
                    n = (function (t) {
                      ...
                      return t
                    })({ width: t.width, height: t.height }, t.style)
                  return r.default.createElement('div', { ref: this.updateRef, id: e, style: n })
                }
              }
            ]) && l(n.prototype, s),
            _ && l(n, _),
      ...
      ;(e.default = m),
        (m.propTypes = {
          mode: s.default.string,
          splits: s.default.number,
          orientation: s.default.string,
          focus: s.default.bool,
          theme: s.default.string,
          name: s.default.string,
          className: s.default.string,
          height: s.default.string,
          width: s.default.string,
          fontSize: s.default.oneOfType([s.default.number, s.default.string]),
          showGutter: s.default.bool,
          onChange: s.default.func,
          onCopy: s.default.func,
          onPaste: s.default.func,
          onFocus: s.default.func,
          onInput: s.default.func,
          onBlur: s.default.func,
          onScroll: s.default.func,
          value: s.default.arrayOf(s.default.string),
          defaultValue: s.default.arrayOf(s.default.string),
          debounceChangePeriod: s.default.number,
          onLoad: s.default.func,
          onSelectionChange: s.default.func,
          onCursorChange: s.default.func,
          onBeforeLoad: s.default.func,
          minLines: s.default.number,
          maxLines: s.default.number,
          readOnly: s.default.bool,
          highlightActiveLine: s.default.bool,
          tabSize: s.default.number,
          showPrintMargin: s.default.bool,
          cursorStart: s.default.number,
          editorProps: s.default.object,
          setOptions: s.default.object,
          style: s.default.object,
          scrollMargin: s.default.array,
          annotations: s.default.array,
          markers: s.default.array,
          keyboardHandler: s.default.string,
          wrapEnabled: s.default.bool,
          enableBasicAutocompletion: s.default.oneOfType([s.default.bool, s.default.array]),
          enableLiveAutocompletion: s.default.oneOfType([s.default.bool, s.default.array]),
          commands: s.default.array
        }),
        (m.defaultProps = {
          name: 'brace-editor',
          focus: !1,
    ...
    NCrt: function (module, __webpack_exports__, __webpack_require__) {
      'use strict'
      __webpack_require__.r(__webpack_exports__)
      var _babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
          'rePB'
        ),
        _babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
          '1OyB'
        ),
        _babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
          'vuIU'
        ),
        _babel_runtime_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
          'JX7q'
        ),
        _babel_runtime_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
          'Ji7U'
        ),
        _babel_runtime_helpers_esm_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
          'md7G'
        ),
        _babel_runtime_helpers_esm_getPrototypeOf__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
          'foSv'
        ),
        react__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__('q1tI'),
        react__WEBPACK_IMPORTED_MODULE_7___default = __webpack_require__.n(
          react__WEBPACK_IMPORTED_MODULE_7__
        ),
        _components_editor__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__('uLGy'),
        _functions_titleCase__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__('XAyo'),
        sandhands__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__('Sca8'),
        sandhands__WEBPACK_IMPORTED_MODULE_10___default = __webpack_require__.n(
          sandhands__WEBPACK_IMPORTED_MODULE_10__
        ),
        _functions_objectToLiteralString__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
          'xJFj'
        ),
        js_beautify__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__('5VLF'),
        js_beautify__WEBPACK_IMPORTED_MODULE_12___default = __webpack_require__.n(
          js_beautify__WEBPACK_IMPORTED_MODULE_12__
        ),
        sandhands_package_json__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__('LN1d'),
        sandhands_package_json__WEBPACK_IMPORTED_MODULE_13___namespace = __webpack_require__.t(
          'LN1d',
          1
        ),
        react_highlight__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__('xj1T'),
        react_highlight__WEBPACK_IMPORTED_MODULE_14___default = __webpack_require__.n(
          react_highlight__WEBPACK_IMPORTED_MODULE_14__
        ),
        _styles_sandbox_less__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__('GzY7'),
        _styles_sandbox_less__WEBPACK_IMPORTED_MODULE_15___default = __webpack_require__.n(
          _styles_sandbox_less__WEBPACK_IMPORTED_MODULE_15__
        ),
        __jsx = react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement
        ...
        for (var e = 1; e < arguments.length; e++) {
          ...
          e % 2
            ? ownKeys(Object(n), !0).forEach(function (e) {
                Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__.a)(
                  t,
                  e,
                  n[e]
                )
      ...
      function _createSuper(t) {
        ...
        return function () {
          var n,
            i = Object(_babel_runtime_helpers_esm_getPrototypeOf__WEBPACK_IMPORTED_MODULE_6__.a)(t)
          if (e) {
            var r = Object(
              _babel_runtime_helpers_esm_getPrototypeOf__WEBPACK_IMPORTED_MODULE_6__.a
            )(this).constructor
            n = Reflect.construct(i, arguments, r)
          } else n = i.apply(this, arguments)
          return Object(
            _babel_runtime_helpers_esm_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_5__.a
          )(this, n)
        }
      }
      ...
      var Sandbox = (function (_Component) {
        Object(_babel_runtime_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_4__.a)(
          Sandbox,
          _Component
        )
        ...
        function Sandbox(t) {
          var e
          return (
            Object(_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_1__.a)(
              this,
              Sandbox
            ),
            ((e = _super.call(this, t)).state = {
              mode: 'details',
            ...
            ['setMode', 'getOutput', 'setObject', 'handleChange', 'onError'].forEach(function (t) {
              return (e[t] = e[t].bind(
                Object(
                  _babel_runtime_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3__.a
                )(e)
              ))
            }),
            e
        ...
        return (
          Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__.a)(Sandbox, [
            {
              key: 'render',
              value: function () {
                var t = this
                return __jsx(
                  ...
                  __jsx(
                    'div',
                    { className: 'editors' },
                    this.state.editors.map(function (e, n) {
                      return __jsx(
                        'div',
                        { key: n, className: 'editor' },
                        __jsx(
                          'h2',
                          { className: 'name' },
                          Object(_functions_titleCase__WEBPACK_IMPORTED_MODULE_9__.a)(e)
                        ),
                        __jsx(_components_editor__WEBPACK_IMPORTED_MODULE_8__.a, {
                          ...
                          onChange: function () {
                            for (var n = arguments.length, i = new Array(n), r = 0; r < n; r++)
                              i[r] = arguments[r]
                            t.handleChange.apply(t, [e].concat(i))
                          }
                        }),
                        __jsx(
                          'p',
                          null,
                          null !== t.state.objects[e] ? 'V' : 'Inv',
                          'alid Syntax ',
                          null !== t.state.objects[e] ? '\u2714' : '\u2716'
                        )
                      )
                    })
                  ),
                  __jsx(
                    ...
                    __jsx(
                      'select',
                      { className: 'modes', onChange: this.setMode },
                      __jsx('option', { value: 'details' }, 'Details'),
                      __jsx('option', { value: 'sanitize' }, 'Sanitize'),
                      __jsx('option', { value: 'valid' }, 'Valid')
                    )
                  ),
                  __jsx(
                    'div',
                    { className: 'output ' + this.state.mode },
                    __jsx(
                      react_highlight__WEBPACK_IMPORTED_MODULE_14___default.a,
                  ...
                  __jsx(
                    'span',
                    { className: 'version' },
                    'Sandbox using Sandhands@',
                    sandhands_package_json__WEBPACK_IMPORTED_MODULE_13__.a
                  )
                )
              }
            },
            {
              key: 'componentDidMount',
              value: function () {
                window.Format = sandhands__WEBPACK_IMPORTED_MODULE_10__.Format
              }
            },
            {
              key: 'handleChange',
              value: function handleChange(editor, value) {
                var values = _objectSpread({}, this.state.values),
                  object
                ;(values[editor] = value), this.setState({ values: values })
                try {
            ...
            },
            {
              ...
              value: function (t) {
                ...
                this.setState({ mode: e, output: this.getOutput(this.state.objects, e) })
              }
            },
            {
              key: 'onError',
              value: function (t, e) {
                console.error(e), this.setObject(t, null)
              }
            },
            {
              key: 'setObject',
              value: function (t, e) {
                var n = _objectSpread({}, this.state.objects)
                ;(n[t] = e),
                  this.setState({ objects: n }),
                  null !== n.input && null !== n.format
                    ? this.setState({ output: this.getOutput(n) })
            ...
            },
            {
              ...
              value: function (t, e) {
                var n = t.input,
                  i = t.format
                if ('details' === (e = e || this.state.mode))
                  try {
                    return js_beautify__WEBPACK_IMPORTED_MODULE_12___default()(
                      Object(_functions_objectToLiteralString__WEBPACK_IMPORTED_MODULE_11__.a)(
                        Object(sandhands__WEBPACK_IMPORTED_MODULE_10__.details)(n, i)
                      )
                    )
                  } catch (r) {
                    return console.error(r), this.setObject('format', null), null
                  }
                else {
                  if ('sanitize' !== e)
                    return 'valid' === e
                      ? Object(sandhands__WEBPACK_IMPORTED_MODULE_10__.valid)(n, i).toString()
                      : 'There was an error'
                  try {
                    return (
                      Object(sandhands__WEBPACK_IMPORTED_MODULE_10__.sanitize)(n, i), 'Error: null'
                    )
                  } catch (r) {
      ...
      __webpack_exports__.default = Sandbox
    },
    'Sc/Q': function (t, e, n) {
      'use strict'
    ...
    Sca8: function (t, e, n) {
          ...
          (function (t, e) {
            ...
            try {
              for (
                ...
                !(i = (a = o.next()).done) && (n.push(a.value), !e || n.length !== e);
                i = !0
              );
            } catch (_) {
              ;(r = !0), (s = _)
        ...
        if ('object' == i(t) && null !== t) {
          if (Array.isArray(t)) {
            for (var n = 0; n < t.length; n++) {
              var r = t[n]
              if ((!0 === e && (r = p(r, !0)), null !== r)) return r
            }
            return null
          }
          for (var s = Object.values(t), a = 0; a < s.length; a++) {
            var o = s[a]
            if ((!0 === e && (o = p(o, !0)), null !== o)) return o
          }
          return null
        }
        return t
      ...
      function f(t, e, n, i) {
        if (!Array.isArray(e)) return 'Expected Array'
        var r = i.firstAsStandard,
          s = i.strict,
          a = i.minLength,
          o = i.maxLength,
          _ = i.length
        n === Array && ((n = []), i.hasOwnProperty('strict') || (s = !1))
        var u = h(n)
        if (
          (i.hasOwnProperty('firstAsStandard') ||
            i.hasOwnProperty('standard') ||
            1 !== n.length ||
            (r = !0),
          !0 === i.firstAsStandard && i.hasOwnProperty('standard'))
        )
          throw new Error('Cannot both specify standard manually and set firstAsStandard to true.')
        var l = !0 === r || i.hasOwnProperty('standard'),
          c = i.standard || null
        if (!0 === r) {
          if (n.length < 1) throw new Error('Missing First Array Value for First As Standard')
          c = u.splice(0, 1)[0]
        }
        if (
          (!i.hasOwnProperty('minLength') && (u.length > 0 || !0 === l) && (a = 1),
          'number' == typeof a && e.length < a)
        )
          return 'Array Too Short'
        if (i.hasOwnProperty('maxLength') && e.length > o) return 'Array Too Long'
        if (i.hasOwnProperty('length') && e.length !== _) return 'Incorrect Array Length'
        var p = []
        return (
          Array.prototype.forEach.call(e, function (e, i) {
            if (u.hasOwnProperty(i)) {
              ...
              var a = t(e, c)
              null !== a && (p[i] = a)
            } else !0 === s && (p[i] = 'Invalid Index #' + i)
          }),
          !0 === s &&
            u.forEach(function (t, n) {
              Object.prototype.hasOwnProperty.call(e, n) || (p[n] = 'Missing Index #' + n)
            }),
          p.length < 1 ? null : p
        )
      }
      function d(t) {
        for (
          ...
          null !== t &&
          !Array.isArray(t) &&
          (t.hasOwnProperty('_') || t.hasOwnProperty('_or'));

        ) {
          if ((Object.assign(n, t), t.hasOwnProperty('_or'))) {
            var o = n._or
            r.includes(o) ||
              (Array.isArray(o) ? (r = Array.from(new Set(r.concat(o)))) : r.push(o)),
              delete n._or
          }
          if (t.hasOwnProperty('_and')) {
            var _ = n._and
            s.includes(_) ||
              (Array.isArray(_) ? (s = Array.from(new Set(s.concat(_)))) : s.push(_)),
              delete n._and
          }
          if (t.hasOwnProperty('_not')) {
            var u = n._not
            a.includes(u) ||
              (Array.isArray(u) ? (a = Array.from(new Set(a.concat(u)))) : a.push(u)),
              delete n._not
          }
          t.hasOwnProperty('_') && (delete n._, (t = t._))
        }
        if ((r.length > 0) + (s.length > 0) + (a.length > 0) > 1)
          throw new Error(
            'Cannot use more than one boolean logic condition of differing kinds at the same depth'
          )
        return (
          Object.assign(n, e), { options: n, format: t, ORFormats: r, ANDFormats: s, NOTFormats: a }
        )
      }
      function g(t, e, n, r) {
        if ((n === Object && (n = {}), 'object' != i(e) || null === e || Array.isArray(e)))
          return 'Expected Object'
        var s = {},
          a = r.strict,
          o = r.standard
        return (
          !r.hasOwnProperty('strict') &&
            r.hasOwnProperty('standard') &&
            ((function (t) {
              throw new Error('"' + t + '" is read-only')
            })('strict'),
            (a = !1)),
          (!0 === a || r.hasOwnProperty('standard')) &&
            Object.keys(e).forEach(function (i) {
              if (!n.hasOwnProperty(i))
                if (r.hasOwnProperty('standard')) {
                  var a = t(e[i], o)
                  null !== a && (s[i] = a)
                } else s[i] = 'Invalid Property'
            }),
          Object.entries(n).forEach(function (n) {
            ...
            if (!s[r]) {
              ...
              if (Object.prototype.hasOwnProperty.call(e, r)) {
                ...
                var l = t(e[r], o, h)
                null !== l && (s[r] = l)
              } else !0 !== h.optional && !0 === a && (s[r] = 'Property Required')
            }
          }),
          Object.keys(s).length < 1 ? null : s
        )
      }
      Object.defineProperty(e, '__esModule', { value: !0 })
      var b = {
        email: { _: String, email: !0, lowercase: !0 },
        username: {
          _: String,
          regex: /^[a-zA-Z\-0-9]+$/,
          trimmed: !0,
          ...
          validate: [
            function (t) {
              return !t.startsWith('-') || 'Username cannot begin with a dash'
            },
            function (t) {
              return !t.endsWith('-') || 'Username cannot end with a dash'
            },
            function (t) {
              return !t.includes('--') || 'Username cannot include consecutive dashes'
            }
          ]
        },
      ...
      function y(t) {
        if ('string' == typeof t) {
          if (!b.hasOwnProperty(t)) throw new Error('Custom Format "'.concat(t, '" Not Found'))
          return b[t]
        }
        if ('object' == i(t) && null !== t) {
          if (Array.isArray(t)) return t.map(y)
          if (t.hasOwnProperty('_')) return _(_({}, t), {}, { _: y(t._) })
          var e = {}
          return (
      ...
      var v = new Map([
        ...
        w = Object.freeze(['equalTo', 'validate']),
        k = new Map([
          [
            String,
            Object.freeze([
      ...
      Object.defineProperties(k, {
        ...
        Object.freeze(k)
      var x = Object.freeze(['strict', 'standard']),
        O = Object.freeze([
          'strict',
          'firstAsStandard',
          'minLength',
        ...
        E = Object.freeze({ universal: w, primitives: k, object: x, array: O })
      function S(t) {
        var e = t.strict
        return t.hasOwnProperty('strict') && 'boolean' != typeof e ? 'Invalid Strict Option' : null
      }
      var C = Object.freeze(function t() {
          r(this, t)
        }),
        T = [String, Number, Boolean, null, void 0, Function],
        R = new Map([
          [
            String,
            function (t) {
              var e = t.regex,
                ...
                u = t.whitespace,
                h = t.trimmed
              return t.hasOwnProperty('email') && 'boolean' != typeof _
                ? 'Invalid Email Option'
                : t.hasOwnProperty('minLength') && ('number' != typeof n || !isFinite(n) || n < 0)
                ? 'Invalid Minimum Length Option'
                : t.hasOwnProperty('maxLength') &&
                  ('number' != typeof t.maxLength || !isFinite(t.maxLength) || t.maxLength < 0)
                ? 'Invalid Maximum Length Option'
                : t.hasOwnProperty('length') && ('number' != typeof i || !isFinite(i) || i < 0)
                ? 'Invalid Length Option'
                : t.hasOwnProperty('allowed') && ('string' != typeof r || r.length < 1)
                ? 'Invalid Allowed Option'
                : t.hasOwnProperty('banned') && ('string' != typeof s || s.length < 1)
                ? 'Invalid Banned Option'
                : (t.hasOwnProperty('lowercase') && 'boolean' != typeof a) ||
                  (t.hasOwnProperty('uppercase') && 'boolean' != typeof o)
                ? 'Invalid Lowercase Option'
                : t.hasOwnProperty('whitespace') && 'boolean' != typeof u
                ? 'Invalid Whitespace Option'
                : !t.hasOwnProperty('regex') || e instanceof RegExp
                ? t.hasOwnProperty('trimmed') && 'boolean' != typeof h
                  ? 'Invalid Trimmed Option'
                  : null
          ...
          [
            ...
            function (t) {
              var e = t.allowNaN,
                ...
                s = t.even,
                a = t.odd
              return t.hasOwnProperty('allowNaN') && 'boolean' != typeof e
                ? 'Invalid AllowNaN Option'
                : t.hasOwnProperty('finite') && 'boolean' != typeof n
                ? 'Invalid Finite Option'
                : t.hasOwnProperty('min') && 'number' != typeof i && !isFinite(i)
                ? 'Invalid Min Option'
                : !t.hasOwnProperty('max') || ('number' == typeof r && isFinite(r))
                ? t.hasOwnProperty('even') && 'boolean' != typeof s
                  ? 'Invalid Even Option'
                  : t.hasOwnProperty('odd') && 'boolean' != typeof a
                  ? 'Invalid Odd Option'
                  : null
                : 'Invalid Max Option'
            }
      ...
      function M(t) {
        var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}
        if ('object' != i(e) || null === e) return 'Options Not Object'
        var n = d(t, e)
        ;(t = n.format), delete (e = n.options).optional
        var r = [],
          s = 'Internal Error'
        if (T.includes(t)) {
          if (((s = j.get(t)), E.primitives.has(t) && (r = E.primitives.get(t)), R.has(t))) {
            var a = R.get(t)(e)
            if (null !== a) return a
          }
        } else if (Array.isArray(t) || t === Array) (s = 'Array'), (r = E.array)
        else if (('object' == i(t) && null !== t) || t === Object) {
          ;(s = 'Object'), (r = E.object)
          var o = S(e)
          if (null !== o) return o
        } else if (t !== C) return 'Invalid Format Type'
        r = r.concat(E.universal)
        var _ = Object.keys(e).filter(function (t) {
            return !r.includes(t)
          }),
          u = _[0]
        return _.length > 0 ? 'Invalid Option "'.concat(u, '" for Format ').concat(s) : null
      }
      function A(t, e, n) {
        ...
        if (arguments.length > 2 && ('object' != i(n) || null === n))
          throw new Error('Options Invalid')
        var r = M(e, n)
        if (null !== r) throw new Error(r)
      }
      function P(t) {
        if ('object' == i(t) && null !== t) {
          if (t instanceof I) return P(t.format)
          if (t.hasOwnProperty('_')) return _(_({}, t), {}, { _: P(t._) })
      ...
      function N() {
        ...
        ;(e[1] = P(e[1])), (e[1] = y(e[1])), A.apply(void 0, e)
        var i = V.apply(void 0, e),
          r = p(i, !0)
        if (null !== r) {
          var s = new Error(r)
          throw ((s.sanitationDetails = i), s)
        }
        return !0
      }
      function L() {
        for (var t = arguments.length, e = new Array(t), n = 0; n < t; n++) e[n] = arguments[n]
        return (e[1] = P(e[1])), (e[1] = y(e[1])), A.apply(void 0, e), null === V.apply(void 0, e)
      }
      var I = (function () {
          function t(e, n) {
            r(this, t), M(e, n), (this.format = _(_({}, n || {}), {}, { _: e }))
          }
          var e, n, i
          return (
            (e = t),
            (n = [
              {
                key: 'details',
                value: function (t) {
                  return G(t, this.format)
                }
              },
              {
                key: 'valid',
                value: function (t) {
                  return L(t, this.format)
                }
              },
              {
                key: 'sanitize',
                value: function (t) {
                  return N(t, this.format)
                }
              },
              {
                key: 'Or',
                value: function () {
                  for (var t = arguments.length, e = new Array(t), n = 0; n < t; n++)
                    e[n] = arguments[n]
                  if (e.length < 1) throw new Error('Must supply at least 1 format')
                  e.forEach(function (t) {
                    return M(t)
                  }),
                    (this.format = { _: this.format, _or: e })
                }
              },
              {
                key: 'And',
                value: function () {
                  ...
                  e.forEach(function (t) {
                    ...
                    (this.format = { _: this.format, _and: e })
                }
              },
              {
                key: 'Not',
                value: function () {
                  ...
                  e.forEach(function (t) {
                    ...
                    (this.format = { _: this.format, _not: e })
                }
              }
            ]) && s(e.prototype, n),
            i && s(e, i),
        ...
        D = ['details', 'valid', 'sanitize'],
        U = {
          get: function (t, e) {
            if (t === K) return K[e]
            if (!(t instanceof I)) throw new Error('Expected Format Instance')
            if ('constructor' === e) throw new Error('Cannot retrieve the contructor')
            if ('format' === e) return t.format
              ...
              return D.includes(e)
                ...
                : function () {
                    for (var e = arguments.length, i = new Array(e), r = 0; r < e; r++)
                      i[r] = arguments[r]
                    return n.apply(t, i), new Proxy(t, U)
                  }
            }
            return function () {
              var n = !(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0]
              return (t.format[e] = n), new Proxy(t, U)
            }
          },
          construct: function (t, e) {
            return K.apply(void 0, h(e))
          }
        }
      function K() {
        for (var t = arguments.length, e = new Array(t), n = 0; n < t; n++) e[n] = arguments[n]
        if (e.length < 1) throw new Error('Must supply a format.')
        var i = e[0],
          r = e[1]
        return new Proxy(new I(i, r), U)
      }
      var W = new Proxy(K, U),
      ...
      function F(t, e) {
        ...
        if ('function' == typeof t && t.toString() !== e.toString()) return !1
      ...
      var J = new Map([
        [
          ...
          function (t, e) {
            var n,
              ...
              c = e.whitespace,
              p = e.trimmed
            if ('string' != typeof t) return 'Expected String'
            if (e.hasOwnProperty('email') && !0 === l && ((n = t), !z.test(n)))
              return 'Email Invalid'
            if (e.hasOwnProperty('minLength') && t.length < r) return 'Too short'
            if (e.hasOwnProperty('maxLength') && t.length > e.maxLength) return 'Too long'
            if (e.hasOwnProperty('length') && t.length != s) return 'Incorrect Length'
            if (e.hasOwnProperty('allowed')) {
              var f = h(t).find(function (t) {
                return !a.includes(t)
              })
              if (f) return 'Character not allowed "'.concat(f, '"')
            }
            if (e.hasOwnProperty('banned')) {
              var d = h(t).find(function (t) {
                return o.includes(t)
              })
              if (d) return 'Character not allowed "'.concat(d, '"')
            }
            if (e.hasOwnProperty('lowercase') && !0 === _ && t.toLowerCase() != t)
              return 'Lowercase only'
            if (e.hasOwnProperty('uppercase') && !0 === u && t.toUpperCase() != t)
              return 'Uppercase only'
            if (e.hasOwnProperty('whitespace') && !1 === c && /\s/.test(t)) return 'No whitespace'
            if (e.hasOwnProperty('regex') && !0 !== i.test(t)) return 'Failed regex'
            if (e.hasOwnProperty('trimmed') && !0 === p) {
              if (/^\s/.test(t)) return 'Cannot start with whitespace'
              if (/\s$/.test(t)) return 'Cannot end with whitespace'
            }
            return null
          }
        ],
        [
          Number,
          function (t, e) {
            if ('number' != typeof t) return 'Expected Number'
            var n = e.allowNaN,
              i = e.finite,
              r = e.min,
              s = e.max,
              ...
              o = e.odd,
              _ = e.integer
            if (e.hasOwnProperty('allowNaN')) {
              if ('boolean' != typeof n) throw new Error('Invalid AllowNaN Option')
              if (!1 === n && isNaN(t)) return 'NaN not allowed'
            }
            if (e.hasOwnProperty('finite')) {
              if ('boolean' != typeof i) throw new Error('Invalid Finite Option')
              if (!0 === i && !isFinite(t) && !isNaN(t)) return 'Infinity not allowed'
            }
            if (e.hasOwnProperty('min')) {
              if ('number' != typeof r && !isFinite(r)) throw new Error('Invalid Min Option')
              if (t < r) return 'Too small'
            }
            if (e.hasOwnProperty('max')) {
              if ('number' != typeof s || !isFinite(s)) throw new Error('Invalid Max Option')
              if (t > s) return 'Too great'
            }
            if (e.hasOwnProperty('even')) {
              if ('boolean' != typeof a) throw new Error('Invalid Even Option')
              if (!0 === a && t % 2 != 0) return 'Not even'
            }
            if (e.hasOwnProperty('odd')) {
              if ('boolean' != typeof o) throw new Error('Invalid Odd Option')
              if (!0 === o && t % 2 != 1) return 'Not odd'
            }
            if (e.hasOwnProperty('integer')) {
              if ('boolean' != typeof _) throw new Error('Invalid Integer Option')
              if (!0 === _ && t % 1 !== 0) return 'Not an integer'
            }
            return null
          }
        ],
        [
          Boolean,
          function (t, e) {
            return 'boolean' != typeof t ? 'Expected Boolean' : null
          }
        ],
        [
          null,
          function (t, e) {
            return null !== t ? 'Expected Null' : null
          }
        ],
        [
          void 0,
          function (t, e) {
            return void 0 !== t ? 'Expected Undefined' : null
          }
        ],
        [
          Function,
          function (t, e) {
            return 'function' != typeof t ? 'Expected Function' : null
          }
        ]
      ])
      function q(t, e) {
        ...
        if (o.length > 0) {
          var y = q(t, e, n)
          if (null !== y) return y
          for (var w = 0, k = o.length; w < k; w++) {
            var x = q(t, o[w])
            if (null === x) return 'Something was NOT allowed'
          }
          return null
        }
        if (n.hasOwnProperty('equalTo') && !F(t, n.equalTo)) return 'Input Not Equal'
        if (J.has(e)) {
          v.has(e) && (n = Object.assign({}, v.get(e), n))
          var O = J.get(e)(t, n)
          if (null !== O) return O
        } else if (Array.isArray(e) || e === Array) {
          var E = f(q, t, e, (n = Object.assign({}, v.get(Array), n)))
          if (null !== E) return E
        } else if ('object' == i(e) || e === Object) {
          var S = g(q, t, e, (n = Object.assign({}, v.get(Object), n)))
          if (null !== S) return S
        } else if (e !== C) throw new Error('Invalid Format')
        if (n.hasOwnProperty('validate'))
          if (Array.isArray(n.validate))
            for (var T = 0; T < n.validate.length; T++) {
              var R = n.validate[T](t)
              if ('string' == typeof R) {
                if (R.length < 1)
              ...
              if (!1 === R) return 'Failed Validation Function'
            }
          else {
            var j = n.validate(t)
            if ('string' == typeof j) {
            ...
            if ('boolean' != typeof j)
              throw new Error('Validation Function Returned Unexpected output')
            if (!1 === j) return 'Failed Validation Function'
          }
        return null
      }
      function V(t, e, n) {
        return (arguments[1] = y(arguments[1])), q.apply(void 0, arguments)
      }
      function G() {
        for (var t = arguments.length, e = new Array(t), n = 0; n < t; n++) e[n] = arguments[n]
        return (e[1] = P(e[1])), (e[1] = y(e[1])), A.apply(void 0, e), V.apply(void 0, e)
      }
      var Q = W
      ;(e.ANY = C),
        (e.And = function () {
          for (var t = arguments.length, e = new Array(t), n = 0; n < t; n++) e[n] = arguments[n]
          if (e.length < 2) throw new Error('Must supply at least 2 formats')
          return (
            e.forEach(function (t) {
              return M(t)
            }),
            { _: e[0], _and: e.slice(1) }
          )
        }),
        (e.F = Q),
        (e.Format = W),
        ...
        (e.allowedOptions = E),
        (e.customFormat = function t(e, n) {
          if (1 !== arguments.length || 'object' != i(arguments[0]) || null === arguments[0]) {
            if ('string' != typeof e || e.length < 1) throw new Error('Custom Format Name Invalid')
            var r = M(n)
            if (null !== r) throw new Error('Custom Format Invalid, "'.concat(n, '"'))
            b[e] = n
          } else
            Object.entries(arguments[0]).forEach(function (e) {
              var n = u(e, 2)
              t(n[0], n[1])
            })
        }),
        (e.details = G),
        (e.getFormatErrors = function (t) {
          if (arguments.length < 1) throw new Error('Must supply a format')
          return M(t)
        }),
        (e.sandhandsExpress = function (t) {
          var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
            n = M((t = y((t = P(t)))), e)
          if (null !== n) throw new Error(n)
          return function (n, i, r) {
            if (!n.hasOwnProperty('body')) return i.status(500).send('Expected Body')
            var s = G(n.body, t, e)
            if (null !== s) return i.status(400).json(s)
            r()
          }
        }),
        (e.sanitize = N),
        (e.setDefault = function (t, e) {
          if (
            ((function (t) {
              return !('object' != i(t) || null === t || Object.getOwnPropertyNames(t).length > 0)
            })(t) && (t = Object),
            Array.isArray(t) && 0 === t.length && (t = []),
            !v.has(t))
          )
            throw new Error('Invalid Type')
          var n = M(t === Object ? {} : t === Array ? [] : t, e)
          if (null !== n) throw new Error('Invalid Default Options, Error: "'.concat(n, '"'))
          v.set(t, Object.assign({}, v.get(t), e))
        }),
        (e.valid = L)
    },
    TXwP: function (t, e, n) {
          ...
          function (t, e, n) {
            ...
            ;(p.prototype.eatString = function (t) {
              ...
              (p.prototype.eatWhitespace = function (t) {
                for (var e = u.test(this._input.peek()), n = !0; u.test(this._input.peek()); )
                  (this._ch = this._input.next()),
                    t &&
                      '\n' === this._ch &&
              ...
              (p.prototype.beautify = function () {
                ...
                ;(this._output = new r(this._options, n)),
                  ...
                  (this._ch = null)
                for (
                  var i, p, f = 0, d = !1, g = !1, b = !1, m = !1, y = !1, v = this._ch;
                  ...
                  if ('/' === this._ch && '*' === this._input.peek()) {
                    ...
                    var w = this._input.read(l),
                      k = a.get_directives(w)
                    k && 'start' === k.ignore && (w += a.readIgnored(this._input)),
                      this.print_string(w),
                    ...
                    (this._output.space_before_token = !0),
                      this._input.back(),
                      this.print_string(this._input.read(c)),
                      this.eatWhitespace(!0)
                  else if ('@' === this._ch)
                    if ((this.preserveSingleSpace(i), '{' === this._input.peek()))
                      ...
                      x.match(/[ :]$/) &&
                        ((x = this.eatString(': ').replace(/\s$/, '')),
                        this.print_string(x),
                        (this._output.space_before_token = !0)),
                        'extend' === (x = x.replace(/\s$/, ''))
                          ? (m = !0)
                          : 'import' === x && (y = !0),
                        x in this.NESTED_AT_RULE
                          ? ((this._nestedLevel += 1), x in this.CONDITIONAL_GROUP_RULE && (b = !0))
                          : d || 0 !== f || -1 === x.indexOf(':') || ((g = !0), this.indent())
                    }
                  else
                    '#' === this._ch && '{' === this._input.peek()
                      ...
                      ? (g && ((g = !1), this.outdent()),
                        b
                          ? ((b = !1), (d = this._indentLevel >= this._nestedLevel))
                      ...
                      ? (this.print_string(this._ch),
                        this.eatWhitespace(!0),
                        !this._options.selector_separator_newline || g || 0 !== f || y
                          ? (this._output.space_before_token = !0)
                          : this._output.add_new_line())
                      : ('>' !== this._ch && '+' !== this._ch && '~' !== this._ch) || g || 0 !== f
                      ? ']' === this._ch
                        ? this.print_string(this._ch)
                        : '[' === this._ch
          ...
          function (t, e, n) {
            ...
            function r(t) {
              ...
              for (var r = 0; r < n.length; r++)
                'expand' !== n[r] ? (this.brace_style = 'collapse') : (this.brace_style = n[r])
            }
    ...
    Uf63: function (t, e, n) {
      ...
      var p = (function (t) {
        function e(t) {
          ...
          return (
            ...
            })(this, h(e).call(this, t))).state = { value: n.props.value }),
            (n.onChange = n.onChange.bind(l(n))),
            (n.diff = n.diff.bind(l(n))),
            n
          )
        }
        var n, s, o
          ...
          (s = [
            ...
            },
            {
              ...
              value: function () {
                ...
                var i = t.diff_main(e, n)
                t.diff_cleanupSemantic(i)
                var r = this.generateDiffedLines(i)
                return this.setCodeMarkers(r)
              }
            },
            {
                  ...
                  t.forEach(function (t) {
                    ...
                    if (0 !== o.length) {
                      ...
                      switch (a) {
                        ...
                        case n:
                          '\n' === u && (s.left++, _--),
                            0 === (l = _) && r.right.push({ startLine: s.right, endLine: s.right }),
                            '\n' === h && (l -= 1),
                            r.left.push({ startLine: s.left, endLine: s.left + l }),
                            (s.left += _)
                          break
                        case i:
                          '\n' === u && (s.right++, _--),
                            0 === (l = _) && r.left.push({ startLine: s.left, endLine: s.left }),
                            '\n' === h && (l -= 1),
                            r.right.push({ startLine: s.right, endLine: s.right + l }),
                            (s.right += _)
                          break
                        default:
            ...
            },
            {
              ...
              value: function () {
                for (
                  ...
                  var r = {
                    startRow: t.left[i].startLine - 1,
                    endRow: t.left[i].endLine,
                    type: 'text',
                    className: 'codeMarker'
                  }
                  n.left.push(r)
                }
                for (var s = 0; s < t.right.length; s++) {
                  var a = {
                    startRow: t.right[s].startLine - 1,
                    endRow: t.right[s].endLine,
                    type: 'text',
                    className: 'codeMarker'
                  }
                  n.right.push(a)
      ...
      ;(e.default = p),
        (p.propTypes = {
          cursorStart: s.default.number,
          editorProps: s.default.object,
          enableBasicAutocompletion: s.default.bool,
          enableLiveAutocompletion: s.default.bool,
          focus: s.default.bool,
          fontSize: s.default.number,
          height: s.default.string,
          highlightActiveLine: s.default.bool,
          maxLines: s.default.func,
          minLines: s.default.func,
          mode: s.default.string,
          name: s.default.string,
          className: s.default.string,
          onLoad: s.default.func,
    ...
    XaGS: function (t, e, n) {
      ;(function (t, n) {
        ...
        ;(c['[object Float32Array]'] = c['[object Float64Array]'] = c['[object Int8Array]'] = c[
          '[object Int16Array]'
        ] = c['[object Int32Array]'] = c['[object Uint8Array]'] = c[
          '[object Uint8ClampedArray]'
        ] = c['[object Uint16Array]'] = c['[object Uint32Array]'] = !0),
          (c[i] = c['[object Array]'] = c['[object ArrayBuffer]'] = c['[object Boolean]'] = c[
            '[object DataView]'
          ] = c['[object Date]'] = c['[object Error]'] = c['[object Function]'] = c[a] = c[
            '[object Number]'
          ] = c[o] = c['[object RegExp]'] = c[_] = c['[object String]'] = c[
            '[object WeakMap]'
          ] = !1)
        ...
        function pt(t, e, n, h, l) {
          return (
            t === e ||
            (null == t || null == e || (!Mt(t) && !Mt(e))
              ? t !== t && e !== e
              : (function (t, e, n, h, l, c) {
                  var p = St(t),
                    f = St(e),
                    d = p ? r : wt(t),
                    g = f ? r : wt(e),
                        ...
                        : (function (t, e, n, i, r, o, h) {
                            switch (n) {
                              ...
                              case '[object ArrayBuffer]':
                                return !(t.byteLength != e.byteLength || !o(new U(t), new U(e)))
                              case s:
                              case '[object Date]':
                              case '[object Number]':
                                return Ot(+t, +e)
                              ...
                              case _:
                                var c = 1 & i
                                if ((l || (l = O), t.size != e.size && !c)) return !1
                                var p = h.get(t)
                                if (p) return p == e
                                ;(i |= 2), h.set(t, e)
                                var f = gt(l(t), l(e), i, r, o, h)
                                return h.delete(t), f
                              case '[object Symbol]':
                  ...
                  if (!(1 & n)) {
                    var v = b && A.call(t, '__wrapped__'),
                      w = m && A.call(e, '__wrapped__')
                    if (v || w) {
                      var k = v ? t.value() : t,
                        E = w ? e.value() : e
                      return c || (c = new _t()), l(k, E, n, h, c)
                    }
                  }
                  if (!y) return !1
                  return (
                    ...
                    (function (t, e, n, i, r, s) {
                      ...
                      for (; h--; ) {
                        var l = o[h]
                        if (!(a ? l in e : A.call(e, l))) return !1
                      }
                      var c = s.get(t)
                      ...
                      for (; ++h < _; ) {
                        var d = t[(l = o[h])],
                          g = e[l]
                        if (i) var b = a ? i(g, d, l, e, t, s) : i(d, g, l, t, e, s)
                        if (!(void 0 === b ? d === g || r(d, g, n, i, s) : b)) {
                          p = !1
                          break
                        }
                        f || (f = 'constructor' == l)
        ...
        function gt(t, e, n, i, r, s) {
          ...
          for (s.set(t, e), s.set(e, t); ++h < o; ) {
            var p = t[h],
              f = e[h]
            if (i) var d = a ? i(f, p, h, e, t, s) : i(p, f, h, t, e, s)
            if (void 0 !== d) {
              if (d) continue
              l = !1
              break
            ...
            if (c) {
              if (
                !k(e, function (t, e) {
                  if (((a = e), !c.has(a) && (p === t || r(p, t, n, i, s)))) return c.push(e)
                  var a
                })
              ) {
                l = !1
        ...
        ;(rt.prototype.clear = function () {
          ...
          (at.prototype.clear = function () {
            ;(this.size = 0),
              (this.__data__ = { hash: new rt(), map: new (V || st)(), string: new rt() })
          }),
          ...
          (_t.prototype.set = function (t, e) {
            ...
            if (n instanceof st) {
              var i = n.__data__
              if (!V || i.length < 199) return i.push([t, e]), (this.size = ++n.size), this
        ...
        ;((q && wt(new q(new ArrayBuffer(1))) != u) ||
          (V && wt(new V()) != a) ||
          (G && '[object Promise]' != wt(G.resolve())) ||
          (Q && wt(new Q()) != _) ||
          (Z && '[object WeakMap]' != wt(new Z()))) &&
          (wt = function (t) {
            var e = lt(t),
        ...
        var Et = ct(
            ...
            ? ct
            : function (t) {
                return Mt(t) && A.call(t, 'callee') && !K.call(t, 'callee')
              },
          St = Array.isArray
        var Ct =
          B ||
        ...
        var At = w
          ...
          : function (t) {
              return Mt(t) && Rt(t.length) && !!c[lt(t)]
            }
        function Pt(t) {
          return null != (e = t) && Rt(e.length) && !Tt(e) ? ut(t) : dt(t)
          var e
        }
    ...
    ZBwS: function (t, e) {
      ...
      n.Diff,
        (n.prototype.diff_main = function (t, e, n, i) {
          'undefined' == typeof i &&
            (i =
              this.Diff_Timeout <= 0
                ? Number.MAX_VALUE
          ...
          var _ = t.substring(t.length - a)
          ;(t = t.substring(0, t.length - a)), (e = e.substring(0, e.length - a))
          var u = this.diff_compute_(t, e, s, r)
          return o && u.unshift([0, o]), _ && u.push([0, _]), this.diff_cleanupMerge(u), u
        }),
        (n.prototype.diff_compute_ = function (t, e, n, i) {
          var r
          if (!t) return [[1, e]]
          if (!e) return [[-1, t]]
          ...
          var _ = this.diff_halfMatch_(t, e)
          if (_) {
            var u = _[0],
              h = _[1],
              l = _[2],
              c = _[3],
              p = _[4],
              f = this.diff_main(u, l, n, i),
              d = this.diff_main(h, c, n, i)
            return f.concat([[0, p]], d)
          }
          return n && t.length > 100 && e.length > 100
            ? this.diff_lineMode_(t, e, i)
            : this.diff_bisect_(t, e, i)
        }),
        (n.prototype.diff_lineMode_ = function (t, e, n) {
          ;(t = (h = this.diff_linesToChars_(t, e)).chars1), (e = h.chars2)
          var i = h.lineArray,
            r = this.diff_main(t, e, !1, n)
          this.diff_charsToLines_(r, i), this.diff_cleanupSemantic(r), r.push([0, ''])
          for (var s = 0, a = 0, o = 0, _ = '', u = ''; s < r.length; ) {
            switch (r[s][0]) {
              case 1:
                o++, (u += r[s][1])
                break
              ...
              case 0:
                if (a >= 1 && o >= 1) {
                  r.splice(s - a - o, a + o), (s = s - a - o)
                  for (var h, l = (h = this.diff_main(_, u, !1, n)).length - 1; l >= 0; l--)
                    r.splice(s, 0, h[l])
                  s += h.length
                }
                ;(o = 0), (a = 0), (_ = ''), (u = '')
        ...
        (n.prototype.diff_bisect_ = function (t, e, n) {
          for (
            var i = t.length,
              r = e.length,
              s = Math.ceil((i + r) / 2),
          ...
          ;(_[a + 1] = 0), (u[a + 1] = 0)
          for (
            var l = i - r, c = l % 2 != 0, p = 0, f = 0, d = 0, g = 0, b = 0;
            b < s && !(new Date().getTime() > n);
            b++
          ) {
            for (var m = -b + p; m <= b - f; m += 2) {
              for (
                var y = a + m,
                  v =
                    (E = m == -b || (m != b && _[y - 1] < _[y + 1]) ? _[y + 1] : _[y - 1] + 1) - m;
                E < i && v < r && t.charAt(E) == e.charAt(v);
              ...
              if (((_[y] = E), E > i)) f += 2
                ...
                if ((x = a + l - m) >= 0 && x < o && -1 != u[x])
                  if (E >= (k = i - u[x])) return this.diff_bisectSplit_(t, e, E, v, n)
              }
            }
            for (var w = -b + d; w <= b - g; w += 2) {
              for (
                var k,
                  x = a + w,
                  O =
                    (k = w == -b || (w != b && u[x - 1] < u[x + 1]) ? u[x + 1] : u[x - 1] + 1) - w;
                k < i && O < r && t.charAt(i - k - 1) == e.charAt(r - O - 1);
              ...
              if (((u[x] = k), k > i)) g += 2
                ...
                if ((y = a + l - w) >= 0 && y < o && -1 != _[y]) {
                  var E
                  v = a + (E = _[y]) - y
                  if (E >= (k = i - k)) return this.diff_bisectSplit_(t, e, E, v, n)
                }
              }
            }
          }
        ...
        (n.prototype.diff_bisectSplit_ = function (t, e, n, i, r) {
          var s = t.substring(0, n),
            a = e.substring(0, i),
            o = t.substring(n),
            _ = e.substring(i),
            u = this.diff_main(s, a, !1, r),
            h = this.diff_main(o, _, !1, r)
          return u.concat(h)
        }),
        (n.prototype.diff_linesToChars_ = function (t, e) {
          var n = [],
            i = {}
          function r(t) {
            for (var e = '', r = 0, s = -1, a = n.length; s < t.length - 1; ) {
              ;-1 == (s = t.indexOf('\n', r)) && (s = t.length - 1)
              var o = t.substring(r, s + 1)
              ;(r = s + 1),
                (i.hasOwnProperty ? i.hasOwnProperty(o) : void 0 !== i[o])
                  ? (e += String.fromCharCode(i[o]))
                  : ((e += String.fromCharCode(a)), (i[o] = a), (n[a++] = o))
            }
            return e
          }
          return (n[0] = ''), { chars1: r(t), chars2: r(e), lineArray: n }
        }),
        ...
        (n.prototype.diff_commonOverlap_ = function (t, e) {
          ...
          for (var s = 0, a = 1; ; ) {
            var o = t.substring(r - a),
              _ = e.indexOf(o)
            if (-1 == _) return s
            ;(a += _), (0 != _ && t.substring(r - a) != e.substring(0, a)) || ((s = a), a++)
          }
        }),
        (n.prototype.diff_halfMatch_ = function (t, e) {
          ...
          function s(t, e, n) {
            for (
              var i, s, a, o, _ = t.substring(n, n + Math.floor(t.length / 4)), u = -1, h = '';
              -1 != (u = e.indexOf(_, u + 1));

            ) {
              var l = r.diff_commonPrefix(t.substring(n), e.substring(u)),
                c = r.diff_commonSuffix(t.substring(0, n), e.substring(0, u))
              h.length < c + l &&
                ((h = e.substring(u - c, u) + e.substring(u, u + l)),
                (i = t.substring(0, n - c)),
                (s = t.substring(n + l)),
                (a = e.substring(0, u - c)),
                (o = e.substring(u + l)))
            }
            return 2 * h.length >= t.length ? [i, s, a, o, h] : null
          }
          var a,
            o,
            _,
            u,
            h,
            l = s(n, i, Math.ceil(n.length / 4)),
            c = s(n, i, Math.ceil(n.length / 2))
          return l || c
            ? ((a = c ? (l && l[4].length > c[4].length ? l : c) : l),
              t.length > e.length
                ? ((o = a[0]), (_ = a[1]), (u = a[2]), (h = a[3]))
                : ((u = a[0]), (h = a[1]), (o = a[2]), (_ = a[3])),
              [o, _, u, h, a[4]])
            : null
        }),
        (n.prototype.diff_cleanupSemantic = function (t) {
          for (
            var e = !1, n = [], i = 0, r = null, s = 0, a = 0, o = 0, _ = 0, u = 0;
            s < t.length;

          )
            0 == t[s][0]
              ? ((n[i++] = s), (a = _), (o = u), (_ = 0), (u = 0), (r = t[s][1]))
              : (1 == t[s][0] ? (_ += t[s][1].length) : (u += t[s][1].length),
                r &&
                  r.length <= Math.max(a, o) &&
                  r.length <= Math.max(_, u) &&
          ...
          for (
            ...
            if (-1 == t[s - 1][0] && 1 == t[s][0]) {
              var h = t[s - 1][1],
                l = t[s][1],
                c = this.diff_commonOverlap_(h, l),
                p = this.diff_commonOverlap_(l, h)
              c >= p
                ? (c >= h.length / 2 || c >= l.length / 2) &&
                  (t.splice(s, 0, [0, l.substring(0, c)]),
                  (t[s - 1][1] = h.substring(0, h.length - c)),
                  (t[s + 1][1] = l.substring(c)),
                  s++)
                : (p >= h.length / 2 || p >= l.length / 2) &&
                  (t.splice(s, 0, [0, h.substring(0, p)]),
                  (t[s - 1][0] = 1),
                  (t[s - 1][1] = l.substring(0, l.length - p)),
                  (t[s + 1][0] = -1),
        ...
        (n.prototype.diff_cleanupSemanticLossless = function (t) {
          function e(t, e) {
            ...
            var i = t.charAt(t.length - 1),
              r = e.charAt(0),
              s = i.match(n.nonAlphaNumericRegex_),
              a = r.match(n.nonAlphaNumericRegex_),
              o = s && i.match(n.whitespaceRegex_),
              _ = a && r.match(n.whitespaceRegex_),
              u = o && i.match(n.linebreakRegex_),
              h = _ && r.match(n.linebreakRegex_),
              l = u && t.match(n.blanklineEndRegex_),
              c = h && e.match(n.blanklineStartRegex_)
            return l || c ? 5 : u || h ? 4 : s && !o && _ ? 3 : o || _ ? 2 : s || a ? 1 : 0
          }
          for (var i = 1; i < t.length - 1; ) {
            if (0 == t[i - 1][0] && 0 == t[i + 1][0]) {
              var r = t[i - 1][1],
                s = t[i][1],
                a = t[i + 1][1],
                o = this.diff_commonSuffix(r, s)
              if (o) {
                var _ = s.substring(s.length - o)
                ;(r = r.substring(0, r.length - o)),
                  (s = _ + s.substring(0, s.length - o)),
                  (a = _ + a)
              }
              for (var u = r, h = s, l = a, c = e(r, s) + e(s, a); s.charAt(0) === a.charAt(0); ) {
                ;(r += s.charAt(0)), (s = s.substring(1) + a.charAt(0)), (a = a.substring(1))
                var p = e(r, s) + e(s, a)
                p >= c && ((c = p), (u = r), (h = s), (l = a))
              }
              t[i - 1][1] != u &&
                (u ? (t[i - 1][1] = u) : (t.splice(i - 1, 1), i--),
                (t[i][1] = h),
        ...
        (n.prototype.diff_cleanupEfficiency = function (t) {
          for (
            var e = !1, n = [], i = 0, r = null, s = 0, a = !1, o = !1, _ = !1, u = !1;
            s < t.length;

          )
            0 == t[s][0]
              ? (t[s][1].length < this.Diff_EditCost && (_ || u)
                  ? ((n[i++] = s), (a = _), (o = u), (r = t[s][1]))
                  : ((i = 0), (r = null)),
                (_ = u = !1))
              : (-1 == t[s][0] ? (u = !0) : (_ = !0),
                r &&
                  ((a && o && _ && u) ||
                    (r.length < this.Diff_EditCost / 2 && a + o + _ + u == 3)) &&
                  (t.splice(n[i - 1], 0, [-1, r]),
                  (t[n[i - 1] + 1][0] = 1),
                  i--,
                  (r = null),
                  a && o ? ((_ = u = !0), (i = 0)) : ((s = --i > 0 ? n[i - 1] : -1), (_ = u = !1)),
                  (e = !0))),
              s++
        ...
        (n.prototype.diff_cleanupMerge = function (t) {
          t.push([0, ''])
          for (var e, n = 0, i = 0, r = 0, s = '', a = ''; n < t.length; )
            switch (t[n][0]) {
              case 1:
                r++, (a += t[n][1]), n++
                break
                ...
                i + r > 1
                  ? (0 !== i &&
                    ...
                    0 === i
                      ...
                      : 0 === r
                      ? t.splice(n - i, i + r, [-1, s])
                      : t.splice(n - i - r, i + r, [-1, s], [1, a]),
        ...
        (n.prototype.diff_prettyHtml = function (t) {
          for (var e = [], n = /&/g, i = /</g, r = />/g, s = /\n/g, a = 0; a < t.length; a++) {
            ...
            switch (o) {
              case 1:
                e[a] = '<ins style="background:#e6ffe6;">' + _ + '</ins>'
                break
              case -1:
                e[a] = '<del style="background:#ffe6e6;">' + _ + '</del>'
                break
              case 0:
                e[a] = '<span>' + _ + '</span>'
            }
        ...
        (n.prototype.diff_fromDelta = function (t, e) {
          for (var n = [], i = 0, r = 0, s = e.split(/\t/g), a = 0; a < s.length; a++) {
            var o = s[a].substring(1)
            switch (s[a].charAt(0)) {
              case '+':
                try {
                  n[i++] = [1, decodeURI(o)]
              ...
              case '=':
                var _ = parseInt(o, 10)
                if (isNaN(_) || _ < 0) throw new Error('Invalid number in diff_fromDelta: ' + o)
                var u = t.substring(r, (r += _))
                '=' == s[a].charAt(0) ? (n[i++] = [0, u]) : (n[i++] = [-1, u])
                break
              default:
          ...
          if (r != t.length)
            throw new Error(
              'Delta length (' + r + ') does not equal source text length (' + t.length + ').'
            )
          return n
        }),
        ...
        (n.prototype.match_bitap_ = function (t, e, n) {
          ...
          function s(t, i) {
            var s = t / e.length,
              a = Math.abs(n - i)
            return r.Match_Distance ? s + a / r.Match_Distance : a ? 1 : s
          }
          var a = this.Match_Threshold,
            o = t.indexOf(e, n)
          ;-1 != o &&
            ((a = Math.min(s(0, o), a)),
            -1 != (o = t.lastIndexOf(e, n + e.length)) && (a = Math.min(s(0, o), a)))
          var _,
            u,
            h = 1 << (e.length - 1)
          o = -1
          for (var l, c = e.length + t.length, p = 0; p < e.length; p++) {
            for (_ = 0, u = c; _ < u; )
              s(p, n + u) <= a ? (_ = u) : (c = u), (u = Math.floor((c - _) / 2 + _))
            c = u
            var f = Math.max(1, n - u + 1),
              d = Math.min(n + u, t.length) + e.length,
              g = Array(d + 2)
            g[d + 1] = (1 << p) - 1
            for (var b = d; b >= f; b--) {
              var m = i[t.charAt(b - 1)]
              if (
                ((g[b] =
                  0 === p
                    ? ((g[b + 1] << 1) | 1) & m
                    : (((g[b + 1] << 1) | 1) & m) | ((l[b + 1] | l[b]) << 1) | 1 | l[b + 1]),
                g[b] & h)
              ) {
                var y = s(p, b - 1)
                if (y <= a) {
                  if (((a = y), !((o = b - 1) > n))) break
                  f = Math.max(1, 2 * n - o)
                }
              }
            }
        ...
        (n.prototype.patch_addContext_ = function (t, e) {
          if (0 != e.length) {
            for (
              ...
              (i += this.Patch_Margin), (n = e.substring(t.start2 - i, t.start2 + t.length1 + i))
            i += this.Patch_Margin
            ...
            s && t.diffs.push([0, s]),
              (t.start1 -= r.length),
              (t.start2 -= r.length),
              (t.length1 += r.length + s.length),
              (t.length2 += r.length + s.length)
          }
        }),
        (n.prototype.patch_make = function (t, e, i) {
          var r, s
          if ('string' == typeof t && 'string' == typeof e && 'undefined' == typeof i)
            (r = t),
              (s = this.diff_main(r, e, !0)).length > 2 &&
                (this.diff_cleanupSemantic(s), this.diff_cleanupEfficiency(s))
          else if (t && 'object' == typeof t && 'undefined' == typeof e && 'undefined' == typeof i)
            (s = t), (r = this.diff_text1(s))
          else if ('string' == typeof t && e && 'object' == typeof e && 'undefined' == typeof i)
            (r = t), (s = e)
          else {
            if ('string' != typeof t || 'string' != typeof e || !i || 'object' != typeof i)
              throw new Error('Unknown call format to patch_make.')
            ;(r = t), (s = i)
          }
          if (0 === s.length) return []
          for (
            var a = [], o = new n.patch_obj(), _ = 0, u = 0, h = 0, l = r, c = r, p = 0;
            p < s.length;
            p++
          ) {
            var f = s[p][0],
              d = s[p][1]
            switch ((_ || 0 === f || ((o.start1 = u), (o.start2 = h)), f)) {
              case 1:
                ;(o.diffs[_++] = s[p]),
                  (o.length2 += d.length),
                  (c = c.substring(0, h) + d + c.substring(h))
                break
              case -1:
                ;(o.length1 += d.length),
                  (o.diffs[_++] = s[p]),
                  (c = c.substring(0, h) + c.substring(h + d.length))
                break
              case 0:
                d.length <= 2 * this.Patch_Margin && _ && s.length != p + 1
                  ? ((o.diffs[_++] = s[p]), (o.length1 += d.length), (o.length2 += d.length))
                  : d.length >= 2 * this.Patch_Margin &&
                    _ &&
                    (this.patch_addContext_(o, l),
                    a.push(o),
                    (o = new n.patch_obj()),
                    (_ = 0),
                    (l = c),
            ...
            1 !== f && (u += d.length), -1 !== f && (h += d.length)
          }
          return _ && (this.patch_addContext_(o, l), a.push(o)), a
        }),
        (n.prototype.patch_deepCopy = function (t) {
          for (var e = [], i = 0; i < t.length; i++) {
            var r = t[i],
              s = new n.patch_obj()
            s.diffs = []
            for (var a = 0; a < r.diffs.length; a++) s.diffs[a] = r.diffs[a].slice()
            ;(s.start1 = r.start1),
              (s.start2 = r.start2),
              (s.length1 = r.length1),
              (s.length2 = r.length2),
        ...
        (n.prototype.patch_apply = function (t, e) {
          ...
          for (var i = 0, r = [], s = 0; s < t.length; s++) {
            var a,
              o,
              _ = t[s].start2 + i,
              u = this.diff_text1(t[s].diffs),
              h = -1
            if (
              (u.length > this.Match_MaxBits
                ? -1 != (a = this.match_main(e, u.substring(0, this.Match_MaxBits), _)) &&
                  (-1 ==
                    (h = this.match_main(
                      e,
                      u.substring(u.length - this.Match_MaxBits),
                      _ + u.length - this.Match_MaxBits
                    )) ||
                    a >= h) &&
                  (a = -1)
                : (a = this.match_main(e, u, _)),
              -1 == a)
            )
              (r[s] = !1), (i -= t[s].length2 - t[s].length1)
            else if (
              ((r[s] = !0),
              (i = a - _),
              u ==
                (o =
                  -1 == h ? e.substring(a, a + u.length) : e.substring(a, h + this.Match_MaxBits)))
            )
              e = e.substring(0, a) + this.diff_text2(t[s].diffs) + e.substring(a + u.length)
            else {
              var l = this.diff_main(u, o, !1)
              if (
                u.length > this.Match_MaxBits &&
                this.diff_levenshtein(l) / u.length > this.Patch_DeleteThreshold
              )
                r[s] = !1
              else {
                this.diff_cleanupSemanticLossless(l)
                for (var c, p = 0, f = 0; f < t[s].diffs.length; f++) {
                  var d = t[s].diffs[f]
                  0 !== d[0] && (c = this.diff_xIndex(l, p)),
                    1 === d[0]
                      ? (e = e.substring(0, a + c) + d[1] + e.substring(a + c))
                      : -1 === d[0] &&
                        (e =
                          e.substring(0, a + c) +
                          e.substring(a + this.diff_xIndex(l, p + d[1].length))),
                    -1 !== d[0] && (p += d[1].length)
                }
              }
            }
        ...
        (n.prototype.patch_addPadding = function (t) {
          ...
          if (0 == s.length || 0 != s[0][0])
            s.unshift([0, n]), (r.start1 -= e), (r.start2 -= e), (r.length1 += e), (r.length2 += e)
          ...
          if (0 == (s = (r = t[t.length - 1]).diffs).length || 0 != s[s.length - 1][0])
            s.push([0, n]), (r.length1 += e), (r.length2 += e)
          else if (e > s[s.length - 1][1].length) {
            a = e - s[s.length - 1][1].length
            ;(s[s.length - 1][1] += n.substring(0, a)), (r.length1 += a), (r.length2 += a)
          }
          return n
        }),
        (n.prototype.patch_splitMax = function (t) {
          for (var e = this.Match_MaxBits, i = 0; i < t.length; i++)
            if (!(t[i].length1 <= e)) {
              var r = t[i]
              t.splice(i--, 1)
              for (var s = r.start1, a = r.start2, o = ''; 0 !== r.diffs.length; ) {
                var _ = new n.patch_obj(),
                  u = !0
                for (
                  _.start1 = s - o.length,
                    _.start2 = a - o.length,
                    '' !== o && ((_.length1 = _.length2 = o.length), _.diffs.push([0, o]));
                  0 !== r.diffs.length && _.length1 < e - this.Patch_Margin;
                  ...
                  1 === h
                    ? ((_.length2 += l.length),
                      (a += l.length),
                      _.diffs.push(r.diffs.shift()),
                      (u = !1))
                    : -1 === h && 1 == _.diffs.length && 0 == _.diffs[0][0] && l.length > 2 * e
                    ? ((_.length1 += l.length),
                      (s += l.length),
                      (u = !1),
                      _.diffs.push([h, l]),
                      r.diffs.shift())
                    : ((l = l.substring(0, e - _.length1 - this.Patch_Margin)),
                      (_.length1 += l.length),
                      (s += l.length),
                      0 === h ? ((_.length2 += l.length), (a += l.length)) : (u = !1),
                      _.diffs.push([h, l]),
                      l == r.diffs[0][1]
                        ? r.diffs.shift()
                        : (r.diffs[0][1] = r.diffs[0][1].substring(l.length)))
                }
                o = (o = this.diff_text2(_.diffs)).substring(o.length - this.Patch_Margin)
                var c = this.diff_text1(r.diffs).substring(0, this.Patch_Margin)
                '' !== c &&
                  ((_.length1 += c.length),
                  (_.length2 += c.length),
                  0 !== _.diffs.length && 0 === _.diffs[_.diffs.length - 1][0]
                    ? (_.diffs[_.diffs.length - 1][1] += c)
                    : _.diffs.push([0, c])),
                  u || t.splice(++i, 0, _)
              }
            }
        ...
        (n.prototype.patch_fromText = function (t) {
          ...
          for (
            ...
            var a = i[r].match(s)
            if (!a) throw new Error('Invalid patch string: ' + i[r])
            var o = new n.patch_obj()
            for (
              e.push(o),
              ...
              var _ = i[r].charAt(0)
              try {
                var u = decodeURI(i[r].substring(1))
              } catch (h) {
                throw new Error('Illegal escape in patch_fromText: ' + u)
              }
              if ('-' == _) o.diffs.push([-1, u])
              else if ('+' == _) o.diffs.push([1, u])
              else if (' ' == _) o.diffs.push([0, u])
              else {
                if ('@' == _) break
                if ('' !== _) throw new Error('Invalid patch mode "' + _ + '" in: ' + u)
              }
              r++
            }
          }
    ...
    'eF/C': function (t, e, n) {
      ...
      var f = (0, a.getAceInstance)(),
        d = f.acequire('ace/range').Range,
        g = (function (t) {
          function e(t) {
            var n
            return (
              ...
              })(this, l(e).call(this, t))),
              a.editorEvents.forEach(function (t) {
                n[t] = n[t].bind(c(n))
              }),
              (n.debounce = a.debounce),
              n
            )
          }
          var n, r, o
            ...
            (r = [
              {
                ...
                value: function () {
                  var t = this,
                    ...
                    x = e.markers,
                    O = e.placeholder
                  ;(this.editor = f.edit(this.refEditor)), i && i(f)
                  for (var E = Object.keys(this.props.editorProps), S = 0; S < E.length; S++)
                    this.editor[E[S]] = this.props.editorProps[E[S]]
                  this.props.debounceChangePeriod &&
                    (this.onChange = this.debounce(this.onChange, this.props.debounceChangePeriod)),
                    this.editor.renderer.setScrollMargin(m[0], m[1], m[2], m[3]),
                    this.editor.getSession().setMode('ace/mode/'.concat(s)),
                    this.editor.setTheme('ace/theme/'.concat(_)),
                    this.editor.setFontSize(u),
                    this.editor.getSession().setValue(l || h, c),
                    ...
                    O && this.updatePlaceholder(this.editor, O),
                    this.editor
                      .getSession()
                    ...
                    this.editor.getSession().setAnnotations(k || []),
                    x && x.length > 0 && this.handleMarkers(x)
                  for (var C = this.editor.$options, T = 0; T < a.editorOptions.length; T++) {
                    var R = a.editorOptions[T]
                    C.hasOwnProperty(R)
                      ? this.editor.setOption(R, this.props[R])
                      : this.props[R] &&
                        console.warn(
              ...
              },
              {
                key: 'componentDidUpdate',
                value: function (t) {
                  for (var e = t, n = this.props, i = 0; i < a.editorOptions.length; i++) {
                    var r = a.editorOptions[i]
                    n[r] !== e[r] && this.editor.setOption(r, n[r])
                  }
                  ...
                  if (this.editor && this.editor.getValue() !== n.value) {
                    this.silent = !0
                    var _ = this.editor.session.selection.toJSON()
                    this.editor.setValue(n.value, n.cursorStart),
                      this.editor.session.selection.fromJSON(_),
                      (this.silent = !1)
                  }
                  n.placeholder !== e.placeholder && this.updatePlaceholder(),
                    n.mode !== e.mode && this.editor.getSession().setMode('ace/mode/' + n.mode),
                    n.theme !== e.theme && this.editor.setTheme('ace/theme/' + n.theme),
                    n.keyboardHandler !== e.keyboardHandler &&
                      (n.keyboardHandler
                        ? this.editor.setKeyboardHandler('ace/keyboard/' + n.keyboardHandler)
                        : this.editor.setKeyboardHandler(null)),
                    n.fontSize !== e.fontSize && this.editor.setFontSize(n.fontSize),
                    ...
                    (0, s.default)(n.setOptions, e.setOptions) || this.handleOptions(n),
                    (0, s.default)(n.annotations, e.annotations) ||
                      this.editor.getSession().setAnnotations(n.annotations || []),
                    !(0, s.default)(n.markers, e.markers) &&
                      Array.isArray(n.markers) &&
                      this.handleMarkers(n.markers),
                    (0, s.default)(n.scrollMargin, e.scrollMargin) ||
                      this.handleScrollMargins(n.scrollMargin),
                    (t.height === this.props.height && t.width === this.props.width) ||
                      this.editor.resize(),
              ...
              },
              {
                ...
                value: function () {
                  var t =
                    arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [0, 0, 0, 0]
                  this.editor.renderer.setScrollMargins(t[0], t[1], t[2], t[3])
                }
              },
              {
                key: 'componentWillUnmount',
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  for (var i in n)
                    n.hasOwnProperty(i) && this.editor.getSession().removeMarker(n[i].id)
                  ...
                  t.forEach(function (t) {
                    var n = t.startRow,
                      ...
                      u = void 0 !== _ && _,
                      h = new d(n, i, r, s)
                    e.editor.getSession().addMarker(h, a, o, u)
                  })
                }
              },
              {
                ...
                value: function () {
                  var t = this.editor,
                    ...
                    i = t.renderer.placeholderNode
                  !n && i
                    ? (t.renderer.scroller.removeChild(t.renderer.placeholderNode),
                      (t.renderer.placeholderNode = null))
                    : n && !i
                    ? (((i = t.renderer.placeholderNode = document.createElement(
                        'div'
                      )).textContent = e || ''),
                      (i.className = 'ace_comment ace_placeholder'),
                      (i.style.padding = '0 9px'),
                      (i.style.position = 'absolute'),
                      (i.style.zIndex = '3'),
                      t.renderer.scroller.appendChild(i))
                    : n && i && (i.textContent = e)
                }
              },
              {
              ...
              },
              {
                ...
                value: function () {
                  ...
                  return i.default.createElement('div', { ref: this.updateRef, id: e, style: n })
                }
              }
            ]) && h(n.prototype, r),
            o && h(n, o),
      ...
      ;(e.default = g),
        (g.propTypes = {
          ...
          fontSize: r.default.oneOfType([r.default.number, r.default.string]),
          showGutter: r.default.bool,
          onChange: r.default.func,
          onCopy: r.default.func,
          onPaste: r.default.func,
          onFocus: r.default.func,
          onInput: r.default.func,
          onBlur: r.default.func,
          onScroll: r.default.func,
          value: r.default.string,
          defaultValue: r.default.string,
          onLoad: r.default.func,
          onSelectionChange: r.default.func,
          onCursorChange: r.default.func,
          onBeforeLoad: r.default.func,
          onValidate: r.default.func,
          minLines: r.default.number,
          maxLines: r.default.number,
          readOnly: r.default.bool,
          highlightActiveLine: r.default.bool,
          tabSize: r.default.number,
          showPrintMargin: r.default.bool,
          cursorStart: r.default.number,
          debounceChangePeriod: r.default.number,
          editorProps: r.default.object,
          setOptions: r.default.object,
          style: r.default.object,
          scrollMargin: r.default.array,
          annotations: r.default.array,
          markers: r.default.array,
          keyboardHandler: r.default.string,
          wrapEnabled: r.default.bool,
          enableBasicAutocompletion: r.default.oneOfType([r.default.bool, r.default.array]),
          enableLiveAutocompletion: r.default.oneOfType([r.default.bool, r.default.array]),
          navigateToFileEnd: r.default.bool,
          commands: r.default.array,
        ...
        var s = (function (t) {
          ...
          function (t, e, n) {
            ...
            ;(u.prototype.current_line_has_match = function (t) {
              ...
              (u.prototype.print_preserved_newlines = function (t) {
                var e = 0
                t.type !== a.TEXT && t.previous.type !== a.TEXT && (e = t.newlines ? 1 : 0),
            ...
            ;(p.prototype.get_parser_token = function () {
              ...
              (p.prototype.record_tag = function (t) {
                var e = new c(this._current_frame, t, this._printer.indent_level)
              ...
              (f.prototype.beautify = function () {
                ...
                var n = (t = t.replace(_, '\n')).match(/^[\t ]*/)[0],
                  i = { text: '', type: '' },
                  r = new d(),
                  h = new u(this._options, n),
                  l = new s(t, this._options).tokenize()
                this._tag_stack = new p(h)
                for (var c = null, f = l.next(); f.type !== a.EOF; )
                  f.type === a.TAG_OPEN || f.type === a.COMMENT
                    ? (r = c = this._handle_tag_open(h, f, r, i))
                    : f.type === a.ATTRIBUTE ||
                      f.type === a.EQUALS ||
                      f.type === a.VALUE ||
                      (f.type === a.TEXT && !r.tag_complete)
                    ? (c = this._handle_inside_tag(h, f, r, l))
                    : f.type === a.TAG_CLOSE
                    ? (c = this._handle_tag_close(h, f, r))
                    : f.type === a.TEXT
                    ? (c = this._handle_text(h, f, r))
                    : h.add_raw_token(f),
                    (i = c),
                    (f = l.next())
              ...
              (f.prototype._handle_inside_tag = function (t, e, n, i) {
                ...
                if (
                  ...
                  t.add_raw_token(e)
                else if ('{' === n.tag_start_char && e.type === a.TEXT)
                  ...
                  if (
                    (e.type === a.ATTRIBUTE
                      ...
                      : (e.type === a.EQUALS ||
                          (e.type === a.VALUE && e.previous.type === a.EQUALS)) &&
                        t.set_space_before_token(!1),
                    e.type === a.ATTRIBUTE &&
                      '<' === n.tag_start_char &&
                      ((this._is_wrap_attributes_preserve ||
                        this._is_wrap_attributes_preserve_aligned) &&
                        (t.traverse_whitespace(e), (r = r || 0 !== e.newlines)),
                      this._is_wrap_attributes_force))
                  ) {
                    ...
                    if (this._is_wrap_attributes_force_expand_multiline && 1 === n.attr_count) {
                      var _,
                        ...
                        h = 0
                      do {
                        if ((_ = i.peek(h)).type === a.ATTRIBUTE) {
                          u = !1
                          break
                        }
                        h += 1
                      } while (h < 4 && _.type !== a.EOF && _.type !== a.TAG_CLOSE)
                      o = !u
                    }
                    o && (t.print_newline(!1), (r = !0))
                  }
                  t.print_token(e), (r = r || t.previous_token_wrapped()), (n.has_wrapped_attrs = r)
                }
                return s
              }),
                ...
                if ('' !== e.text) {
                  ...
                  'function' === typeof this._js_beautify
                    ...
                    : 'html' === n.custom_beautifier_name &&
                      (r = function (t, e) {
                        return new f(t, e, i._js_beautify, i._css_beautify).beautify()
                      }),
                    'keep' === this._options.indent_scripts
                      ? (a = 0)
                      : 'separate' === this._options.indent_scripts && (a = -t.indent_level)
                  ...
                  if (s)
                    if (r) {
                      ...
                      ;(l.prototype = this._options.raw_options), (s = r(u + s, new l()))
                    } else {
                      var c = e.whitespace_before
                      c && (s = s.replace(new RegExp('\n(' + c + ')?', 'g'), '\n')),
                        (s = u + s.replace(/\n/g, '\n' + u))
                    }
                  o && (s = s ? o + s + '\n' + _ : o + _),
                    t.print_newline(!1),
              ...
              (f.prototype._handle_tag_open = function (t, e, n, i) {
            ...
            ;(f.prototype._get_tag_open_token = function (t) {
              ...
              return (
                ...
                (e.is_end_tag = e.is_end_tag || l(e.tag_check, this._options.void_elements)),
                (e.is_empty_element = e.tag_complete || (e.is_start_tag && e.is_end_tag)),
                (e.is_unformatted = !e.tag_complete && l(e.tag_check, this._options.unformatted)),
                (e.is_content_unformatted =
                  !e.is_empty_element && l(e.tag_check, this._options.content_unformatted)),
                (e.is_inline_element =
                  l(e.tag_name, this._options.inline) || '{' === e.tag_start_char),
                e
              )
            }),
              (f.prototype._set_tag_position = function (t, e, n, i, r) {
                if (
                  ...
                  l(n.tag_check, this._options.extra_liners) &&
            ...
            ;(f.prototype._do_optional_end_element = function (t) {
              ...
              if (!t.is_empty_element && t.is_start_tag && t.parent) {
                if ('body' === t.tag_name) e = e || this._tag_stack.try_pop('head')
                  ...
                  ;(n && -1 !== b.indexOf(n.tag_name)) || (e = e || this._tag_stack.try_pop('p'))
                } else
                  'rp' === t.tag_name || 'rt' === t.tag_name
                    ...
                    : 'option' === t.tag_name
                    ? (e =
                        e || this._tag_stack.try_pop('option', ['select', 'datalist', 'optgroup']))
                    : 'colgroup' === t.tag_name
          ...
          function (t, e, n) {
            ...
            ;((h.prototype = new i())._is_comment = function (t) {
                              ...
                              (n =
                                (n =
                                  (n =
                                    ...
                                    this._read_attribute(i, t, e)) || this._read_close(i, e)) ||
                                this._read_raw_content(i, t, e)) || this._read_content_word(i)) ||
                            this._read_comment_or_cdata(i)) || this._read_processing(i)) ||
                        this._read_open(i, e)) || this._create_token(_.UNKNOWN, this._input.next()))
              }),
              (h.prototype._read_comment_or_cdata = function (t) {
                var e = null,
                  n = null,
                  i = null
                '<' === t &&
              ...
              (h.prototype._read_processing = function (t) {
                var e = null,
                  n = null
                if ('<' === t) {
                    ...
                    (this._options.indent_handlebars &&
                      ...
                      ('!' === this._input.peek(2)
                        ? ((n =
                            ...
                            this.__patterns.handlebars.read()),
                          (i = this._create_token(_.COMMENT, n)))
                  ...
                  e &&
                    ('<' === e.text[0] && ('>' === t || ('/' === t && '>' === this._input.peek(1)))
                      ? ((n = this._input.next()),
                        ...
                        (i = this._create_token(_.TAG_CLOSE, n)))
                      : '{' === e.text[0] &&
                        '}' === t &&
                        '}' === this._input.peek(1) &&
                        (this._input.next(),
              ...
              (h.prototype._read_attribute = function (t, e, n) {
                var i = null,
                  r = ''
                if (n && '<' === n.text[0])
                  if ('=' === t) i = this._create_token(_.EQUALS, this._input.next())
                  else if ('"' === t || "'" === t) {
                    ...
                    (r = this.__patterns.attribute.read()) &&
                      (i =
                        e.type === _.EQUALS
                          ? this._create_token(_.VALUE, r)
                          : this._create_token(_.ATTRIBUTE, r))
                return i
              }),
              ...
              (h.prototype._read_raw_content = function (t, e, n) {
                var i = ''
              ...
              (h.prototype._read_content_word = function (t) {
                ...
                if (
                  ...
                  return this._create_token(_.TEXT, e)
              }),
    ...
    tGEx: function (t, e, n) {
      'use strict'
      Object.defineProperty(e, '__esModule', { value: !0 }),
        (e.getAceInstance = e.debounce = e.editorEvents = e.editorOptions = void 0)
      e.editorOptions = [
        'minLines',
        'maxLines',
        'readOnly',
      ...
      e.getAceInstance = function () {
        ...
        return (
          window.ace
            ? ((t = window.ace).acequire = window.ace.require || window.ace.acequire)
            : (t = n('Bhyg')),
          t
        )
      }
    ...
    uLGy: function (t, e, n) {
      ...
      function p(t) {
        ...
        return function () {
          var n,
            i = Object(_.a)(t)
          if (e) {
            var r = Object(_.a)(this).constructor
            n = Reflect.construct(i, arguments, r)
          } else n = i.apply(this, arguments)
      ...
      var f = function (t) {
          var e = n('lc5D').default
          return n('uzal'), n('hUa+'), c(e, t)
        },
        d = (function (t) {
          Object(a.a)(n, t)
          var e = p(n)
          function n() {
            ...
            return (
              ...
              Object(u.a)(Object(s.a)(t), 'state', { mounted: !1 }),
              Object(u.a)(Object(s.a)(t), 'render', function () {
                return t.state.mounted ? c(f, t.props) : null
              }),
              t
            )
          }
    ...
    uzal: function (t, e, n) {
      ace.define(
        ...
        function (t, e, n) {
          ...
          i.inherits(s, r),
            (s.getTagRule = function (t) {
              return {
                token: 'comment.doc.tag.storage.type',
                regex: '\\b(?:TODO|FIXME|XXX|HACK)\\b'
              }
            }),
            (s.getStartRule = function (t) {
              return { token: 'comment.doc', regex: '\\/\\*(?=\\*)', next: t }
            }),
            (s.getEndRule = function (t) {
              return { token: 'comment.doc', regex: '\\*\\/', next: t }
            }),
            (e.DocCommentHighlightRules = s)
        }
      ),
        ace.define(
          ...
          function (t, e, n) {
            'use strict'
            var i = t('../lib/oop'),
              r = t('./doc_comment_highlight_rules').DocCommentHighlightRules,
              s = t('./text_highlight_rules').TextHighlightRules,
                    ...
                    (this.$rules.no_regex.unshift(
                      {
                        ...
                        onMatch: function (t, e, n) {
                          if (((this.next = '{' == t ? this.nextState : ''), '{' == t && n.length))
                            n.unshift('start', e)
                          else if (
                            '}' == t &&
                            n.length &&
                          ...
                          return '{' == t ? 'paren.lparen' : 'paren.rparen'
                        },
                        nextState: 'start'
                      },
                      {
            ...
            function _() {
                  ...
                  onMatch: function (t, e, n) {
                    ...
                    return (
                      ...
                      [
                        ...
                        { type: 'meta.tag.tag-name.xml', value: t.substr(i) }
                      ]
                    )
                  },
                  regex: '</?' + t,
              ...
              this.$rules.start.unshift(e)
              var n = { regex: '{', token: 'paren.quasi.start', push: 'start' }
              ;(this.$rules.jsx = [n, e, { include: 'reference' }, { defaultToken: 'string' }]),
              ...
              return [
                {
                  ...
                  next: [
                    r.getTagRule(),
                    { token: 'comment', regex: '\\*\\/', next: t || 'pop' },
            ...
            i.inherits(o, s), (e.JavaScriptHighlightRules = o)
          }
        ),
        ace.define(
            ...
            ;(function () {
              ;(this.checkOutdent = function (t, e) {
                ...
                (this.autoOutdent = function (t, e) {
                  ...
                  if (!n) return 0
                  var r = n[1].length,
                    s = t.findMatchingBracket({ row: e, column: r })
                  if (!s || s.row == e) return 0
                  var a = this.$getIndent(t.getLine(s.row))
        ...
        ace.define(
          ...
          function (t, e, n) {
            ...
            var i = t('../../lib/oop'),
              r = t('../../range').Range,
              s = t('./fold_mode').FoldMode,
              a = (e.FoldMode = function (t) {
                t &&
                  ((this.foldingStartMarker = new RegExp(
                    this.foldingStartMarker.source.replace(/\|[^|]*?$/, '|' + t.start)
                  )),
                  (this.foldingStopMarker = new RegExp(
                    this.foldingStopMarker.source.replace(/\|[^|]*?$/, '|' + t.end)
                  )))
              })
            i.inherits(a, s),
              function () {
                ;(this.foldingStartMarker = /([\{\[\(])[^\}\]\)]*$|^\s*(\/\*)/),
                  ...
                  (this.getFoldWidgetRange = function (t, e, n, i) {
                    var r,
                      s = t.getLine(n)
                    if (this.startRegionRe.test(s)) return this.getCommentRegionBlock(t, s, n)
                    if ((r = s.match(this.foldingStartMarker))) {
                      var a = r.index
                      if (r[1]) return this.openingBracketBlock(t, r[1], n, a)
                      var o = t.getCommentFoldRange(n, a + r[0].length, 1)
                      return (
                        o &&
                          !o.isMultiLine() &&
                          (i ? (o = this.getSectionRange(t, n)) : 'all' != e && (o = null)),
                        o
                      )
                    }
                    if ('markbegin' !== e && (r = s.match(this.foldingStopMarker))) {
                  ...
                  (this.getSectionRange = function (t, e) {
                    for (
                      ...
                      var u = (n = t.getLine(e)).search(/\S/)
                      if (-1 !== u) {
                        if (i > u) break
                        var h = this.getFoldWidgetRange(t, 'all', e)
                        if (h) {
                          if (h.start.row <= s) break
                          if (h.isMultiLine()) e = h.end.row
                          else if (i == u) break
                        }
                        o = e
                      }
                    }
                    return new r(s, a, o, t.getLine(o).length)
                  }),
        ...
        ace.define(
          ...
          function (t, e, i) {
            ...
            var r = t('../lib/oop'),
              s = t('./text').Mode,
              a = t('./javascript_highlight_rules').JavaScriptHighlightRules,
              o = t('./matching_brace_outdent').MatchingBraceOutdent,
              _ = t('../worker/worker_client').WorkerClient,
              u = t('./behaviour/cstyle').CstyleBehaviour,
              h = t('./folding/cstyle').FoldMode,
              l = function () {
                ...
                ;(this.lineCommentStart = '//'),
                  ...
                  (this.getNextLineIndent = function (t, e, n) {
                    var i = this.$getIndent(e),
                      r = this.getTokenizer().getLineTokens(e, t),
                      s = r.tokens,
                      a = r.state
                    if (s.length && 'comment' == s[s.length - 1].type) return i
                    if ('start' == t || 'no_regex' == t)
                      (o = e.match(/^.*(?:\bcase\b.*:|[\{\(\[])\s*$/)) && (i += n)
                    else if ('doc-start' == t) {
                  ...
                  (this.createWorker = function (t) {
                    var e = new _(['ace'], n('bWjX'), 'JavaScriptWorker')
                    return (
      ...
      ;(function (e) {
          ...
          for (
            var n,
              ...
              a = (e = (function (t, e) {
                if (U(t)) return !1
                var n = typeof t
                if ('number' == n || 'symbol' == n || 'boolean' == n || null == t || W(t)) return !0
                return r.test(t) || !i.test(t) || (null != e && (t in Object(e)))
              })(e, t)
                ? [e]
                : U((n = e))
                ? n
        ...
        ;(C.prototype.clear = function () {
          ...
          (R.prototype.clear = function () {
            this.__data__ = { hash: new C(), map: new (x || T)(), string: new C() }
          }),
        ...
        var L = D(function (t) {
          ...
          return (
            s.test(t) && n.push(''),
            t.replace(a, function (t, e, i, r) {
              n.push(i ? r.replace(o, '$1') : e || t)
            }),
            n
          )
        })
        ...
        function W(t) {
          return (
            ...
            ((function (t) {
              ...
              '[object Symbol]' == y.call(t))
          )
        }
        t.exports = function (t, e, n) {
          var i = null == t ? void 0 : M(t, e)
          return void 0 === i ? n : i
        }
      }.call(this, n('3r9c')))
    }
