          ...
          Object(o.a)(t, [
            {
              ...
              value: function () {
                return h(
                  'div',
                  { className: 'home' },
                  h('h2', null, 'Getting started with Sandhands'),
                  h(
                    'p',
                    null,
                    ...
                    h(
                      'li',
                      null,
                      h(f.a, { href: '/Sandhands/format.html' }, h('a', null, 'Format section'))
                    ),
                    ' ',
                    'and',
                    ' ',
                    h(
                      ...
                      h(
                        ...
                        h('a', null, 'play around with the sandbox!')
                      )
                    )
                  ),
                  h('br', null),
                  h('h2', null, 'A Basic Express Example'),
                  h(
                    d.a,
    ...
    cTJO: function (e, n, t) {
                  ...
                  e.forEach(function (e) {
                    if (i.has(e.target)) {
                      ...
                      ;(e.isIntersecting || e.intersectionRatio > 0) &&
                        (a.unobserve(e.target), i.delete(e.target), n())
                    }
                  })
                },
                { rootMargin: '200px' }
      ...
      var h = function (e) {
        var n = !1 !== e.prefetch,
          ...
          y = s.default.useMemo(
            function () {
              var n = (0, c.resolveHref)(v, e.href, !0),
                t = r(n, 2),
                o = t[0],
                a = t[1]
              return { href: o, as: e.as ? (0, c.resolveHref)(v, e.as) : a || o }
            },
            [v, e.href, e.as]
          ),
          m = y.href,
        ...
        s.default.useEffect(
          function () {
            if (n && l && a && a.tagName && (0, c.isLocalURL)(m) && !f[m + '%' + b])
              return p(a, function () {
                d(h, m, b)
              })
          },
        ...
        var w = e.children,
          ...
          E = e.shallow,
          x = e.scroll
        'string' === typeof w && (w = s.default.createElement('a', null, w))
        var _ = s.Children.only(w),
          R = {
            ref: function (e) {
              e && i(e),
                _ &&
            ...
            onClick: function (e) {
              _.props && 'function' === typeof _.props.onClick && _.props.onClick(e),
                e.defaultPrevented ||
                  (function (e, n, t, r, o, a, s) {
                    ;('A' !== e.currentTarget.nodeName ||
                      ...
                      n[o ? 'replace' : 'push'](t, r, { shallow: a }).then(function (e) {
        ...
        return (
          n &&
            (R.onMouseEnter = function (e) {
              ;(0, c.isLocalURL)(m) &&
                (_.props && 'function' === typeof _.props.onMouseEnter && _.props.onMouseEnter(e),
                d(h, m, b, { priority: !0 }))
            }),
          (e.passHref || ('a' === _.type && !('href' in _.props))) &&
            (R.href = (0, c.addBasePath)((0, c.addLocale)(b, h && h.locale, h && h.defaultLocale))),
          s.default.cloneElement(_, R)
        )
      }
      n.default = h
    }
