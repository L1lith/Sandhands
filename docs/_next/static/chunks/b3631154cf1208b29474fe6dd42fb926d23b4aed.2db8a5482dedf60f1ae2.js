  ...
  [2],
  {
    ...
    QmWs: function (t, e, r) {
        ...
        var e = (function (t, e, r) {
          ...
          ;(n = n ? encodeURIComponent(n).replace(/%3A/i, ':') + '@' : ''),
            t.host
              ? (s = n + t.host)
              : o &&
                ((s = n + (~o.indexOf(':') ? '[' + o + ']' : o)), t.port && (s += ':' + t.port)),
      ...
      function d(t, e, r) {
        ...
        ;(t = n ? v(n[1]).replace(/\\/g, '/') + n[2] : v(t).replace(/\\/g, '/')),
        ...
        a &&
          ...
          a[2] || ((c = !1), l.test(a[1]) ? ((d = a[1]), (t = '' + a[3])) : (t = '//' + a[3])),
          (3 !== a[2].length && 1 !== a[2].length) || ((d = a[1]), (t = '/' + a[3])))
        var m,
          g = t.match(/(:[0-9]+)/),
          b = ''
        ...
        try {
          ...
          ;(_ = o),
            d || r || !/^\/\//.test(t) || /^\/\/.+[@.]/.test(t) || ((x = '/'), (t = t.substr(1)))
          try {
            m = new URL(t, s)
          } catch (t) {
        ...
        ;(w.slashes = c && !x),
          ...
          (w.hostname = m.hostname === u ? '' : m.hostname.replace(/(\[|\])/g, '')),
        ...
        !w.search && ~S[0].indexOf('?') && (w.search = '?'),
          ...
          (w.pathname = x + v(m.pathname).replace(/"/g, '%22')),
          'about:' === w.protocol &&
            'blank' === w.pathname &&
            ((w.protocol = ''), (w.pathname = '')),
          _ && '/' !== t[0] && (w.pathname = w.pathname.substr(1)),
          d && !l.test(d) && '/' !== t.slice(-1) && '/' === w.pathname && (w.pathname = ''),
          (w.path = w.pathname + w.search),
          (w.auth = [m.username, m.password].map(decodeURIComponent).filter(Boolean).join(':')),
          (w.port = m.port),
      ...
      function b(t, e) {
        ...
        r.protocol &&
          ...
          o &&
            n.protocol &&
            ((o = ''), n.slashes || ((o = n.protocol), (e = e.replace(n.protocol, ''))))
        var a = t.match(m)
        a &&
          !n.protocol &&
            ...
            (a._invoke = (function (t, e, r) {
              ...
              return function (o, a) {
                ...
                for (r.method = o, r.arg = a; ; ) {
                  ...
                  var u = s(t, e, r)
                  if ('normal' === u.type) {
                    if (((n = r.done ? h : f), u.arg === y)) continue
      ...
      var g = (function () {
        function t(e, r, n, o) {
          ...
          a(this, t),
            ...
            (this.pathname = e),
            (this.query = r),
            (this.asPath = f.isDynamicRoute(e) && __NEXT_DATA__.autoExport ? e : n),
            (this.sub = b),
            (this.clc = null),
            (this._wrapApp = h),
            (this.isSsr = !0),
            (this.isFallback = w),
            this.changeState('replaceState', l.formatWithValidation({ pathname: e, query: r }), n),
            ...
            [
              ...
              },
              {
                ...
                value: function (e, r, n, o) {
                  ...
                  return new Promise(function (i, c) {
                    ...
                    var s = 'object' === typeof r ? l.formatWithValidation(r) : r,
                      d = 'object' === typeof n ? l.formatWithValidation(n) : n
                    if ((a.abortComponentLoad(d), !o._h && a.onlyAHashChange(d)))
                      return (
                        (a.asPath = d),
                        t.events.emit('hashChangeStart', d),
                        a.changeState(e, s, y(d), o),
                        a.scrollToHash(d),
                        ...
                        return c(
                          new Error(
                            'The provided `as` value ('
                              .concat(P, ') is incompatible with the `href` value (')
                              .concat(_, '). ') +
                  ...
                  var c = function t(a, i) {
                    return new Promise(function (c) {
                      return 'PAGE_LOAD_ERROR' === a.code || i
                        ? ((window.location.href = n), (a.cancelled = !0), c({ error: a }))
                        : a.cancelled
                        ? c({ error: a })
                        : void c(
                            o
                              ...
                              .then(function (t) {
                                ...
                                return new Promise(function (t) {
                                  o.getInitialProps(n, { err: a, pathname: e, query: r }).then(
                                    function (e) {
                      ...
                      return o
                        ._getData(function () {
                          return c
                            ...
                            : u
                            ? o._getServerData(n)
                            : o.getInitialProps(i, { pathname: e, query: r, asPath: n })
                        })
                        .then(function (e) {
                  ...
                  return new Promise(function (o, a) {
                    ...
                    c &&
                      ...
                      Promise.all([
                        ...
                        e.pageLoader[n.priority ? 'loadPage' : 'prefetch'](v(c))
                      ]).then(function () {
                        return o()
                      }, a)
                  })
                    ...
                    function (i) {
                      for (;;)
                        switch ((i.prev = i.next)) {
                          ...
                          case 9:
                            return r === this.clc && (this.clc = null), i.abrupt('return', o)
                          case 11:
                          case 'end':
                            return i.stop()
                        }
              ...
              },
              {
                ...
                value: function (t, e) {
                  ...
                  return (
                    (e.AppTree = n),
                    l.loadGetInitialProps(r, { AppTree: n, Component: t, router: this, ctx: e })
                  )
                }
              },
              {
            ...
            function (s) {
              for (;;)
                switch ((s.prev = s.next)) {
                  ...
                  case 9:
                    return (s.t0 = s.sent), s.abrupt('return', { pageProps: s.t0 })
                  case 11:
      ...
      t.exports = function (t, e, r, a) {
        ...
        for (var l = 0; l < s; ++l) {
          var f,
            ...
            v = t[l].replace(c, '%20'),
            d = v.indexOf(r)
          d >= 0 ? ((f = v.substr(0, d)), (p = v.substr(d + 1))) : ((f = v), (p = '')),
