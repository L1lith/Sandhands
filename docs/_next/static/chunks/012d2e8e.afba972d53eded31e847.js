    ...
    Bhyg: function (e, t, i) {
      !(function () {
        ...
        var t = function (e, i, n) {
          'string' === typeof e
            ? (2 == arguments.length && (n = i),
              t.modules[e] || ((t.payloads[e] = n), (t.modules[e] = null)))
            : t.original
        ...
        !(function (i) {
          var s = e
          i && (e[i] || (e[i] = {}), (s = e[i])),
            (s.define && s.define.packaged) ||
              ((t.original = s.define), (s.define = t), (s.define.packaged = !0)),
            (s.acequire && s.acequire.packaged) ||
              ((n.original = s.acequire), (s.acequire = n), (s.acequire.packaged = !0))
        })('ace')
      })(),
        ace.define('ace/lib/regexp', ['require', 'exports', 'module'], function (e, t, i) {
          ...
          ;(o && s) ||
            ((RegExp.prototype.exec = function (e) {
              var t,
                i,
                l = n.exec.apply(this, arguments)
              if ('string' == typeof e && l) {
                if (
                  (!s &&
                    l.length > 1 &&
                    a(l, '') > -1 &&
                    ((i = RegExp(this.source, n.replace.call(r(this), 'g', ''))),
                    n.replace.call(e.slice(l.index), i, function () {
        ...
        ace.define('ace/lib/es5-shim', ['require', 'exports', 'module'], function (e, t, i) {
          ...
          var s,
            ...
            d = c.slice,
            g = h.bind(u.toString),
            f = h.bind(u.hasOwnProperty)
          if (
            ((l = f(u, '__defineGetter__')) &&
              ((s = h.bind(u.__defineGetter__)),
              (o = h.bind(u.__defineSetter__)),
              (r = h.bind(u.__lookupGetter__)),
              (a = h.bind(u.__lookupSetter__))),
            ...
            if (
              ...
              Array.prototype.splice = function (e, t) {
                ...
                if (e === i) o && this.push.apply(this, s)
                  ...
                  else for (this.length = c + o, u = 0; u < o; ++u) this[e + u] = s[u]
                }
                return n
              }
          Array.isArray ||
          ...
          if (
            (Array.prototype.forEach ||
              (Array.prototype.forEach = function (e) {
                var t = R(this),
                  i = F && '[object String]' == g(this) ? this.split('') : t,
                  n = arguments[1],
                  s = -1,
                  o = i.length >>> 0
            ...
            Array.prototype.filter ||
              (Array.prototype.filter = function (e) {
                var t,
                  i = R(this),
                  n = F && '[object String]' == g(this) ? this.split('') : i,
                  s = n.length >>> 0,
                  o = [],
                  r = arguments[1]
                if ('[object Function]' != g(e)) throw new TypeError(e + ' is not a function')
            ...
            (Array.prototype.indexOf && -1 == [0, 1].indexOf(1, 2)) ||
              (Array.prototype.indexOf = function (e) {
                var t = F && '[object String]' == g(this) ? this.split('') : R(this),
                  i = t.length >>> 0
                if (!i) return -1
                var n = 0
                for (
                  arguments.length > 1 && (n = L(arguments[1])),
                    n = n >= 0 ? n : Math.max(0, i + n);
                  n < i;
                  n++
                )
            ...
            (Array.prototype.lastIndexOf && -1 == [0, 1].lastIndexOf(0, -3)) ||
              (Array.prototype.lastIndexOf = function (e) {
                ...
                var n = i - 1
                for (
                  arguments.length > 1 && (n = Math.min(n, L(arguments[1]))),
            ...
            Object.getOwnPropertyDescriptor = function (e, t) {
              ...
              if (f(e, t)) {
                var i
                if (((i = { enumerable: !0, configurable: !0 }), l)) {
                  var n = e.__proto__
                  e.__proto__ = u
                  var s = r(e, t),
                    o = a(e, t)
          ...
          if (Object.defineProperty) {
            var w = v({}),
              E = 'undefined' == typeof document || v(document.createElement('div'))
            if (!w || !E) var b = Object.defineProperty
          }
          if (!Object.defineProperty || b) {
            Object.defineProperty = function (e, t, i) {
              ...
              if (('object' != typeof i && 'function' != typeof i) || null === i)
                throw new TypeError('Property description must be an object: ' + i)
              if (b)
                try {
              ...
              if (f(i, 'value'))
                ...
                f(i, 'get') && s(e, t, i.get), f(i, 'set') && o(e, t, i.set)
              }
              return e
            }
          }
          ...
          if (!String.prototype.trim || S.trim()) {
            S = '[' + S + ']'
            var x = new RegExp('^' + S + S + '*'),
              k = new RegExp(S + S + '*$')
            String.prototype.trim = function () {
              return String(this).replace(x, '').replace(k, '')
            }
          }
          function L(e) {
            return (
        ...
        ace.define('ace/lib/dom', ['require', 'exports', 'module'], function (e, t, i) {
          ...
          ;(t.getDocumentHead = function (e) {
            ...
            (t.importCssString = function (e, i, n) {
              ...
              i && (e += '\n/*# sourceURL=ace/css/' + i + ' */'),
                n.createStyleSheet
                  ? (((s = n.createStyleSheet()).cssText = e), i && (s.owningElement.id = i))
                  : ((s = t.createElement('style')).appendChild(n.createTextNode(e)),
                    i && (s.id = i),
            ...
            ;(t.addListener = function (e, t, i) {
              ...
              (t.getButton = function (e) {
                return 'dblclick' == e.type
                  ? 0
                  : 'contextmenu' == e.type || (s.isMac && e.ctrlKey && !e.altKey && !e.shiftKey)
                  ? 2
                  : e.preventDefault
                  ? e.button
              ...
              (t.addMultiMouseDownListener = function (e, i, n, o) {
                ...
                function u(e) {
                  if (
                    (0 !== t.getButton(e) ? (h = 0) : e.detail > 1 ? ++h > 4 && (h = 1) : (h = 1),
                    s.isIE)
                  ) {
                  ...
                  if (((e._clicks = h), n[o]('mousedown', e), h > 4)) h = 0
                ...
                Array.isArray(e) || (e = [e]),
                  e.forEach(function (e) {
                    t.addListener(e, 'mousedown', u), s.isOldIE && t.addListener(e, 'dblclick', d)
                  })
              })
            var a =
              !s.isMac || !s.isOpera || 'KeyboardEvent' in window
                ? function (e) {
                    return (
                      0 |
                      (e.ctrlKey ? 1 : 0) |
            ...
            function l(e, t, i) {
              ...
              if (!s.isMac && o) {
                ...
                if (18 === i || 17 === i) {
                  ...
                  if (17 === i && 1 === h) 1 == o[i] && (r = t.timeStamp)
                  else if (18 === i && 3 === l && 2 === h) {
                    t.timeStamp - r < 50 && (o.altGr = !0)
                  }
                }
              }
              if (
                (i in n.MODIFIER_KEYS && (i = -1),
                8 & l && i >= 91 && i <= 93 && (i = -1),
                !l && 13 === i) &&
                3 === (h = 'location' in t ? t.location : t.keyLocation) &&
                (e(t, l, -i), t.defaultPrevented)
              )
                return
              if (s.isChromeOS && 8 & l) {
            ...
            if (
              ...
              t.nextTick = function (e, i) {
                ...
                t.addListener(i, 'message', function n(s) {
                  'zero-timeout-message-1' == s.data &&
                    (t.stopPropagation(s), t.removeListener(i, 'message', n), e())
                }),
        ...
        ace.define(
          ...
          function (e, t, i) {
            ...
            t.TextInput = function (e, t) {
              ...
              ;(i.className = s.isIOS ? 'ace_text-input ace_text-input-ios' : 'ace_text-input'),
                s.isTouchPad && i.setAttribute('x-palm-disable-auto-cap', !0),
              ...
              var u = '\n aaaa a\n',
                ...
                A = !0
              try {
                var C = document.activeElement === i
              } catch (W) {}
              ...
              function w(e) {
                if (!m) {
                  if (((m = !0), b)) (t = 0), (n = e ? 0 : i.value.length - 1)
                  else
                    var t = 4,
                      n = 5
                  try {
              ...
              function E() {
                m || ((i.value = u), s.isWebKit && v.schedule())
              }
              s.isWebKit ||
              ...
              var $ = !1,
                y = function (e) {
                  ;(4 === i.selectionStart && 5 === i.selectionEnd) ||
                    (b && ((e = b(e)), (b = null)),
                    f
                      ? (w(), e && t.onPaste(e), (f = !1))
                      : e == u.substr(0) && 4 === i.selectionStart
                      ? $
                        ? t.execCommand('del', { source: 'ace' })
                        : t.execCommand('backspace', { source: 'ace' })
                      : d ||
                        (e.substring(0, 9) == u && e.length > u.length
                          ? (e = e.substr(9))
                          : e.substr(0, 4) == u.substr(0, 4)
                          ? (e = e.substr(4, e.length - u.length + 1))
              ...
              n.addCommandKeyListener(i, t.onCommandKey.bind(t)),
                n.addListener(i, 'select', function (e) {
                  !(function (e) {
                    return 0 === e.selectionStart && e.selectionEnd === e.value.length
                  })(i)
                    ? b && w(t.selection.isEmpty())
                    : (t.selectAll(), w())
                }),
                n.addListener(i, 'input', B),
                n.addListener(i, 'cut', function (e) {
                  S(e, !0)
                }),
                ...
                n.addListener(i, 'paste', function (e) {
                  var o = D(e)
                  'string' == typeof o
                    ? (o && t.onPaste(o, e), s.isIE && setTimeout(w), n.preventDefault(e))
                    : ((i.value = ''), (f = !0))
                })
              var x,
                k = function () {
                ...
                L = function (e) {
                  if (t.onCompositionEnd && !t.$readOnly) {
                    ...
                    var o = setTimeout(function () {
                      o = null
                      var e = i.value.replace(/\x01/g, '')
                      m || (e == n.lastValue ? E() : !n.lastValue && e && (E(), y(e)))
                    })
                    ;(b = function (e) {
                      return (
                        o && clearTimeout(o),
                        (e = e.replace(/\x01/g, '')) == n.lastValue
                          ? ''
                          : (n.lastValue && o && t.undo(), e)
                      )
                    }),
                      t.onCompositionEnd(),
                      t.removeListener('mousedown', L),
                      'compositionend' == e.type && n.range && t.selection.setRange(n.range),
                      ((!!s.isChrome && s.isChrome >= 53) || (!!s.isWebKit && s.isWebKit >= 603)) &&
                        B()
                  }
                },
                R = r.delayedCall(k, 50)
              function M() {
                clearTimeout(x),
                  (x = setTimeout(function () {
                    p && ((i.style.cssText = p), (p = '')),
              ...
              n.addListener(i, 'compositionstart', function (e) {
                ...
                n.addListener(i, 'compositionend', L),
                ...
                (this.moveToMouse = function (e, r) {
                  ...
                  var a = t.container.getBoundingClientRect(),
                    ...
                    d = function (e) {
                      ;(i.style.left = e.clientX - c - 2 + 'px'),
                        (i.style.top = Math.min(e.clientY - h - 2, u) + 'px')
                    }
                  d(e),
                    'mousedown' == e.type &&
                      ...
                      clearTimeout(x),
                      s.isWin && n.capture(t.container, d, M))
                }),
              ...
              if (
                (n.addListener(i, 'mouseup', T),
                n.addListener(i, 'mousedown', function (e) {
                  e.preventDefault(), M()
                }),
                n.addListener(t.renderer.scroller, 'contextmenu', T),
                n.addListener(i, 'contextmenu', T),
                s.isIOS)
              ) {
                var _ = null,
                  O = !1
                e.addEventListener('keydown', function (e) {
                  _ && clearTimeout(_), (O = !0)
                }),
                ...
                var I = function (e) {
                  if (document.activeElement === i && !O) {
                    ...
                    var n = i.selectionStart,
                      s = i.selectionEnd
                    if ((i.setSelectionRange(4, 5), n == s))
                      switch (n) {
                        case 0:
        ...
        ace.define(
          ...
          function (e, t, i) {
            ...
            var n = e('../lib/event'),
              ...
              a = s.isChrome < 18,
              l = s.isIE,
              h = e('./textinput_ios').TextInput
            t.TextInput = function (e, t) {
              if (s.isIOS) return h.call(this, e, t)
              var i = o.createElement('textarea')
              ...
              function v() {
                g || ((i.value = c), s.isWebKit && C.schedule())
              }
              s.isWebKit ||
                t.addEventListener('changeSelection', function () {
              ...
              var E = !1,
                ...
                x = function (e) {
                  var o = y(e)
                  'string' == typeof o
                    ? (o && t.onPaste(o, e), s.isIE && setTimeout(F), n.preventDefault(e))
                    : ((i.value = ''), (d = !0))
                }
              n.addCommandKeyListener(i, t.onCommandKey.bind(t)),
                n.addListener(i, 'select', function (e) {
                  u
                    ...
                    ? w && F(t.selection.isEmpty())
                    : (t.selectAll(), F())
                }),
                n.addListener(i, 'input', $),
                n.addListener(i, 'cut', D),
                n.addListener(i, 'copy', S),
                n.addListener(i, 'paste', x),
              ...
              var k,
                L = function () {
                  if (g && t.onCompositionUpdate && !t.$readOnly) {
                    ...
                    if (
                      ...
                      (t.onCompositionUpdate(e),
                      g.lastValue && t.undo(),
                      g.canUndo && (g.lastValue = e),
                      g.lastValue)
                    ) {
                      var n = t.selection.getRange()
                      t.insert(g.lastValue),
                        t.session.markUndoGroup(),
                        (g.range = t.selection.getRange()),
                        t.selection.setRange(n),
                        t.selection.clearSelection()
                    }
                  }
                ...
                R = function (e) {
                  if (t.onCompositionEnd && !t.$readOnly) {
                    ...
                    var o = setTimeout(function () {
                      o = null
                      var e = i.value.replace(/\u2028/g, '')
                      g || (e == n.lastValue ? v() : !n.lastValue && e && (v(), b(e)))
                    })
                    ;(w = function (e) {
                      return (
                        o && clearTimeout(o),
                        (e = e.replace(/\u2028/g, '')) == n.lastValue
                          ? ''
                          : (n.lastValue && o && t.undo(), e)
                      )
                    }),
                ...
                M = r.delayedCall(L, 50)
              function T() {
                clearTimeout(k),
                  (k = setTimeout(function () {
                    f && ((i.style.cssText = f), (f = '')),
                      null == t.renderer.$keepTextAreaAtCursor &&
                        ((t.renderer.$keepTextAreaAtCursor = !0),
                        t.renderer.$moveTextAreaToCursor())
                  }, 0))
              ...
              n.addListener(i, 'compositionstart', function (e) {
                g ||
                  !t.onCompositionStart ||
                  t.$readOnly ||
                  (((g = {}).canUndo = t.session.$undoManager),
                  t.onCompositionStart(),
                  setTimeout(L, 0),
                  t.on('mousedown', R),
                  g.canUndo &&
                ...
                n.addListener(i, 'compositionend', R),
                (this.getElement = function () {
                  return i
                }),
                (this.setReadOnly = function (e) {
                  ...
                  d(e),
                    'mousedown' == e.type &&
                      (t.renderer.$keepTextAreaAtCursor &&
                        (t.renderer.$keepTextAreaAtCursor = null),
                      clearTimeout(k),
                      s.isWin && n.capture(t.container, d, T))
                }),
                (this.onContextMenuClose = T)
              var _ = function (e) {
                t.textInput.onContextMenu(e), T()
              }
              n.addListener(i, 'mouseup', _),
                n.addListener(i, 'mousedown', function (e) {
                  e.preventDefault(), T()
                }),
                n.addListener(t.renderer.scroller, 'contextmenu', _),
                n.addListener(i, 'contextmenu', _)
            }
          }
        ),
        ace.define(
            ...
            ;(function () {
              ;(this.onMouseDown = function (e) {
                ...
                var s = this.editor,
                  o = e.getButton()
                if (0 !== o) {
                  var r = s.getSelectionRange().isEmpty()
                  return (
                    s.$blockScrolling++,
                    (r || 1 == o) && s.selection.moveToPosition(i),
                    s.$blockScrolling--,
                    void (
                      2 == o &&
                      (s.textInput.onContextMenu(e.domEvent), n.isMozilla || e.preventDefault())
                    )
                  )
                }
                return (
                  ...
                  !t ||
                  s.isFocused() ||
                  (s.focus(), !this.$focusTimout || this.$clickSelection || s.inMultiSelectMode)
                    ? (this.captureMouse(e),
                ...
                (this.focusWait = function () {
                  var e,
                    ...
                    o = Date.now()
                  ;(s > 0 || o - this.mousedownEvent.time > this.$focusTimout) &&
                ...
                (this.onDoubleClick = function (e) {
                  ...
                  n
                    ...
                    : ((n = i.selection.getWordRange(t.row, t.column)),
                ...
                (this.onMouseWheel = function (e) {
                  if (!e.getAccelKey()) {
                    ...
                    if (
                      ...
                      Math.abs(o) <= 1.1 * Math.abs(i.vx) && Math.abs(r) <= 1.1 * Math.abs(i.vy)
                        ? ((l = !0), (i.allowed = n))
                        : (i.allowed = 0)
                    }
                    return (
                ...
                function c() {
                  t && (t = clearTimeout(t)),
                    s &&
                      (h.hide(),
                      (s = null),
                      r._signal('hideGutterTooltip', h),
                      r.removeEventListener('mousewheel', c))
                }
                function u(e) {
                            ...
                            i && !e.isMousePressed
                              ? (function () {
                                  ...
                                  if (t == r.session.getLength()) {
                                    var o = r.renderer.pixelToScreenCoordinates(0, i.y).row,
                                      a = i.$pos
                                    if (o > r.session.documentToScreenRow(a.row, a.column))
                                      return c()
                                  }
                                  if (s != n)
                                    if (
          ...
          function (e, t, i) {
            ...
            function h(e) {
              ...
              function b() {
                ...
                ;(function (e, i) {
                  ...
                  !F || s || o
                    ...
                    : c(v.x, v.y, u, d) > l
                    ? (F = null)
                    : n - F >= a && (t.renderer.scrollCursorIntoView(), (F = null))
                })((m = t.renderer.screenToTextCoordinates(u, d)), e),
                  (function (e, i) {
                    var n = Date.now(),
                      ...
                      l = {
                        x: { left: u - a.left, right: a.right - u },
                        y: { top: d - a.top, bottom: a.bottom - d }
                      },
                      h = Math.min(l.x.left, l.x.right),
                      c = Math.min(l.y.top, l.y.bottom),
                      g = { row: e.row, column: e.column }
                    h / o <= 2 && (g.column += l.x.left < l.x.right ? -3 : 2),
                      c / s <= 1 && (g.row += l.y.top < l.y.bottom ? -1 : 1)
                    var f = e.row != g.row,
                      m = e.column != g.column,
                      p = !i || e.row != i.row
                    f || (m && !p)
                      ? C
                        ? n - C >= r && t.renderer.scrollCursorIntoView(g)
                        : (C = n)
                      : (C = null)
                  })(m, e)
              }
              function $() {
                ;(f = t.selection.toOrientedRange()),
                  (h = t.session.addMarker(f, 'ace_selection', t.getSelectionStyle())),
                  t.clearSelection(),
                  ...
                  (g = setInterval(b, 20)),
                  (E = 0),
                  s.addListener(document, 'mousemove', D)
              }
              function y() {
                clearInterval(g),
                  ...
                  (h = null),
                  (t.$blockScrolling += 1),
                  t.selection.fromOrientedRange(f),
                  (t.$blockScrolling -= 1),
                  t.isFocused() && !A && t.renderer.$cursorLayer.setBlinking(!t.getReadOnly()),
                  (f = null),
                  (m = null),
                  (E = 0),
                  (C = null),
                  (F = null),
                  s.removeListener(document, 'mousemove', D)
              }
              ;(this.onDragStart = function (e) {
                ...
                ;(s.effectAllowed = t.getReadOnly() ? 'copy' : 'copyMove'),
                  o.isOpera && (t.container.appendChild(i), (i.scrollTop = 0)),
                  s.setDragImage && s.setDragImage(i, 0, 0),
                  o.isOpera && t.container.removeChild(i),
                  s.clearData(),
                ...
                (this.onDragEnd = function (e) {
                  if (((w.draggable = !1), (A = !1), this.setState(null), !t.getReadOnly())) {
                    var i = e.dataTransfer.dropEffect
                    p || 'move' != i || t.session.remove(t.getSelectionRange()),
                      t.renderer.$cursorLayer.setBlinking(!0)
                  }
                  this.editor.unsetStyle('ace_dragging'), this.editor.renderer.setCursorStyle('')
                }),
                (this.onDragEnter = function (e) {
                  if (!t.getReadOnly() && S(e.dataTransfer))
                    return (
                      (u = e.clientX),
                      (d = e.clientY),
                      h || $(),
                      E++,
                      (e.dataTransfer.dropEffect = p = x(e)),
                      s.preventDefault(e)
                    )
                }),
                ...
                (this.onDragLeave = function (e) {
                  if (--E <= 0 && h) return y(), (p = null), s.preventDefault(e)
                }),
                (this.onDrop = function (e) {
                  if (m) {
                    ...
                    if (A)
                      switch (p) {
                        case 'move':
                          f = f.contains(m.row, m.column) ? { start: m, end: m } : t.moveText(f, m)
                          break
                        case 'copy':
                          f = t.moveText(f, m, !0)
                      }
                      ...
                      ;(f = { start: m, end: t.session.insert(m, n) }), t.focus(), (p = null)
                    }
                    return y(), s.preventDefault(e)
                  }
                }),
                s.addListener(w, 'dragstart', this.onDragStart.bind(e)),
                s.addListener(w, 'dragend', this.onDragEnd.bind(e)),
                s.addListener(w, 'dragenter', this.onDragEnter.bind(e)),
                s.addListener(w, 'dragover', this.onDragOver.bind(e)),
                s.addListener(w, 'dragleave', this.onDragLeave.bind(e)),
                s.addListener(w, 'drop', this.onDrop.bind(e))
              var B = null
              function D() {
                null == B &&
            ...
            ;(function () {
              ;(this.dragWait = function () {
                Date.now() - this.mousedownEvent.time > this.editor.getDragDelay() &&
                  this.startDrag()
              }),
                ...
                (this.onMouseDrag = function (e) {
                  ...
                  o.isIE &&
                    ...
                    c(this.mousedownEvent.x, this.mousedownEvent.y, this.x, this.y) > 3 &&
                    t.dragDrop()
                  'dragWait' === this.state &&
              ...
              o = {
                ...
                setOption: function (e, t) {
                  if (this['$' + e] !== t) {
                    ...
                    if (!i) return r('misspelled option "' + e + '"')
        ...
        ace.define(
          ...
          function (e, t, n) {
            ...
            function h(s) {
              if (a && a.document) {
                l.packaged = s || e.packaged || n.packaged || (a.define && i('B9Yq').packaged)
                for (
                  var o,
                    r = {},
                    h = '',
                  ...
                  if (f) {
                    for (var m = g.attributes, p = 0, A = m.length; p < A; p++) {
                      var C = m[p]
                      0 === C.name.indexOf('data-ace-') &&
                        (r[
                          ((o = C.name.replace(/^data-ace-/, '')),
                ...
                for (var v in (h && ((r.base = r.base || h), (r.packaged = !0)),
                (r.basePath = r.base),
                ...
                delete r.base,
                r))
                  'undefined' !== typeof r[v] && t.set(v, r[v])
              }
            }
            ;(t.get = function (e) {
            ...
            ;(function () {
              ;(this.onMouseEvent = function (e, t) {
                ...
                (this.captureMouse = function (e, t) {
                  ...
                  ;(o.$onCaptureMouseMove = r),
                    (o.releaseMouse = n.capture(this.editor.container, r, l))
            ...
            ;(function () {
              ;(this.setDefaultHandler = function (e) {
                ...
                (this.removeKeyboardHandler = function (e) {
                  ...
                  return (
                    -1 != t && (this.$handlers.splice(t, 1), e.detach && e.detach(this.$editor), !0)
                  )
                }),
                ...
                (this.$callKeyboardHandlers = function (e, t, i, n) {
                  for (
                    var o, r = !1, a = this.$editor.commands, l = this.$handlers.length;
                    l-- &&
                    !(
                      (o = this.$handlers[l].handleKeyboard(this.$data, e, t, i, n)) &&
                      o.command &&
                      ((r = 'null' == o.command || a.exec(o.command, this.$editor, o.args, n)) &&
                        n &&
                        -1 != e &&
                        1 != o.passEvent &&
        ...
        ace.define('ace/lib/bidiutil', ['require', 'exports', 'module'], function (e, t, i) {
          ...
          function R(e, t, i) {
            if (!(s < e))
              if (1 != e || n != c || r)
                for (var o, a, l, h, u = i.length, d = 0; d < u; ) {
                  if (t[d] >= e) {
                    for (o = d + 1; o < u && t[o] >= e; ) o++
                    for (a = d, l = o - 1; a < l; a++, l--) (h = i[a]), (i[a] = i[l]), (i[l] = h)
                    d = o
                  }
                  d++
                }
            ...
            switch (L) {
              ...
              case v:
                return s < 1 ||
                  ...
                  : (o && (h = f), h == l ? h : m)
              case w:
                return (l = s > 0 ? i[s - 1] : p) == g && s + 1 < t.length && t[s + 1] == g ? g : m
              case E:
                if (s > 0 && i[s - 1] == g) return g
                if (o) return m
                for (k = s + 1, c = t.length; k < c && t[k] == E; ) k++
                return k < c && t[k] == g ? g : m
              case b:
                for (c = t.length, k = s + 1; k < c && t[k] == b; ) k++
                if (k < c) {
                  var R = e[s],
                    M = (R >= 1425 && R <= 2303) || 64286 == R
                  if (((l = t[k]), M && (l == d || l == C))) return d
                }
                return s < 1 || (l = t[s - 1]) == p ? m : i[s - 1]
              case p:
                return (o = !1), (r = !0), n
              case A:
                return (a = !0), m
          ...
          ;(t.L = u),
            ...
            (t.B = 6),
            (t.DOT = '\xb7'),
            (t.doBidiReorder = function (e, i, u) {
              if (e.length < 2) return {}
              var g = e.split(''),
                v = new Array(g.length),
                w = new Array(g.length),
                E = []
              ;(n = u ? c : 0),
                (function (e, t, i, c) {
                  var u = n ? h : l,
                    ...
                    E = null,
                    b = []
                  if (!c) for (w = 0, c = []; w < i; w++) c[w] = T(e[w])
                  for (s = n, o = !1, !1, r = !1, a = !1, E = 0; E < i; E++) {
                    if (
                      ((d = m),
                      (b[E] = g = M(e, c, b, E)),
                      (C = 240 & (m = u[d][g])),
                  ...
                  if (a)
                    for (w = 0; w < i; w++)
                      if (c[w] == A) {
                        t[w] = n
                        for (var $ = w - 1; $ >= 0 && c[$] == F; $--) t[$] = n
                      }
                })(g, E, g.length, i)
              for (var b = 0; b < v.length; v[b] = b, b++);
              R(2, E, v), R(1, E, v)
              for (b = 0; b < v.length - 1; b++)
                i[b] === f
                  ? (E[b] = t.AN)
                  : E[b] === d && ((i[b] > C && i[b] < $) || i[b] === m || i[b] === x)
                  ? (E[b] = t.ON_R)
                  : b > 0 &&
                    '\u0644' === g[b - 1] &&
                    /\u0622|\u0623|\u0625|\u0627/.test(g[b]) &&
                    ((E[b - 1] = E[b] = t.R_H), b++)
              g[g.length - 1] === t.DOT && (E[g.length - 1] = t.B)
              for (b = 0; b < v.length; b++) w[b] = E[v[b]]
              return { logicalFromVisual: v, bidiLevels: w }
            }),
            (t.hasBidiCharacters = function (e, t) {
              for (var i = !1, n = 0; n < e.length; n++)
                (t[n] = T(e.charAt(n))), i || (t[n] != d && t[n] != C) || (i = !0)
              return i
            }),
        ...
        ace.define(
          'ace/bidihandler',
          ['require', 'exports', 'module', 'ace/lib/bidiutil', 'ace/lib/lang', 'ace/lib/useragent'],
          function (e, t, i) {
            'use strict'
            ...
            ;(function () {
              ;(this.isBidiRow = function (e, t, i) {
                return (
                  !!this.seenBidi &&
                  (e !== this.currentRow &&
                    ((this.currentRow = e), this.updateRowLine(t, i), this.updateBidiMap()),
                ...
                (this.updateRowLine = function (e, t) {
                  if (
                    ...
                    i &&
                      ...
                      t > 0 && i.length
                        ? ((this.wrapIndent = i.indent),
                          (this.line =
                            t < i.length
                              ? this.line.substring(i[t - 1], i[i.length - 1])
                              : this.line.substring(i[i.length - 1])))
                        : (this.line = this.line.substring(0, i[t])))
                  }
                  var o,
                    r = this.session,
                    a = 0
                  this.line = this.line.replace(
                    /\t|[\u1100-\u2029, \u202F-\uFFE6]/g,
                    function (e, t) {
                      return '\t' === e || r.isFullWidth(e.charCodeAt(0))
                        ? ((o = '\t' === e ? r.getScreenTabSize(t + a) : 2),
                          (a += o - 1),
                          s.stringRepeat(n.DOT, o))
                        : e
                    }
                  )
                }),
                (this.updateBidiMap = function () {
                  ...
                  n.hasBidiCharacters(i, e)
                    ? (this.bidiMap = n.doBidiReorder(i, e, this.isRtlDir))
                    : (this.bidiMap = {})
                }),
                ...
                (this.updateCharacterWidths = function (e) {
                  if (this.seenBidi && this.characterWidth !== e.$characterSize.width) {
                    ...
                    ;(this.charWidths[n.L] = this.charWidths[n.EN] = this.charWidths[n.ON_R] = t),
                      ...
                      (this.charWidths[n.R_H] = o.isChrome ? i : 0.45 * i),
                      (this.charWidths[n.B] = 0),
                      (this.currentRow = null)
                  }
                }),
                ...
                (this.getPosLeft = function (e) {
                  ...
                  var t = n.getVisualFromLogicalIdx(e > 0 ? e - 1 : 0, this.bidiMap),
                    ...
                    s = 0
                  0 === e && i[t] % 2 !== 0 && t++
                  for (var o = 0; o < t; o++) s += this.charWidths[i[o]]
                  return (
                    0 !== e && i[t] % 2 === 0 && (s += this.charWidths[i[t]]),
                    this.wrapIndent && (s += this.wrapIndent * this.charWidths[n.L]),
                    s
                  )
                }),
                (this.getSelections = function (e, t) {
                  for (
                    var i,
                      ...
                      o = this.bidiMap,
                      r = o.bidiLevels,
                      a = this.wrapIndent * this.charWidths[n.L],
                      l = [],
                      h = Math.min(e, t) - this.wrapIndent,
                    ...
                    (s = o.logicalFromVisual[f]),
                      (i = r[f]),
                      (u = s >= h && s < c) && !d
                        ? (g = a)
                        : !u && d && l.push({ left: g, width: a - g }),
                      (a += this.charWidths[i]),
                      (d = u)
                  return u && f === r.length && l.push({ left: g, width: a - g }), l
                }),
                (this.offsetToCol = function (e) {
                  ...
                  for (
                    this.wrapIndent && (e -= this.wrapIndent * this.charWidths[n.L]);
                    e > i + r / 2;
                  ...
                  return (
                    s > 0 && o[s - 1] % 2 !== 0 && o[s] % 2 === 0
                      ? (e < i && s--, (t = this.bidiMap.logicalFromVisual[s]))
                      : s > 0 && o[s - 1] % 2 === 0 && o[s] % 2 !== 0
                      ? (t =
                          1 +
                          (e > i
                            ? this.bidiMap.logicalFromVisual[s]
                            : this.bidiMap.logicalFromVisual[s - 1]))
                      : (this.isRtlDir && s === o.length - 1 && 0 === r && o[s - 1] % 2 === 0) ||
                        (!this.isRtlDir && 0 === s && o[s] % 2 !== 0)
                      ? (t = 1 + this.bidiMap.logicalFromVisual[s])
                      : (s > 0 && o[s - 1] % 2 !== 0 && 0 !== r && s--,
                        (t = this.bidiMap.logicalFromVisual[s])),
                    t + this.wrapIndent
                  )
                })
            }.call(a.prototype),
              ...
              n.implement(this, o),
                ...
                (this.getLineRange = function (e, t) {
                  ...
                  return (
                    ...
                    !0 === t
                      ? new r(n, 0, i, this.session.getLine(i).length)
                      : new r(n, 0, i + 1, 0)
                  )
                }),
                ...
                (this.wouldMoveIntoSoftTab = function (e, t, i) {
                  ...
                  return (
                    ...
                    this.session.isTabStop(e) &&
                      this.doc.getLine(e.row).slice(n, s).split(' ').length - 1 == t
                  )
                }),
                ...
                (this.$shortWordEndIndex = function (e) {
                  ...
                  if (((s.lastIndex = 0), this.session.tokenRe.exec(e)))
                ...
                (this.moveCursorBy = function (e, t) {
                  ...
                  0 !== e &&
                    ...
                    this.session.lineWidgets[s.row] &&
                    (s.row > 0 || e > 0) &&
                    s.row++,
                ...
                this.states)) {
                  for (
                    var i = this.states[t],
                      n = [],
                      s = 0,
                      o = (this.matchMappings[t] = { defaultToken: 'text' }),
                      r = 'g',
                      a = [],
                      l = 0;
                    l < i.length;
                    ...
                    var h = i[l]
                    if (
                      (h.defaultToken && (o.defaultToken = h.defaultToken),
                    ...
                    e.replace(/(\\.)|(\((?:\?[=!])?)|(\))|([\[\]])/g, function (e, t, o, r, a, l) {
                      return (
                        n
                          ...
                          : o && (i++, 1 != o.length && ((s.stack = i), (s.start = l))),
                        e
                      )
                    }),
                      null != s.end &&
                ...
                (this.getLineTokens = function (e, t) {
                  ...
                  for (
                    ...
                    for (var C = 0; C < l.length - 2; C++)
                      if (void 0 !== l[C + 1]) {
                        ;(g = (f = o[r[C]]).onMatch ? f.onMatch(m, n, i, e) : f.token),
                          f.next &&
                    ...
                    for (var n = e[i], s = 0; s < n.length; s++) {
                      ...
                      ;(o.next || o.onMatch) &&
                        ('string' == typeof o.next &&
                          ...
                          (o.next = t + o.next),
                        o.nextState &&
                          0 !== o.nextState.indexOf(t) &&
                          (o.nextState = t + o.nextState))
                    }
                    this.$rules[t + i] = n
                  }
                ...
                Object.keys(n).forEach(function s(o) {
                  ...
                  for (var a = 0; a < r.length; a++) {
                    ...
                    if (c && Array.isArray(c)) {
                      var u = l.stateName
                      u ||
                        ('string' != typeof (u = l.token) && (u = u[0] || ''), n[u] && (u += i++)),
                        (n[u] = c),
                        (l.next = u),
                        s(u)
                    } else 'pop' == c && (l.next = t)
          ...
          function (e, t, i) {
                ...
                this.add('braces', 'insertion', function (t, i, s, o, r) {
                  ...
                  if ('{' == r) {
                    ...
                    if (f.isSaneInsertion(s, o))
                      return /[\]\}\)]/.test(h[l.column]) || s.inMultiSelectMode || (e && e.braces)
                        ? (f.recordAutoInsert(s, o, '}'), { text: '{}', selection: [1, 1] })
                        : (f.recordMaybeInsert(s, o, '{'), { text: '{', selection: [1, 1] })
                  } else if ('}' == r) {
                    if ((d(s), '}' == h.substring(l.column, l.column + 1)))
                      if (
                        null !== o.$findOpeningBracket('}', { column: l.column + 1, row: l.row }) &&
                        f.isAutoInsertedClosing(l, h, r)
                      )
                        return f.popAutoInsertedClosing(), { text: '', selection: [1, 1] }
                  } else {
                    if ('\n' == r || '\r\n' == r) {
                      d(s)
                      var m = ''
                      if (
                        (f.isMaybeInsertedClosing(l, h) &&
                          ((m = a.stringRepeat('}', n.maybeInsertedBrackets)),
                          f.clearMaybeInsertedClosing()),
                        '}' === h.substring(l.column, l.column + 1))
                      ) {
                        var p = o.findMatchingBracket({ row: l.row, column: l.column + 1 }, '}')
                        if (!p) return null
                        var A = this.$getIndent(o.getLine(p.row))
                      } else {
                        if (!m) return void f.clearMaybeInsertedClosing()
                        A = this.$getIndent(h)
                      }
                      var C = A + o.getTabString()
                      return {
                        text: '\n' + C + '\n' + A + m,
                  ...
                  this.add('parens', 'insertion', function (e, t, i, n, s) {
                    if ('(' == s) {
                      ...
                      if (f.isSaneInsertion(i, n))
                        return f.recordAutoInsert(i, n, ')'), { text: '()', selection: [1, 1] }
                    } else if (')' == s) {
                      d(i)
                      ...
                      if (')' == l.substring(a.column, a.column + 1))
                        if (
                          null !==
                            n.$findOpeningBracket(')', { column: a.column + 1, row: a.row }) &&
                  ...
                  this.add('parens', 'deletion', function (e, t, i, n, s) {
                    ...
                    if (
                      ...
                      ')' ==
                        n.doc
                          .getLine(s.start.row)
                          .substring(s.start.column + 1, s.start.column + 2))
                    )
                    ...
                    if (1 == s.length && o[s]) {
                      ...
                      if (!l) {
                        var h = i.getCursorPosition(),
                          ...
                          A = n.getTokenAt(h.row, h.column + 1)
                        if ('\\' == f && p && /escape/.test(p.type)) return null
                        var C,
                          F = p && /string|escape/.test(p.type),
                          v = !A || /string|escape/.test(A.type)
                        if (m == r) (C = F !== v) && /string\.end/.test(A.type) && (C = !1)
                        else {
                          if (F && !v) return null
                          if (F && v) return null
                        ...
                        return { text: C ? r + r : '', selection: [1, 1] }
                      }
                    }
                  }),
                  this.add('string_dquotes', 'deletion', function (e, t, i, n, s) {
                    ...
                    if (
                      ...
                      n.doc
                        .getLine(s.start.row)
                        .substring(s.start.column + 1, s.start.column + 2) == o)
                    )
                      return s.end.column++, s
                  })
              }
            ;(f.isSaneInsertion = function (e, t) {
              ...
              (f.recordAutoInsert = function (e, t, i) {
                ...
                this.isAutoInsertedClosing(s, o, n.autoInsertedLineEnd[0]) ||
              ...
              ;(this.$defaultBehaviour = new o()),
                ...
                (this.toggleCommentLines = function (e, t, i, n) {
                  ...
                  if (this.lineCommentStart) {
                    if (Array.isArray(this.lineCommentStart))
                      (m = this.lineCommentStart.map(a.escapeRegExp).join('|')),
                        (g = this.lineCommentStart[0])
                    else (m = a.escapeRegExp(this.lineCommentStart)), (g = this.lineCommentStart)
                    ...
                    var u = g + ' ',
                      d =
                        ((A = function (e, t) {
                          ;(o && !/\S/.test(e)) ||
                            (d(e, l, l)
                              ? s.insertInLine({ row: t, column: l }, u)
                              : s.insertInLine({ row: t, column: l }, g))
                        }),
                        (F = function (e, t) {
                          return m.test(e)
                        }),
                    ...
                    var g = this.blockComment.start,
                      ...
                      m = new RegExp('^(\\s*)(?:' + a.escapeRegExp(g) + ')'),
                      p = new RegExp('(?:' + a.escapeRegExp(f) + ')\\s*$'),
                      A = function (e, t) {
                        F(e, t) ||
                          (o && !/\S/.test(e)) ||
                          (s.insertInLine({ row: t, column: e.length }, f),
                          s.insertInLine({ row: t, column: l }, g))
                      },
                      C = function (e, t) {
                        var i
                        ;(i = e.match(p)) && s.removeInLine(t, e.length - i[0].length, e.length),
                          (i = e.match(m)) && s.removeInLine(t, i[1].length, i[0].length)
                      },
                      F = function (e, i) {
                ...
                (this.toggleBlockComment = function (e, t, i, n) {
                  ...
                  if (s) {
                    ...
                    var o,
                      r,
                      a = (m = new l(t, n.row, n.column)).getCurrentToken(),
                    ...
                    c.start.row == o && (c.start.column += r),
                      c.end.row == o && (c.end.column += r),
            ...
            switch (t.action) {
              ...
              case 'remove':
                var a = t.end.column,
                  l = t.end.row
                n === l
                  ? (e[n] = o.substring(0, s) + o.substring(a))
                  : e.splice(n, l - n + 1, o.substring(0, s) + e[l].substring(a))
            }
          }
        }),
        ace.define(
                  ...
                  if (
                    ...
                    var i = (function (t, i, n) {
                      var s = 'insert' == t.action,
                        ...
                        a = t.start,
                        l = s ? a : t.end
                      if (e(i, a, n)) return { row: i.row, column: i.column }
                      if (e(l, i, !n))
                        return { row: i.row + o, column: i.column + (i.row == l.row ? r : 0) }
            ...
            ;(function () {
              n.implement(this, o),
                ...
                (this.replace = function (e, t) {
                  return (
                    e instanceof r || (e = r.fromPoints(e.start, e.end)),
                ...
                (this.applyDelta = function (e, t) {
                  ...
                  ;(i ? e.lines.length <= 1 && !e.lines[0] : !r.comparePoints(e.start, e.end)) ||
                ...
                (this.update = function (e, t, i, o) {
                  if (this.regExp)
                    for (var r = o.firstRow, a = o.lastRow, l = r; l <= a; l++) {
                      var h = this.cache[l]
                      null == h &&
                        ((h = n.getMatchOffsets(i.getLine(l), this.regExp)).length >
                          this.MAX_RANGES && (h = h.slice(0, this.MAX_RANGES)),
                        (h = h.map(function (e) {
              ...
              ;(this.shiftRow = function (e) {
                ...
                (this.walk = function (e, t, i) {
                  ...
                  for (var l = 0; l < r.length; l++) {
                    ...
                    if (
                      (!e(null, n.start.row, n.start.column, o, a) &&
                        e(n.placeholder, n.start.row, n.start.column, o)) ||
                      0 === s
                    )
                      return
                ...
                (this.addRemoveChars = function (e, t, i) {
                  ...
                  if (o)
                    if (
                      ((n = o.fold), 'inside' == o.kind && n.start.column != t && n.start.row != e)
                    )
              ...
              ;(this.comparePoints = n),
                ...
                (this.merge = function () {
                  for (
                    ...
                    r < 0 ||
                      ((0 != r || e.isEmpty() || s.isEmpty()) &&
                        (n(e.end, s.end) < 0 &&
                          ((e.end.row = s.end.row), (e.end.column = s.end.column)),
                        i.splice(o, 1),
                        t.push(s),
                        (s = e),
                        o--))
                ...
                (this.$onChange = function (e) {
                  ...
                  for (
                    ...
                    if (!((h = r[a]).end.row < n)) {
                      ...
                      if (
                        (h.start.row == n &&
                          h.start.column >= t.column &&
                          ((h.start.column == t.column && this.$insertRight) ||
                            ((h.start.column += o), (h.start.row += s))),
                        h.end.row == n && h.end.column >= t.column)
                      ) {
                        if (h.end.column == t.column && this.$insertRight) continue
                        h.end.column == t.column &&
                          o > 0 &&
                          a < l - 1 &&
                          h.end.column > h.start.column &&
                          h.end.column == r[a + 1].start.column &&
                          (h.end.column -= o),
                          (h.end.column += o),
                          (h.end.row += s)
                      }
                ...
                ;(this.toString = function () {
                  ...
                  (this.addSubFold = function (e) {
                    if (!this.range.isEqual(e)) {
                      ...
                      var t, i
                      ;(t = e), (i = this.start), r(t.start, i), r(t.end, i)
                      for (
                        var n = e.start.row, s = e.start.column, o = 0, a = -1;
                        o < this.subFolds.length && 1 == (a = this.subFolds[o].range.compare(n, s));
                        o++
                      );
                      ...
                      for (
                        a = -1;
                        h < this.subFolds.length && 1 == (a = this.subFolds[h].range.compare(n, s));
                        h++
                      );
                      this.subFolds[h]
                      if (0 == a)
            ...
            t.Folding = function () {
              ;(this.getFoldAt = function (e, t, i) {
                ...
                (this.getFoldStringAt = function (e, t, i, n) {
                  ...
                  return (
                    s || (s = this.getLine(o.start.row).substring(r.end.column)),
                    -1 == i
                      ? s.substring(0, t - r.end.column)
                      : 1 == i
                      ? s.substring(t - r.end.column)
                      : s
                  )
                }),
                ...
                (this.addFold = function (e, t) {
                  ...
                  e instanceof o
                    ? (i = e)
                    : ((i = new o(t, e)).collapseChildren = t.collapseChildren),
                  ...
                  return (
                    r || (m = this.$addFoldLine(new s(this.$foldData, i))),
                    this.$useWrapMode
                ...
                (this.unfold = function (e, t) {
                  ...
                  if (
                    (null == e
                      ? ((i = new n(0, 0, this.getLength(), 0)), (t = !0))
                      : (i =
                          'number' == typeof e
                            ? new n(e, 0, e, this.getLine(e).length)
                            : 'row' in e
                            ? n.fromPoints(e, e)
                            : e),
                ...
                (this.getDisplayLine = function (e, t, i, n) {
                  ...
                  return o
                    ? this.getFoldDisplayLine(o, e, t, i, n)
                ...
                (this.$toggleFoldWidget = function (e, t) {
                  if (this.getFoldWidget) {
                    ...
                    if (
                      r &&
                      !r.isMultiLine() &&
                      (o = this.getFoldAt(r.start.row, r.start.column, 1)) &&
                      r.isEqual(o.range)
                    )
                    ...
                    if (t.siblings) {
                      ...
                      t.children
                        ? ((h = r ? r.end.row : this.getLength()),
                          this.foldAll(e + 1, h, t.all ? 1e4 : 0))
                        : r && (t.all && (r.collapseChildren = 1e4), this.addFold('...', r))
                    return r
                  }
                }),
              ...
              function () {
                n.implement(this, a),
                  ...
                  (this.getTokenAt = function (e, t) {
                    ...
                    } else for (o = 0; o < n.length && !((s += n[o].value.length) >= t); o++);
                  ...
                  (this.addMarker = function (e, t, i, n) {
                    ...
                    return (
                      n
                        ? ((this.$frontMarkers[s] = o), this._signal('changeFrontMarker'))
                        : ((this.$backMarkers[s] = o), this._signal('changeBackMarker')),
                      s
                    )
                  }),
                  ...
                  (this.$getUndoSelection = function (e, t, i) {
                    ...
                    var s,
                      o,
                      r = e[0]
                    n(r) ? (s = c.fromPoints(r.start, r.end)) : (s = c.fromPoints(r.start, r.start))
                    for (var a = 1; a < e.length; a++)
                      n((r = e[a]))
                        ? ((o = r.start),
                          -1 == s.compare(o.row, o.column) && s.setStart(o),
                          (o = r.end),
                          1 == s.compare(o.row, o.column) && s.setEnd(o),
                          !0)
                        : ((o = r.start),
                          -1 == s.compare(o.row, o.column) && (s = c.fromPoints(r.start, r.start)),
                          !1)
                    if (null != i) {
                      0 === c.comparePoints(i.start, s.start) &&
                  ...
                  (this.moveText = function (e, t, i) {
                    ...
                    if (!i) {
                      ...
                      ;(h = r ? -e.end.column : e.start.column - e.end.column) &&
                        (o.start.row == e.end.row &&
                          o.start.column > e.end.column &&
                          (o.start.column += h),
                        o.end.row == e.end.row &&
                          o.end.column > e.end.column &&
                          (o.end.column += h)),
                  ...
                  (this.outdentRows = function (e) {
                    for (
                      ...
                      r < n && '\t' == o.charAt(r)
                        ? ((i.start.column = r), (i.end.column = r + 1))
                        : ((i.start.column = 0), (i.end.column = r)),
                        this.remove(i)
                    }
                  }),
                  ...
                  (this.setUseWrapMode = function (e) {
                    if (e != this.$useWrapMode) {
                      if (
                        ((this.$useWrapMode = e), (this.$modified = !0), this.$resetRowCache(0), e)
                      ) {
                        var t = this.getLength()
                    ...
                    if (((this.$updating = !0), 0 != a))
                      if ('remove' === i) {
                        ...
                        if ((m = this.getFoldLine(o))) {
                          ...
                          0 == f
                            ? (m = m.split(n.row, n.column)) &&
                              (m.shiftRow(a), m.addRemoveChars(r, 0, s.column - n.column))
                            : -1 == f &&
                              (m.addRemoveChars(o, 0, s.column - n.column), m.shiftRow(a)),
                            (c = h.indexOf(m) + 1)
                        }
                        for (; c < h.length; c++) {
                          var m
                      ...
                      (o = this.getFoldLine(c, o))
                        ? ((s = []),
                          o.walk(
                            ...
                            o.end.row,
                            r[o.end.row].length + 1
                          ),
                          (l[o.start.row] = this.$computeWrapSplits(s, h, a)),
                          (c = o.end.row + 1))
                        : ((s = this.$getDisplayTokens(r[c])),
                ...
                ;(this.$computeWrapSplits = function (n, s, r) {
                  ...
                  var a = [],
                    ...
                    f = s <= Math.max(2 * r, 8) || !1 === g ? 0 : Math.floor(s / 2)
                  function m(e) {
                    var t = n.slice(c, e),
                      s = t.length
                    t
                  ...
                  for (var p = 0; h - c > s - p; ) {
                    var A = c + s - p
                    if (n[A - 1] >= i && n[A] >= i) m(A)
                    else if (n[A] != e && n[A] != t) {
                      for (var C = Math.max(A - (s - (s >> 2)), c - 1); A > C && n[A] < e; ) A--
                      if (d) {
                        for (; A > C && n[A] < e; ) A--
                        for (; A > C && 9 == n[A]; ) A--
                      } else for (; A > C && n[A] < i; ) A--
                      A > C ? m(++A) : (2 == n[(A = c + s)] && A--, m(A - p))
                    } else {
                      for (; A != c - 1 && n[A] != e; A--);
                      if (A > c) {
                        m(A)
                  ...
                  (this.$getDisplayTokens = function (e, t) {
                    ...
                    for (var r = 0; r < e.length; r++) {
                      ...
                      if (9 == a) {
                        ;(n = this.getScreenTabSize(s.length + t)), s.push(o)
                        for (var h = 1; h < n; h++) s.push(l)
                      } else
                        32 == a
                          ? s.push(i)
                          : (a > 39 && a < 48) || (a > 57 && a < 64)
                  ...
                  (this.screenToDocumentPosition = function (e, t, i) {
                    ...
                    for (
                      var g = this.getLength() - 1,
                        ...
                        m = f ? f.start.row : 1 / 0;
                      a <= e && !(a + (l = this.getRowLength(o)) > e || o >= g);

                    )
                      (a += l),
                        ++o > m &&
                          ((o = f.end.row + 1),
                          (m = (f = this.getNextFoldLine(o, f)) ? f.start.row : 1 / 0)),
                        d && (this.$docRowCache.push(o), this.$screenRowCache.push(a))
                    ...
                    var p = 0,
                      A = Math.floor(e - a)
                    if (this.$useWrapMode) {
                      var C = this.$wrapData[o]
                      C &&
                        ((s = C[A]),
                        A > 0 &&
                          C.length &&
                          ((p = C.indent), (r = C[A - 1] || C[C.length - 1]), (n = n.substring(r))))
                    }
                    return (
                      void 0 !== i &&
                        this.$bidiHandler.isBidiRow(a + A, o, A) &&
                        (t = this.$bidiHandler.offsetToCol(i)),
                      (r += this.$getStringScreenWidth(n, t - p)[1]),
                      this.$useWrapMode && r >= s && (r = s - 1),
                      f ? f.idxToPosition(r) : { row: o, column: r }
                    )
                  }),
                  (this.documentToScreenPosition = function (e, t) {
                    ...
                    var f = ''
                    d && a >= g
                      ? ((f = this.getFoldDisplayLine(d, e, t)), (o = d.start.row))
                      : ((f = this.getLine(e).substring(0, t)), (o = e))
                    var m = 0
                    if (this.$useWrapMode) {
                    ...
                    return { row: s, column: m + this.$getStringScreenWidth(f)[0] }
                  }),
                    ...
                    if (this.$useWrapMode)
                      for (
                        ...
                        ;(e += o ? o.length + 1 : 1),
                          ++n > s &&
                            ((n = t.end.row + 1),
                            (s = (t = this.$foldData[a++]) ? t.start.row : 1 / 0))
                      }
                    else {
                      e = this.getLength()
            ...
            ;(function () {
              ;(this.set = function (e) {
                ...
                (this.findAll = function (e) {
                  ...
                  if (i) {
                    var v = i.start.column,
                      w = i.start.column
                    for (
                      A = 0, d = r.length - 1;
                      A < d && r[A].start.column < v && r[A].start.row == i.start.row;
                  ...
                  if (n)
                    var h = function (e) {
                      ...
                      if (!u(i, r.column, e)) {
                        ...
                        if (0 != t.wrap)
                          for (i = l, a = r.row; i >= a; i--) if (u(i, Number.MAX_VALUE, e)) return
                      }
                    }
                  else
                    h = function (e) {
                  ...
                  if (t.$isMultiLine)
                    ...
                    u = function (t, n, s) {
                      var o,
                        r = e.getLine(t),
                        a = n
                      for (i.lastIndex = n; (o = i.exec(r)); ) {
                        var l = o[0].length
                        if (s(t, (a = o.index), t, a + l)) return !0
                        if (!l && ((i.lastIndex = a += 1), a >= r.length)) return !1
                      }
                    }
                  return { forEach: h }
                })
          ...
          function (e, t, i) {
            ...
            ;(a.prototype = r.prototype),
              function () {
                function e(e) {
                  return (
                    ('object' == typeof e && e.bindKey && e.bindKey.position) ||
                    (e.isDefault ? -100 : 0)
                  )
                }
                  ...
                  (this._addCommandToBinding = function (t, i, n) {
                    ...
                    if (i)
                      if (!o[t] || this.$singleCommand) o[t] = i
                        ...
                        Array.isArray(o[t])
                          ? -1 != (s = o[t].indexOf(i)) && o[t].splice(s, 1)
                          : (o[t] = [o[t]]),
        ...
        ace.define(
          ...
          function (e, t, i) {
            ...
            t.commands = [
              ...
              {
                name: 'fold',
                bindKey: r('Alt-L|Ctrl-F1', 'Command-Alt-L|Command-F1'),
                exec: function (e) {
              ...
              },
              {
                ...
                exec: function (e) {
                  ...
                  s.row + 1 < e.session.doc.getLength() - 1 &&
                    (l += e.session.doc.getNewLineCharacter()),
                    e.clearSelection(),
                    e.session.doc.replace(new o(i.row, 0, s.row + 2, 0), l),
                    a > 0
                      ? (e.selection.moveCursorTo(i.row, i.column),
                        e.selection.selectTo(i.row, i.column + a))
        ...
        ace.define(
          ...
          function (e, t, i) {
            ...
            ;(F.$uid = 0),
              function () {
                n.implement(this, f),
                        ...
                        setTimeout(function () {
                          ...
                          if (t && t.bgTokenizer) {
                            ...
                            if (-1 == s.type.indexOf('tag-open') || (s = n.stepForward())) {
                              ...
                              if (!s)
                                return (
                                  t.removeMarker(t.$tagHighlight), void (t.$tagHighlight = null)
                                )
                  ...
                  (this.$getSelectionHighLightRegexp = function () {
                    ...
                    if (!t.isEmpty() && !t.isMultiLine()) {
                      ...
                      if (!((i >= 0 && /^[\w\d]/.test(r)) || (n <= o && /[\w\d]$/.test(r))))
                        if (((r = s.substring(t.start.column, t.end.column)), /^[\w\d]+$/.test(r)))
                  ...
                  (this.insert = function (e, t) {
                    ...
                    if (
                      ('\t' == e && (e = this.session.getTabString()), this.selection.isEmpty())
                    ) {
                      ...
                      (o &&
                        ...
                        (2 == o.selection.length
                          ? this.selection.setSelectionRange(
                              new g(s.row, h + o.selection[0], s.row, h + o.selection[1])
                            )
                          : this.selection.setSelectionRange(
                              new g(
                                s.row + o.selection[0],
                  ...
                  (this.indent = function () {
                    ...
                    if (!(t.start.row < t.end.row)) {
                      ...
                      if (this.session.getUseSoftTabs())
                        ...
                        for (l = a % r; ' ' == n[t.start.column - 1] && l; ) t.start.column--, l--
                  ...
                  (this.sortLines = function () {
                    for (
                      var e = this.$getSelectedRows(), t = this.session, i = [], n = e.first;
                      n <= e.last;
                      n++
                    )
                      i.push(t.getLine(n))
                  ...
                  (this.modifyNumber = function (e) {
                    ...
                    if (!isNaN(parseFloat(s)) && isFinite(s)) {
                      ...
                      if (o) {
                        var r =
                            o.value.indexOf('.') >= 0 ? o.start + o.value.indexOf('.') + 1 : o.end,
                          a = o.start + o.value.length - r,
                          l = parseFloat(o.value)
                        ;(l *= Math.pow(10, a)),
                          r !== o.end && i < r
                            ? (e *= Math.pow(10, o.end - i - 1))
                            : (e *= Math.pow(10, o.end - i)),
                          (l += e)
                  ...
                  (this.$moveLines = function (e, t) {
                    ...
                    if (!s.inMultiSelectMode || this.inVirtualSelectionMode) {
                      ...
                      for (var a = 0, l = 0, h = r.length, c = 0; c < h; c++) {
                        ...
                        r[c].moveBy(a, 0)
                        for (
                          var d = (i = this.$getSelectedRows(r[c])).first, g = i.last;
                          ++c < h;
                      ...
                      do {
                        if (o.value.match(/[{}()\[\]]/g)) {
                          for (; c < o.value.length && !l; c++)
                            if (u[o.value[c]])
                              switch (
                                ((a = u[o.value[c]] + '.' + o.type.replace('rparen', 'lparen')),
                                isNaN(h[a]) && (h[a] = 0),
                                o.value[c])
                              ) {
                                case '(':
                          ...
                          o &&
                            ...
                            (isNaN(h[o.value]) && (h[o.value] = 0),
                            '<' === s.value ? h[o.value]++ : '</' === s.value && h[o.value]--,
                            -1 === h[o.value] && ((r = 'tag'), (l = !0)))
                          ...
                          if (
                            ...
                            null !=
                              (n =
                                ...
                                (!(
                                  o.top < r.height &&
                                  o.top + t.top + r.lineHeight > window.innerHeight
                                ) &&
                                  null)) &&
                              ((s.style.top = a + 'px'),
              ...
              A.defineOptions(F.prototype, 'editor', {
                selectionStyle: {
                  set: function (e) {
          ...
          ;(function () {
            ...
            function i(e, t) {
              for (var i = new Array(e.length), n = 0; n < e.length; n++) {
                for (
                  var s = e[n], o = { group: s.group, deltas: new Array(s.length) }, r = 0;
                  r < s.deltas.length;
                  r++
                ) {
                  var a = s.deltas[r]
              ...
              s.implement(this, r),
                ...
                (this.setAnnotations = function (e) {
                  ...
                  for (var t = 0; t < e.length; t++) {
                    ...
                    var r = i.text
                    ;(r = r ? o.escapeHTML(r) : i.html || ''),
                      -1 === s.text.indexOf(r) && s.text.push(r)
                    var a = i.type
                    'error' == a
                ...
                (this.update = function (e) {
                  for (
                    ...
                    if (
                      (m > r &&
                        ((m = o.end.row + 1),
                        (r = (o = t.getNextFoldLine(m, o)) ? o.start.row : 1 / 0)),
                      m > s)
                    ) {
                    ...
                    if (
                      ...
                      (C = t.getRowLength(m) * e.lineHeight + 'px') != g.element.style.height &&
                        (g.element.style.height = C),
                      a)
                    ) {
                      var A = a[m]
                  ...
                  ;(v += w.left + w.right) === this.gutterWidth ||
                    isNaN(v) ||
                    ((this.gutterWidth = v),
              ...
              ;(this.$padding = 0),
                        ...
                        if (!s.isEmpty())
                          if (((s = s.toScreenRange(this.session)), n.renderer)) {
                            var o = this.$getTop(s.start.row, e),
                              r =
                                this.$padding +
                                (this.session.$bidiHandler.isBidiRow(s.start.row)
                                  ? this.session.$bidiHandler.getPosLeft(s.start.column)
                                  : s.start.column * e.characterWidth)
                ...
                (this.drawTextMarker = function (e, t, i, s, o) {
                  for (
                    ...
                    (f.start.row = f.end.row = h),
                      (f.start.column = h == a ? t.start.column : r.getRowWrapIndent(h)),
                      (f.end.column = d),
                      (c = u),
                      (u = d),
                      (d = h + 1 < l ? r.getScreenLastRowColumn(h + 1) : h == l ? 0 : t.end.column),
                      (g =
                        i +
                        (h == a ? ' ace_start' : '') +
                        ' ace_br' +
                        ((h == a || (h == a + 1 && t.start.column) ? 1 : 0) |
                          ...
                          (u > d ? 4 : 0) |
                          (h == l ? 8 : 0))),
                      this.session.$bidiHandler.isBidiRow(h)
                        ? this.drawBidiSingleLineMarker(e, f, g, s, h == l ? 0 : 1, o)
                        : this.drawSingleLineMarker(e, f, g, s, h == l ? 0 : 1, o)
                }),
                (this.drawMultiLineMarker = function (e, t, i, n, s) {
                  var o,
                    ...
                    a,
                    l = this.$padding
                  ;((s = s || ''), this.session.$bidiHandler.isBidiRow(t.start.row))
                    ...
                    : ((o = n.lineHeight),
                      (r = this.$getTop(t.start.row, n)),
                      (a = l + t.start.column * n.characterWidth),
                      e.push(
                        "<div class='",
                        i,
                ...
                (this.drawBidiSingleLineMarker = function (e, t, i, n, s, o) {
                  ...
                  this.session.$bidiHandler
                    .getSelections(t.start.column, t.end.column)
                    .forEach(function (t) {
                      e.push(
                        "<div class='",
                        i,
            ...
            ;(function () {
              n.implement(this, r),
                ...
                (this.onChangeTabSize = this.$computeTabString = function () {
                    ...
                    this.showInvisibles
                      ? t.push(
                          "<span class='ace_invisible ace_invisible_tab'>" +
                            o.stringRepeat(this.TAB_CHAR, i) +
                            '</span>'
                        )
                      : t.push(o.stringRepeat(' ', i))
                  if (this.displayIndentGuides) {
                    ...
                    ;(this.$tabStrings[' '] = "<span class='" + n + s + "'>" + a + '</span>'),
                      (this.$tabStrings['\t'] = "<span class='" + n + r + "'>" + l + '</span>')
                  }
                }),
                (this.updateLines = function (e, t, i) {
                  ...
                  a = n
                  for (
                    var l, h = (l = this.session.getNextFoldLine(a)) ? l.start.row : 1 / 0;
                    a > h &&
                      ((a = l.end.row + 1),
                      (h = (l = this.session.getNextFoldLine(a, l)) ? l.start.row : 1 / 0)),
                      !(a > s);
                ...
                (this.scrollLines = function (e) {
                  ...
                  if (t.lastRow > e.lastRow)
                    for (n = this.session.getFoldedRowCount(e.lastRow + 1, t.lastRow); n > 0; n--)
                ...
                (this.$renderLinesFragment = function (e, t, i) {
                  for (
                    var n = this.element.ownerDocument.createDocumentFragment(),
                      o = t,
                      r = this.session.getNextFoldLine(o),
                      a = r ? r.start.row : 1 / 0;
                    o > a &&
                      ((o = r.end.row + 1),
                      (a = (r = this.session.getNextFoldLine(o, r)) ? r.start.row : 1 / 0)),
                      !(o > i);
                ...
                (this.$renderToken = function (e, t, i, n) {
                        ...
                        if (i)
                          return s.showInvisibles
                            ? "<span class='ace_invisible ace_invisible_space'>" +
                                o.stringRepeat(s.SPACE_CHAR, e.length) +
                                '</span>'
                            : e
                        if ('&' == e) return '&#38;'
                        if ('<' == e) return '&#60;'
                  ...
                  if (this.$textToken[i.type]) e.push(r)
                    ...
                    'fold' == i.type &&
                      (l =
                        " style='width:" + i.value.length * this.config.characterWidth + "px;' "),
                      e.push("<span class='", a, "'", l, '>', r, '</span>')
                  }
                  return t + n.length
                }),
                (this.renderIndentGuide = function (e, t, i) {
                  ...
                  return n <= 0 || n >= i
                    ...
                    : ' ' == t[0]
                    ? ((n -= n % this.tabSize),
                      e.push(o.stringRepeat(this.$tabStrings[' '], n / this.tabSize)),
                      t.substr(n))
                    : '\t' == t[0]
                    ? (e.push(o.stringRepeat(this.$tabStrings['\t'], n)), t.substr(n))
                    : t
                }),
                    ...
                    if (s + u.length < a) (l = this.$renderToken(e, l, c, u)), (s += u.length)
                      ...
                      for (; s + u.length >= a; )
                        (l = this.$renderToken(e, l, c, u.substring(0, a - s))),
                          ...
                          e.push(o.stringRepeat('\xa0', i.indent)),
                          (l = 0),
                          (a = i[++r] || Number.MAX_VALUE)
                ...
                (this.$renderSimpleLine = function (e, t) {
                  ...
                  for (var o = 1; o < t.length; o++)
                    (s = (n = t[o]).value), (i = this.$renderToken(e, i, n, s))
                }),
                (this.$renderLine = function (e, t, i, n) {
                  ...
                  if (
                    ...
                    o && o.length
                      ? this.$renderWrappedLine(e, s, o, i)
                          ...
                          : (a && (s = i.getTokens(t)),
                            s.length &&
                              (function (e, t, i) {
                                ...
                                for (
                                  o != t &&
                                  ((r = e[s].value.substring(t - o)).length > i - t &&
                                    (r = r.substring(0, i - t)),
                                  n.push({ type: e[s].type, value: r }),
                                  (o = t + r.length),
                                  (s += 1));
                                  o < i && s < e.length;
                                  ...
                                  var r
                                  ;(r = e[s].value).length + o > i
                                    ? n.push({ type: e[s].type, value: r.substring(0, i - o) })
                                    : n.push(e[s]),
                                    (o += r.length),
                                    (s += 1)
                                }
                ...
                (this.update = function (e) {
                  ...
                  for (var s = t.length; i < s; i++) {
                    ...
                    if (!((o.top > e.height + e.offset || o.top < 0) && i > 1)) {
                      ...
                      this.drawCursor
                        ? this.drawCursor(r, o, e, t[i], this.session)
                        : ((r.left = o.left + 'px'),
                          (r.top = o.top + 'px'),
              ...
              n.implement(this, a),
                ...
                (this.$setMeasureNodeStyles = function (e, t) {
                  ;(e.width = e.height = 'auto'),
                    ...
                    (e.position = 'absolute'),
                    (e.whiteSpace = 'pre'),
                    r.isIE < 8 ? (e['font-family'] = 'inherit') : (e.font = 'inherit'),
          ...
          function (e, t, i) {
            ...
            var p = function (e, t) {
              ...
              ;(this.container = e || s.createElement('div')),
                (this.$keepTextAreaAtCursor = !r.isOldIE),
            ...
            ;(function () {
              ;(this.CHANGE_CURSOR = 1),
                ...
                (this.$moveTextAreaToCursor = function () {
                  if (this.$keepTextAreaAtCursor) {
                    ...
                    if (t < 0 || t > e.height - s) n.top = n.left = '0'
                      ...
                      ;(i -= this.scrollLeft) > this.$size.scrollerWidth - o &&
                        (i = this.$size.scrollerWidth - o),
                        (i += this.gutterWidth),
                        (n.height = s + 'px'),
                        (n.width = o + 'px'),
                ...
                (this.setScrollMargin = function (e, t, i, n) {
                  ...
                  ;(s.top = 0 | e),
                    ...
                    s.top &&
                      this.scrollTop <= 0 &&
                      this.session &&
                      this.session.setScrollTop(-s.top),
                    this.updateFull()
                }),
                ...
                (this.$renderChanges = function (e, t) {
                  if (
                    ...
                    e & this.CHANGE_TEXT
                      ? (this.$textLayer.update(i), this.$showGutter && this.$gutterLayer.update(i))
                      : e & this.CHANGE_LINES
                ...
                (this.$computeLayerConfig = function () {
                  ...
                  this.session.setScrollTop(
                    Math.max(-u.top, Math.min(this.scrollTop, n - t.scrollerHeight + u.bottom))
                  ),
                    this.session.setScrollLeft(
                      Math.max(
                        -u.left,
                        Math.min(this.scrollLeft, s + 2 * this.$padding - t.scrollerWidth + u.right)
                      )
                    )
                  var d =
                      !i &&
                      (this.$vScrollBarAlwaysVisible ||
                        t.scrollerHeight - n + c < 0 ||
                        this.scrollTop > u.top),
                    g = a !== d
                  g && ((this.$vScroll = d), this.scrollBarV.setVisible(d))
                  var f,
                    m,
                    p = Math.ceil(h / this.lineHeight) - 1,
                    A = Math.max(0, Math.round((this.scrollTop - l) / this.lineHeight)),
                    C = A + p,
                    F = this.lineHeight
                  A = e.screenToDocumentRow(A, 0)
                  var v = e.getFoldLine(A)
                  v && (A = v.start.row),
                    (f = e.documentToScreenRow(A, 0)),
                    (m = e.getRowLength(A) * F),
                    (C = Math.min(e.screenToDocumentRow(C, 0), e.getLength() - 1)),
                    (h = t.scrollerHeight + e.getRowLength(C) * F + m),
                    (l = this.scrollTop - f * F)
                  var w = 0
                  return (
                    this.layerConfig.width != s && (w = this.CHANGE_H_SCROLL),
                    (r || g) &&
                    ...
                    (this.layerConfig = {
                      ...
                      offset: l,
                      gutterOffset: F
                        ? Math.max(0, Math.ceil((l + t.height - t.scrollerHeight) / F))
                        : 0,
                ...
                (this.scrollCursorIntoView = function (e, t, i) {
                  if (0 !== this.$size.scrollerHeight) {
                    ...
                    l + r > o
                      ? (t && l + r > o + this.lineHeight && (o -= t * this.$size.scrollerHeight),
                        0 === o && (o = -this.scrollMargin.top),
                        this.session.setScrollTop(o))
                      : l + this.$size.scrollerHeight - a < o + this.lineHeight &&
                        (t &&
                          l + this.$size.scrollerHeight - a < o - this.lineHeight &&
                          (o += t * this.$size.scrollerHeight),
                ...
                (this.$calcSteps = function (e, t) {
                  var i,
                    ...
                    r = []
                  for (s = 0; s < o; ++s)
                    r.push(((i = s / this.STEPS), (n = e), (t - e) * (Math.pow(i - 1, 3) + 1) + n))
                  return r
                }),
                (this.scrollToLine = function (e, t, i, n) {
                ...
                (this.animateScrolling = function (e, t) {
                  ...
                  if (this.$animatedScroll) {
                    ...
                    if (e != i) {
                      ...
                      ;(this.$scrollAnimation = { from: e, to: i, steps: o }),
                        clearInterval(this.$timer),
                        n.session.setScrollTop(o.shift()),
                        (n.session.$scrollTop = i),
                        (this.$timer = setInterval(function () {
                          o.length
                            ? (n.session.setScrollTop(o.shift()), (n.session.$scrollTop = i))
                            : null != i
                ...
                (this.pixelToScreenCoordinates = function (e, t) {
                  var i = this.scroller.getBoundingClientRect(),
                    ...
                    s = n / this.characterWidth,
                    o = Math.floor((t + this.scrollTop - i.top) / this.lineHeight),
                    r = Math.round(s)
                  return { row: o, column: r, side: s - r > 0 ? 1 : -1, offsetX: n }
                }),
                (this.screenToTextCoordinates = function (e, t) {
                  var i = this.scroller.getBoundingClientRect(),
                    n = e + this.scrollLeft - i.left - this.$padding,
                    s = Math.round(n / this.characterWidth),
                    o = (t + this.scrollTop - i.top) / this.lineHeight
                  return this.session.screenToDocumentPosition(o, Math.max(s, 0), n)
                }),
                ...
                (this.setTheme = function (e, t) {
                  ...
                  function r(n) {
                    ...
                    s.importCssString(n.cssText, n.cssClass, i.container.ownerDocument),
                      i.theme && s.removeCssClass(i.container, i.theme.cssClass)
                    var o =
                      'padding' in n ? n.padding : 'padding' in (i.theme || {}) ? 4 : i.$padding
              ...
              o.defineOptions(p.prototype, 'renderer', {
        ...
        ace.define(
          ...
          function (e, t, i) {
            ...
            var l = function (t, i, n, s, o) {
              if (
                ((this.$sendDeltaQueue = this.$sendDeltaQueue.bind(this)),
                (this.changeListener = this.changeListener.bind(this)),
                (this.onMessage = this.onMessage.bind(this)),
                e.nameToUrl && !e.toUrl && (e.toUrl = e.nameToUrl),
                r.get('packaged') || !e.toUrl)
              )
                s = s || r.moduleUrl(i.id, 'worker')
              else {
              ...
              ;(this.$worker = a(s, i)),
                ...
                this.$worker.postMessage({ init: !0, tlns: h, module: i.id, classname: n }),
                (this.callbackId = 1),
                (this.callbacks = {}),
              ...
              if ((a && s.isMac && (h = t.button), e.editor.inMultiSelectMode && 2 == h))
                ...
                if (0 === h) {
                  var c,
                    ...
                    m = d.getCursor(),
                    p = e.inSelection() || (d.isEmpty() && o(f, m)),
                    A = e.x,
                    C = e.y,
                    F = u.session,
                    v = u.renderer.pixelToScreenCoordinates(A, C),
                    w = v
                  ...
                  if (
                    (c && s.isMac && t.ctrlKey && u.$mouseHandler.cancelContextMenu(), 'add' == c)
                  ) {
                    if (!g && p) return
                    if (!g) {
                    ...
                    u.$blockScrolling++,
                      ...
                      r && ((b = null), (E = d.ranges[0] || E), u.removeSelectionMarker(E)),
                      u.once('mouseup', function () {
                        var e = d.toOrientedRange()
                        b && e.isEmpty() && o(b.cursor, e.cursor)
                          ? d.substractPoint(e.cursor)
                          : (r
                              ? d.substractPoint(E.cursor)
                              : E && (u.removeSelectionMarker(E), d.addRange(E)),
                            d.addRange(e)),
                          u.$blockScrolling--,
                    ...
                    u.$blockScrolling++,
                      ...
                      r ? (v = F.documentToScreenPosition(d.lead)) : d.moveToPosition(f),
                      u.$blockScrolling--,
                      (w = { row: -1, column: -1 })
                    var B = function () {
                      var e = u.renderer.pixelToScreenCoordinates(A, C),
                        t = F.screenToDocumentPosition(e.row, e.column, e.offsetX)
                      ;(o(w, e) && o(t, d.lead)) ||
                        ((w = e),
                        u.$blockScrolling++,
                        u.selection.moveToPosition(t),
                        u.renderer.scrollCursorIntoView(),
                        u.removeSelectionMarkers(y),
                        (y = d.rectangularRangeBlock(w, v)),
                        u.$mouseHandler.$clickSelection &&
                          1 == y.length &&
                          y[0].isEmpty() &&
                          (y[0] = u.$mouseHandler.$clickSelection.clone()),
                        y.forEach(u.addSelectionMarker, u),
              ...
              function () {
                ;(this.ranges = null),
                  ...
                  (this.$initRangeList = function () {
                    this.rangeList ||
                      ((this.rangeList = new n()), (this.ranges = []), (this.rangeCount = 0))
                  }),
                  ...
                  (this.splitIntoLines = function () {
                    if (this.rangeCount > 1) {
                      ...
                      if (o == r) {
                        ...
                        return (
                          this.addRange(s.fromPoints(l, l)), void this.addRange(s.fromPoints(a, a))
                        )
                      }
                      var h = [],
                      ...
                      ;((c = this.getLineRange(r, !0)).end.column = i.end.column),
                        h.push(c),
                  ...
                  (this.rectangularRangeBlock = function (e, t, i) {
                    ...
                    if (o)
                      var r = e.column,
                        ...
                        l = e.offsetX,
                        h = t.offsetX
                    else (r = t.column), (a = e.column), (l = t.offsetX), (h = e.offsetX)
                    var c,
                      u,
                      d = e.row < t.row
                    if (d)
                    ...
                    r < 0 && (r = 0), g < 0 && (g = 0), g == f && (i = !0)
                    for (var m = g; m <= f; m++) {
                      var p = s.fromPoints(
                        this.session.screenToDocumentPosition(m, r, l),
                        this.session.screenToDocumentPosition(m, a, h)
                      )
                      if (p.isEmpty()) {
                        if (A && ((c = p.end), (u = A), c.row == u.row && c.column == u.column))
                          break
                        var A = p.end
                      }
                      ;(p.cursor = o ? p.start : p.end), n.push(p)
                    }
                    if ((d && n.reverse(), !i)) {
                      for (var C = n.length - 1; n[C].isEmpty() && C > 0; ) C--
                      if (C > 0) for (var F = 0; n[F].isEmpty(); ) F++
                      for (var v = C; v >= F; v--) n[v].isEmpty() && n.splice(v, 1)
                    }
                    return n
                  })
              }.call(o.prototype))
              ...
              ;(this.updateSelectionMarkers = function () {
                ...
                (this.getSelectedText = function () {
                  ...
                  if (this.inMultiSelectMode && !this.inVirtualSelectionMode) {
                    for (
                      var t = this.multiSelect.rangeList.ranges, i = [], n = 0;
                      n < t.length;
                      n++
                    )
                ...
                (this.findAll = function (e, t, i) {
                  ...
                  return (
                    n && o.rangeList.rangeAtPoint(n.start) && o.addRange(n, !0),
                    (this.$blockScrolling -= 1),
                    s.length
                  )
                }),
                (this.selectMoreLines = function (e, t) {
                  ...
                  var r,
                    a = this.session.screenToDocumentPosition(o.row + e, o.column)
                  if (i.isEmpty()) h = a
                  else
                    var l = this.session.documentToScreenPosition(n ? i.end : i.start),
                      h = this.session.screenToDocumentPosition(l.row + e, l.column)
                  n
                    ? ((r = s.fromPoints(a, h)).cursor = r.start)
                    : ((r = s.fromPoints(h, a)).cursor = r.end)
                  if (((r.desiredColumn = o.column), this.selection.inMultiSelectMode)) {
                    if (t) var c = i.cursor
                ...
                (this.transposeSelections = function (e) {
                  for (var t = this.session, i = t.multiSelect, n = i.ranges, s = n.length; s--; ) {
                    if ((a = n[s]).isEmpty()) {
                      ...
                      ;(a.start.row = o.start.row),
                        (a.start.column = o.start.column),
                        (a.end.row = o.end.row),
                        (a.end.column = o.end.column)
                    }
                  }
                ...
                (this.selectMore = function (e, t, i) {
                  ...
                  if (
                    !s.isEmpty() ||
                    (((s = n.getWordRange(s.start.row, s.start.column)).cursor =
                      -1 == e ? s.start : s.end),
                  ...
                  if (i.length && o.length != i.length - 1) {
                    ...
                    var r = 0,
                      ...
                      h = i.map(function (t) {
                        ...
                        return (
                          -1 == n && (n = 0), i.column > r && (r = i.column), n < a && (a = n), n
                        )
                      })
                    i.forEach(function (t, i) {
                      var n = t.cursor,
                        ...
                        c = h[i] - a
                      o > c
                        ? e.insert(n, l.stringRepeat(' ', o - c))
                        : e.remove(new s(n.row, n.column, n.row, n.column - o + c)),
                ...
                (this.$reAlignText = function (e, t) {
                    ...
                    .map(function (e) {
                      ...
                      return t
                        ? null == i
                          ...
                          : (i + n + s != t[1].length + t[2].length + t[3].length && (r = !1),
                            i != t[1].length && (o = !1),
                  ...
                  function h(e) {
                    return e[2]
                      ? a(i) + e[2] + a(n - e[2].length + s) + e[4].replace(/^([=:])\s+/, '$1 ')
                      : e[0]
                  }
                })
            }.call(d.prototype),
          ...
          function (e, t, i) {
            ...
            ;(function () {
              ;(this.getRowLength = function (e) {
                ...
                return (
                  (t =
                    (this.lineWidgets && this.lineWidgets[e] && this.lineWidgets[e].rowCount) || 0),
                    ...
                    i[o] &&
                      (r
                        ? i[s]
                          ? (i[o].hidden = r)
                          : (i[s] = i[o])
                        : (i[s] == i[o] && (i[s] = void 0), (i[o].hidden = r)))
                  }
                }),
                (this.updateOnChange = function (e) {
        ...
        ace.define(
          ...
          function (e, t, i) {
            ...
            ;(t.showErrorMarker = function (e, t) {
                ...
                c = (function (e, t, i) {
                  ...
                  if (n.length) {
                    var s = (function (e, t, i) {
                      ...
                      return -(n + 1)
                    })(n, { row: t, column: -1 }, o.comparePoints)
                    s < 0 && (s = -s - 1),
                      s >= n.length
                        ? (s = i > 0 ? 0 : n.length - 1)
                        : 0 === s && i < 0 && (s = n.length - 1)
                    var r = n[s]
                    if (r && i) {
                      if (r.row === t) {
                        do {
              ...
              if (c) {
                var u = c[0]
                ;(r.column = (u.pos && 'number' != typeof u.column ? u.pos.sc : u.column) || 0),
                  (r.row = u.row),
              ...
              ;(f.style.left = m + e.renderer.gutterWidth - 5 + 'px'),
                ...
                g.appendChild(s.createElement('div'))
          ...
          function (e, t, n) {
            ...
            e('./worker/worker_client'),
              ...
              (t.edit = function (e) {
                ...
                return (
                  a && (u.textarea = a),
                  o.addListener(window, 'resize', u.onResize),
        ...
        ace.acequire(['ace/ace'], function (e) {
          for (var t in (e && (e.config.init(!0), (e.define = ace.define)),
